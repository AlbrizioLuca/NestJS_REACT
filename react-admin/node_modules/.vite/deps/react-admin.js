import {
  ...
  useScrollTrigger,
  useTheme
} from "./chunk-TYEO43ZY.js";
import {
  require_createSvgIcon,
  require_interopRequireDefault
} from "./chunk-OM2YVGGV.js";
import {
  alpha,
  clsx_m_default,
  createFilterOptions,
...
} from "./chunk-4IIDZFRS.js";
import {
  _inheritsLoose
} from "./chunk-WUWHBQV3.js";
...
var require_css_mediaquery = __commonJS({
  "node_modules/css-mediaquery/index.js"(exports) {
    ...
    function matchQuery(mediaQuery2, values) {
...
var Button = function(props) {
  var _a13 = props.alignIcon, alignIcon = _a13 === void 0 ? "left" : _a13, children = props.children, className = props.className, disabled = props.disabled, label = props.label, _b = props.color, color = _b === void 0 ? "primary" : _b, _c = props.size, size = _c === void 0 ? "small" : _c, locationDescriptor = props.to, rest = __rest(props, ["alignIcon", "children", "className", "disabled", "label", "color", "size", "to"]);
  ...
  return isXSmall ? label && !disabled ? React.createElement(
    Tooltip_default,
    { title: translatedLabel },
    React.createElement(IconButton_default, __assign({ "aria-label": translatedLabel, className, color, size: "large" }, rest, linkParams), children)
  ) : React.createElement(IconButton_default, __assign({ className, color, disabled, size: "large" }, rest, linkParams), children) : React.createElement(StyledButton, __assign({ className, color, size, "aria-label": translatedLabel, disabled, startIcon: alignIcon === "left" && children ? children : void 0, endIcon: alignIcon === "right" && children ? children : void 0 }, rest, linkParams), translatedLabel);
};
Button.propTypes = {
  alignIcon: import_prop_types.default.oneOf(["left", "right"]),
...
var CloneButton = function(props) {
  var _a13 = props.label, label = _a13 === void 0 ? "ra.action.clone" : _a13, _b = props.scrollToTop, scrollToTop = _b === void 0 ? true : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon : _c, rest = __rest2(props, ["label", "scrollToTop", "icon"]);
  var resource = useResourceContext(props);
  var record = useRecordContext(props);
  var createPath = useCreatePath();
  var pathname = createPath({ resource, type: "create" });
  return React2.createElement(Button, __assign2({ component: Link, to: record ? {
    pathname,
...
var defaultIcon = React2.createElement(import_Queue.default, null);
...
CloneButton.propTypes = {
  ...
  record: import_prop_types2.default.any
};
...
var CreateButton = function(props) {
  var className = props.className, _a13 = props.icon, icon = _a13 === void 0 ? defaultIcon2 : _a13, _b = props.label, label = _b === void 0 ? "ra.action.create" : _b, resourceProp = props.resource, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, variant = props.variant, rest = __rest3(props, ["className", "icon", "label", "resource", "scrollToTop", "variant"]);
  var resource = useResourceContext(props);
  var createPath = useCreatePath();
  var translate = useTranslate();
  ...
  return isSmall ? React3.createElement(StyledFab, __assign3({
    component: Link,
  ...
  }, rest), icon) : React3.createElement(StyledButton2, __assign3({ component: Link, to: createPath({ resource, type: "create" }), state: scrollStates[String(scrollToTop)], className: clsx_m_default(CreateButtonClasses.root, className), label, variant }, rest), icon);
};
var scrollStates = {
  true: { _scrollToTop: true },
  false: {}
};
var defaultIcon2 = React3.createElement(import_Add.default, null);
CreateButton.propTypes = {
  resource: import_prop_types3.default.string,
...
var CreateButton_default = (0, import_react2.memo)(CreateButton, function(prevProps, nextProps) {
...
var ShowButton = function(props) {
  var _a13 = props.icon, icon = _a13 === void 0 ? defaultIcon3 : _a13, _b = props.label, label = _b === void 0 ? "ra.action.show" : _b, recordProp = props.record, resourceProp = props.resource, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, rest = __rest4(props, ["icon", "label", "record", "resource", "scrollToTop"]);
  var resource = useResourceContext(props);
  var record = useRecordContext(props);
  var createPath = useCreatePath();
  if (!record)
    return null;
  return React4.createElement(Button, __assign4({ component: Link, to: createPath({ type: "show", resource, id: record.id }), state: scrollStates2[String(scrollToTop)], label, onClick: stopPropagation2 }, rest), icon);
};
var scrollStates2 = {
  true: { _scrollToTop: true },
  false: {}
};
var defaultIcon3 = React4.createElement(import_RemoveRedEye.default, null);
...
ShowButton.propTypes = {
  ...
  record: import_prop_types4.default.any,
  scrollToTop: import_prop_types4.default.bool
};
var PureShowButton = (0, import_react3.memo)(ShowButton, function(prevProps, nextProps) {
...
var SortButton = function(props) {
  var fields = props.fields, _a13 = props.label, label = _a13 === void 0 ? "ra.sort.sort_by" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon4 : _b;
  ...
  var _d = React5.useState(null), anchorEl = _d[0], setAnchorEl = _d[1];
  ...
  return React5.createElement(
    React5.Fragment,
    null,
    isXSmall ? React5.createElement(
      Tooltip_default,
      { title: buttonLabel },
      React5.createElement(IconButton_default, { "aria-label": buttonLabel, color: "primary", onClick: handleClick2, size: "large" }, icon)
    ) : React5.createElement(StyledButton3, { "aria-controls": "simple-menu", "aria-haspopup": "true", color: "primary", onClick: handleClick2, startIcon: icon, endIcon: React5.createElement(import_ArrowDropDown.default, null), size: "small" }, buttonLabel),
    React5.createElement(Menu_default, { id: "simple-menu", anchorEl, keepMounted: true, open: Boolean(anchorEl), onClose: handleClose }, fields.map(function(field) {
      return React5.createElement(
        MenuItem_default,
...
var defaultIcon4 = React5.createElement(import_Sort.default, null);
...
var StyledButton3 = styled_default(Button_default, {
  name: "RaSortButton",
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var SortButton_default = (0, import_react4.memo)(SortButton, arePropsEqual);
...
var SidebarToggleButton = function(props) {
  ...
  return React6.createElement(
    ...
    React6.createElement(
      ...
      React6.createElement(import_Menu.default, { classes: {
...
var LoadingIndicator = function(props) {
  ...
  var theme = useTheme();
  return React7.createElement(Root, { className, sx }, loading ? React7.createElement(CircularProgress_default, __assign5({ className: clsx_m_default("app-loader", LoadingIndicatorClasses.loader), color: "inherit", size: theme.spacing(2), thickness: 6 }, rest)) : React7.createElement(RefreshIconButton, { className: LoadingIndicatorClasses.loadedIcon }));
};
...
var UserMenuContext = (0, import_react5.createContext)(void 0);

// node_modules/ra-ui-materialui/dist/esm/layout/UserMenuContextProvider.js
var UserMenuContextProvider = function(_a13) {
  var children = _a13.children, value = _a13.value;
  return React8.createElement(UserMenuContext.Provider, { value }, children);
};
...
var _a;
var Logout = React9.forwardRef(function Logout2(props, ref) {
  ...
  var handleClick2 = (0, import_react6.useCallback)(function() {
  ...
  return React9.createElement(
    ...
    React9.createElement(ListItemIcon_default, { className: LogoutClasses.icon }, icon ? icon : React9.createElement(import_PowerSettingsNew.default, { fontSize: "small" })),
    React9.createElement(ListItemText_default, null, translate("ra.auth.logout", { _: "Logout" }))
  );
});
Logout.propTypes = {
  className: import_prop_types6.default.string,
  redirectTo: import_prop_types6.default.string,
...
var UserMenu = function(props) {
  var _a13 = (0, import_react7.useState)(null), anchorEl = _a13[0], setAnchorEl = _a13[1];
  var translate = useTranslate();
  ...
  var _c = props.children, children = _c === void 0 ? !!authProvider ? React10.createElement(Logout, null) : null : _c, className = props.className, _d = props.label, label = _d === void 0 ? "ra.auth.user_menu" : _d, _e = props.icon, icon = _e === void 0 ? defaultIcon5 : _e;
  var handleMenu = function(event) {
    return setAnchorEl(event.currentTarget);
  };
  var handleClose = (0, import_react7.useCallback)(function() {
    return setAnchorEl(null);
  }, []);
  var context = (0, import_react7.useMemo)(function() {
  ...
  return React10.createElement(
    Root2,
    { className },
    isLargeEnough && !isLoading && (identity === null || identity === void 0 ? void 0 : identity.fullName) ? React10.createElement(Button_default, { "aria-label": label && translate(label, { _: label }), className: UserMenuClasses.userButton, color: "inherit", startIcon: identity.avatar ? React10.createElement(Avatar_default, { className: UserMenuClasses.avatar, src: identity.avatar, alt: identity.fullName }) : icon, onClick: handleMenu }, identity.fullName) : React10.createElement(
      Tooltip_default,
      { title: label && translate(label, { _: "Profile" }) },
      React10.createElement(IconButton_default, { "aria-label": label && translate(label, { _: "Profile" }), "aria-owns": open ? "menu-appbar" : null, "aria-haspopup": true, color: "inherit", onClick: handleMenu }, !isLoading && (identity === null || identity === void 0 ? void 0 : identity.avatar) ? React10.createElement(Avatar_default, { className: UserMenuClasses.avatar, src: identity.avatar, alt: identity.fullName }) : icon)
    ),
    React10.createElement(
      UserMenuContextProvider,
      { value: context },
      React10.createElement(Menu_default, { id: "menu-appbar", disableScrollLock: true, anchorEl, anchorOrigin: AnchorOrigin, transformOrigin: TransformOrigin, open, onClose: handleClose }, children)
    )
  );
};
UserMenu.propTypes = {
...
var defaultIcon5 = React10.createElement(import_AccountCircle.default, null);
var AnchorOrigin = {
  vertical: "bottom",
  horizontal: "right"
};
...
var HideOnScroll = function(props) {
  ...
  return React11.createElement(Slide_default, { appear: false, direction: "down", in: !trigger, className }, children);
};
...
var TitlePortal = function(_a13) {
  var className = _a13.className;
  return React12.createElement(Typography_default, { flex: "1", textOverflow: "ellipsis", whiteSpace: "nowrap", overflow: "hidden", variant: "h6", color: "inherit", id: "react-admin-title", className });
};
...
var ThemesContext = (0, import_react8.createContext)({});

// node_modules/ra-ui-materialui/dist/esm/layout/Theme/useThemesContext.js
var useThemesContext = function(params) {
  var _a13 = params || {}, lightTheme = _a13.lightTheme, darkTheme = _a13.darkTheme, defaultTheme2 = _a13.defaultTheme;
  var context = (0, import_react9.useContext)(ThemesContext);
  return {
...
var ToggleThemeLegacyButton = function(props) {
  ...
  var _a13 = useTheme2(), theme = _a13[0], setTheme = _a13[1];
  ...
  return import_react10.default.createElement(
    ...
    import_react10.default.createElement(IconButton_default, { color: "inherit", onClick: handleTogglePaletteType, "aria-label": toggleThemeTitle }, isDark ? import_react10.default.createElement(import_Brightness7.default, null) : import_react10.default.createElement(import_Brightness4.default, null))
  );
};
...
var ToggleThemeButton = function(props) {
  var translate = useTranslate();
  var _a13 = useThemesContext(props), darkTheme = _a13.darkTheme, defaultTheme2 = _a13.defaultTheme;
  var prefersDarkMode = useMediaQuery("(prefers-color-scheme: dark)", {
    noSsr: true
  });
  var _b = useTheme2(defaultTheme2 || (prefersDarkMode && darkTheme ? "dark" : "light")), theme = _b[0], setTheme = _b[1];
  if (props.darkTheme) {
    return import_react11.default.createElement(ToggleThemeLegacyButton, { darkTheme: props.darkTheme, lightTheme: props.lightTheme });
  }
  var handleTogglePaletteType = function() {
  ...
  return import_react11.default.createElement(
    Tooltip_default,
    { title: toggleThemeTitle, enterDelay: 300 },
    import_react11.default.createElement(IconButton_default, { color: "inherit", onClick: handleTogglePaletteType, "aria-label": toggleThemeTitle }, theme === "dark" ? import_react11.default.createElement(import_Brightness72.default, null) : import_react11.default.createElement(import_Brightness42.default, null))
  );
};
...
var AppBar = (0, import_react12.memo)(function(props) {
  var alwaysOn = props.alwaysOn, children = props.children, className = props.className, _a13 = props.color, color = _a13 === void 0 ? "secondary" : _a13, open = props.open, title = props.title, _b = props.toolbar, toolbar = _b === void 0 ? defaultToolbarElement : _b, _c = props.userMenu, userMenu = _c === void 0 ? DefaultUserMenu : _c, _d = props.container, Container = _d === void 0 ? alwaysOn ? "div" : HideOnScroll : _d, rest = __rest7(props, ["alwaysOn", "children", "className", "color", "open", "title", "toolbar", "userMenu", "container"]);
  var isXSmall = useMediaQuery(function(theme) {
    return theme.breakpoints.down("sm");
  });
  return React15.createElement(
    ...
    React15.createElement(
      StyledAppBar,
      __assign7({ className: AppBarClasses.appBar, color }, rest),
      React15.createElement(
        Toolbar_default,
        { disableGutters: true, variant: isXSmall ? "regular" : "dense", className: AppBarClasses.toolbar },
        React15.createElement(SidebarToggleButton, { className: AppBarClasses.menuButton }),
        import_react12.Children.count(children) === 0 ? React15.createElement(TitlePortal, { className: AppBarClasses.title }) : children,
        toolbar,
        typeof userMenu === "boolean" ? userMenu === true ? React15.createElement(UserMenu, null) : null : userMenu
      )
    )
  );
});
var DefaultToolbar = function() {
  ...
  return React15.createElement(
    React15.Fragment,
    null,
    locales && locales.length > 1 ? React15.createElement(LocalesMenuButton, null) : null,
    darkTheme && React15.createElement(ToggleThemeButton, null),
    React15.createElement(LoadingIndicator, null)
  );
};
var defaultToolbarElement = React15.createElement(DefaultToolbar, null);
AppBar.propTypes = {
  alwaysOn: import_prop_types9.default.bool,
  children: import_prop_types9.default.node,
  className: import_prop_types9.default.string,
  color: import_prop_types9.default.oneOf([
    "default",
    "inherit",
    "primary",
    "secondary",
  ...
  toolbar: import_prop_types9.default.element,
  userMenu: import_prop_types9.default.oneOfType([import_prop_types9.default.element, import_prop_types9.default.bool])
};
var DefaultUserMenu = React15.createElement(UserMenu, null);
...
var CardContentInner = function(props) {
  ...
  return React16.createElement(Root3, { className }, children);
};
...
var Root3 = styled_default(CardContent_default, {
  name: PREFIX8,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var Confirm = function(props) {
  var _a13;
  var className = props.className, _b = props.isOpen, isOpen = _b === void 0 ? false : _b, loading = props.loading, title = props.title, content = props.content, _c = props.cancel, cancel = _c === void 0 ? "ra.action.cancel" : _c, _d = props.confirm, confirm = _d === void 0 ? "ra.action.confirm" : _d, _e = props.confirmColor, confirmColor = _e === void 0 ? "primary" : _e, _f = props.ConfirmIcon, ConfirmIcon = _f === void 0 ? import_CheckCircle.default : _f, _g = props.CancelIcon, CancelIcon3 = _g === void 0 ? import_ErrorOutline.default : _g, onClose = props.onClose, onConfirm = props.onConfirm, _h = props.translateOptions, translateOptions = _h === void 0 ? {} : _h, rest = __rest8(props, ["className", "isOpen", "loading", "title", "content", "cancel", "confirm", "confirmColor", "ConfirmIcon", "CancelIcon", "onClose", "onConfirm", "translateOptions"]);
  var translate = useTranslate();
  var handleConfirm = (0, import_react13.useCallback)(function(e) {
    e.stopPropagation();
    onConfirm(e);
  }, [onConfirm]);
  var handleClick2 = (0, import_react13.useCallback)(function(e) {
    e.stopPropagation();
  }, []);
  return React17.createElement(
    StyledDialog,
    __assign8({ className, open: isOpen, onClose, onClick: handleClick2, "aria-labelledby": "alert-dialog-title" }, rest),
    React17.createElement(DialogTitle_default, { id: "alert-dialog-title" }, translate(title, __assign8({ _: title }, translateOptions))),
    React17.createElement(DialogContent_default, null, typeof content === "string" ? React17.createElement(DialogContentText_default, null, translate(content, __assign8({ _: content }, translateOptions))) : content),
    React17.createElement(
      DialogActions_default,
      null,
      React17.createElement(Button_default, { disabled: loading, onClick: onClose, startIcon: React17.createElement(CancelIcon3, null) }, translate(cancel, { _: cancel })),
      React17.createElement(Button_default, { disabled: loading, onClick: handleConfirm, className: clsx_m_default("ra-confirm", (_a13 = {}, _a13[ConfirmClasses.confirmWarning] = confirmColor === "warning", _a13[ConfirmClasses.confirmPrimary] = confirmColor === "primary", _a13)), autoFocus: true, startIcon: React17.createElement(ConfirmIcon, null) }, translate(confirm, { _: confirm }))
    )
  );
};
Confirm.propTypes = {
  cancel: import_prop_types11.default.string,
  className: import_prop_types11.default.string,
  confirm: import_prop_types11.default.string,
  confirmColor: import_prop_types11.default.string,
  ConfirmIcon: import_prop_types11.default.elementType,
  CancelIcon: import_prop_types11.default.elementType,
  content: import_prop_types11.default.node.isRequired,
  ...
  onConfirm: import_prop_types11.default.func.isRequired,
  title: import_prop_types11.default.string.isRequired,
  sx: import_prop_types11.default.any
};
...
var MenuItemLink = (0, import_react14.forwardRef)(function(props, ref) {
  var className = props.className, primaryText = props.primaryText, leftIcon = props.leftIcon, onClick = props.onClick, sidebarIsOpen = props.sidebarIsOpen, tooltipProps = props.tooltipProps, rest = __rest9(props, ["className", "primaryText", "leftIcon", "onClick", "sidebarIsOpen", "tooltipProps"]);
  var isSmall = useMediaQuery(function(theme) {
    return theme.breakpoints.down("md");
  });
  var translate = useTranslate();
  ...
  var _a13 = useSidebarState(), open = _a13[0], setOpen = _a13[1];
  var handleMenuTap = (0, import_react14.useCallback)(function(e) {
    if (isSmall) {
      setOpen(false);
    }
    onClick && onClick(e);
  ...
  var renderMenuItem = function() {
    ...
    return import_react14.default.createElement(
      StyledMenuItem2,
      __assign9({
        className: clsx_m_default(className, (_a14 = {}, _a14[MenuItemLinkClasses.active] = !!match, _a14)),
        // @ts-ignore
        component: LinkRef,
        ref,
        tabIndex: 0
      }, rest, { onClick: handleMenuTap }),
      leftIcon && import_react14.default.createElement(ListItemIcon_default, { className: MenuItemLinkClasses.icon }, leftIcon),
      typeof primaryText === "string" ? translate(primaryText, { _: primaryText }) : primaryText
    );
  };
  return open ? renderMenuItem() : import_react14.default.createElement(Tooltip_default, __assign9({ title: typeof primaryText === "string" ? translate(primaryText, { _: primaryText }) : primaryText, placement: "right" }, tooltipProps), renderMenuItem());
});
MenuItemLink.propTypes = {
  className: import_prop_types12.default.string,
  leftIcon: import_prop_types12.default.element,
  onClick: import_prop_types12.default.func,
  primaryText: import_prop_types12.default.node,
  to: import_prop_types12.default.oneOfType([import_prop_types12.default.string, import_prop_types12.default.object]).isRequired,
  sidebarIsOpen: import_prop_types12.default.bool
};
...
var LinkRef = (0, import_react14.forwardRef)(function(props, ref) {
  return import_react14.default.createElement(Link, __assign9({ ref }, props));
});
...
var DashboardMenuItem = function(props) {
  var basename = useBasename();
  var _a13 = props.leftIcon, leftIcon = _a13 === void 0 ? import_react15.default.createElement(import_Dashboard.default, null) : _a13, _b = props.to, to = _b === void 0 ? "".concat(basename, "/") : _b, _c = props.primaryText, primaryText = _c === void 0 ? "ra.page.dashboard" : _c, rest = __rest10(props, ["leftIcon", "to", "primaryText"]);
  return import_react15.default.createElement(MenuItemLink, __assign10({ leftIcon, to, primaryText }, rest));
};
DashboardMenuItem.propTypes = {
  leftIcon: import_prop_types13.default.element,
  locale: import_prop_types13.default.string,
  onClick: import_prop_types13.default.func,
  dense: import_prop_types13.default.bool,
  sidebarIsOpen: import_prop_types13.default.bool
};
...
var DeviceTestWrapper = function(_a13) {
  var _b = _a13.width, width = _b === void 0 ? "md" : _b, children = _a13.children;
  ...
  return React20.createElement(ThemeProvider, { theme: __assign11(__assign11({}, theme), { components: {
    MuiUseMediaQuery: {
      defaultProps: {
        ssrMatchMedia,
...
var Configurable = function(props) {
  var children = props.children, editor = props.editor, preferenceKey = props.preferenceKey, _a13 = props.openButtonLabel, openButtonLabel = _a13 === void 0 ? "ra.configurable.customize" : _a13, sx = props.sx;
  ...
  var editorOpenRef = (0, import_react16.useRef)(isEditorOpen);
  var wrapperRef = (0, import_react16.useRef)(null);
  var _c = (0, import_react16.useState)(false), isCustomizeButtonVisible = _c[0], setIsCustomizeButtonVisible = _c[1];
  ...
  var handleOpenEditor = function() {
    setEditor((0, import_react16.cloneElement)(editor, {
  ...
  return React21.createElement(
    ...
    React21.createElement(Root4, { className: clsx_m_default(ConfigurableClasses.root, isEnabled && ConfigurableClasses.editMode, isEditorOpen && ConfigurableClasses.editorActive), sx, ref: wrapperRef, onMouseEnter: isEnabled ? handleShowButton : void 0, onMouseLeave: isEnabled ? handleHideButton : void 0 }, children),
...
var FieldToggle = function(props) {
  ...
  var dropIndex = React22.useRef(null);
  var x = React22.useRef(null);
  var y = React22.useRef(null);
  var handleDocumentDragOver = React22.useCallback(function(event) {
  ...
  return React22.createElement(
    Root5,
    { key: source, draggable: onMove ? "true" : void 0, onDrag: onMove ? handleDrag : void 0, onDragStart: onMove ? handleDragStart : void 0, onDragEnd: onMove ? handleDragEnd : void 0, onDragOver: onMove ? handleDragOver : void 0, "data-index": index },
    React22.createElement(
      "label",
      { htmlFor: "switch_".concat(index) },
      React22.createElement(Switch_default, { checked: selected, onChange: onToggle, name: index, id: "switch_".concat(index), size: "small", sx: { mr: 0.5, ml: -0.5 } }),
      React22.createElement(
        Typography_default,
        { variant: "body2", component: "span" },
        React22.createElement(FieldTitle_default, { label, source, resource })
      )
    ),
    onMove && React22.createElement(import_DragIndicator.default, { className: "dragIcon", color: "disabled", fontSize: "small" })
  );
};
var Root5 = styled_default("div")(function(_a13) {
  var theme = _a13.theme;
  return {
    display: "flex",
...
var FieldsSelector = function(_a13) {
  ...
  return React23.createElement(
    ...
    availableFields.map(function(field) {
      return React23.createElement(FieldToggle, { key: field.index, source: field.source, label: field.label, index: field.index, selected: fields.includes(field.index), onToggle: handleToggle, onMove: handleMove });
    }),
    React23.createElement(
      Box_default,
      { display: "flex", justifyContent: "space-between", mx: -0.5, mt: 1 },
      React23.createElement(Button_default, { size: "small", onClick: handleHideAll }, translate("ra.inspector.hideAll", {
        _: "Hide All"
      })),
      React23.createElement(Button_default, { size: "small", onClick: handleShowAll }, translate("ra.inspector.showAll", {
        _: "Show All"
      }))
    )
  );
...
var InspectorRoot = function() {
  ...
  return React24.createElement(Typography_default, null, translate("ra.configurable.inspector.content", {
...
var Inspector = function() {
  ...
  var isDragging = (0, import_react17.useRef)(false);
  var removeItems = useRemoveItemsFromStore(preferenceKey);
  var theme = useTheme();
  var translate = useTranslate();
  var _b = (0, import_react17.useState)(0), version = _b[0], setVersion = _b[1];
  ...
  var _d = (0, import_react17.useState)(), clickPosition = _d[0], setClickPosition = _d[1];
  ...
  return React25.createElement(
    ...
    React25.createElement(
      ...
      React25.createElement(Typography_default, { id: "inspector-dialog-title", variant: "overline", component: "div", py: 1, px: 2, flex: "1" }, title && translate(title, titleOptions)),
      React25.createElement("span", { id: "inspector-toolbar" }),
      preferenceKey && React25.createElement(
        IconButton_default,
        { "aria-label": translate("ra.action.remove"), onClick: handleReset, size: "small" },
        React25.createElement(import_DeleteOutline.default, { fontSize: "inherit" })
      ),
      React25.createElement(
        IconButton_default,
        { "aria-label": translate("ra.action.close"), onClick: disable, size: "small", sx: { mr: 1 } },
        React25.createElement(import_CancelOutlined.default, { fontSize: "inherit" })
      )
    ),
    React25.createElement(
      "div",
      { className: InspectorClasses.content, key: version },
      React25.createElement(PreferenceKeyContextProvider, { value: preferenceKey }, editor || React25.createElement(InspectorRoot, null))
    )
  );
};
...
var InspectorButton = React26.forwardRef(function(_a13, ref) {
  var _b = _a13.label, label = _b === void 0 ? "ra.configurable.configureMode" : _b, _c = _a13.SvgIconProps, SvgIconProps = _c === void 0 ? {} : _c, props = __rest11(_a13, ["label", "SvgIconProps"]);
  ...
  return React26.createElement(
    ...
    React26.createElement(
      IconButton_default,
      __assign12({ "aria-label": translatedLabel, onClick: handleClick2, color: "inherit", ref }, props),
      React26.createElement(import_Settings2.default, __assign12({ fontSize: "inherit" }, SvgIconProps))
    )
  );
});
...
var PageTitle = function(_a13) {
  var title = _a13.title, defaultTitle = _a13.defaultTitle, className = _a13.className, rest = __rest12(_a13, ["title", "defaultTitle", "className"]);
  var titleFromPreferences = usePreference()[0];
  var translate = useTranslate();
  var record = useRecordContext();
  return titleFromPreferences ? React27.createElement("span", __assign13({ className }, rest), translate(titleFromPreferences, __assign13(__assign13({}, record), { _: titleFromPreferences }))) : React27.createElement("span", { className }, !title ? React27.createElement("span", __assign13({}, rest), defaultTitle) : typeof title === "string" ? React27.createElement("span", __assign13({}, rest), translate(title, { _: title })) : title);
};
...
var PageTitleEditor = function() {
  ...
  return React28.createElement(
    "form",
    null,
    React28.createElement(TextField_default, __assign14({ label: "title", variant: "filled", size: "small", fullWidth: true, sx: { mb: 1 } }, field))
  );
};
var PageTitleConfigurable = function(_a13) {
  var preferenceKey = _a13.preferenceKey, props = __rest13(_a13, ["preferenceKey"]);
  var pathname = useLocation().pathname;
  return React28.createElement(
    Configurable,
    { editor: React28.createElement(PageTitleEditor, null), preferenceKey: preferenceKey || "".concat(pathname, ".title"), sx: {
      "&.RaConfigurable-editMode": {
        margin: "2px"
      }
    } },
    React28.createElement(PageTitle, __assign14({}, props))
  );
};
...
var Title = function(props) {
  var defaultTitle = props.defaultTitle, title = props.title, preferenceKey = props.preferenceKey, rest = __rest14(props, ["defaultTitle", "title", "preferenceKey"]);
  var _a13 = (0, import_react18.useState)(function() {
  ...
  return (0, import_react_dom.createPortal)(React29.createElement(PageTitleConfigurable, __assign15({ title, defaultTitle, preferenceKey }, rest)), container);
};
var TitlePropType = import_prop_types14.default.oneOfType([
  import_prop_types14.default.string,
  import_prop_types14.default.element
]);
Title.propTypes = {
  defaultTitle: import_prop_types14.default.string,
  className: import_prop_types14.default.string,
  record: import_prop_types14.default.any,
  title: TitlePropType
};
...
var useResetErrorBoundaryOnLocationChange = function(resetErrorBoundary) {
  var pathname = useLocation().pathname;
  var originalPathname = (0, import_react19.useRef)(pathname);
...
var Error2 = function(props) {
  var error = props.error, ErrorComponent = props.errorComponent, errorInfo = props.errorInfo, resetErrorBoundary = props.resetErrorBoundary, className = props.className, title = props.title, rest = __rest15(props, ["error", "errorComponent", "errorInfo", "resetErrorBoundary", "className", "title"]);
  var translate = useTranslate();
  useResetErrorBoundaryOnLocationChange(resetErrorBoundary);
  if (ErrorComponent) {
    return React30.createElement(ErrorComponent, { error, errorInfo, title });
  }
  return React30.createElement(
    import_react20.Fragment,
    null,
    title && React30.createElement(Title, { title }),
    React30.createElement(
      Root6,
      __assign16({ className }, rest),
      React30.createElement(
        "h1",
        { className: ErrorClasses.title, role: "alert" },
        React30.createElement(import_Report.default, { className: ErrorClasses.icon }),
        translate("ra.page.error")
      ),
      React30.createElement("div", null, translate("ra.message.error")),
      React30.createElement(
        React30.Fragment,
        null,
        React30.createElement(
          ...
          React30.createElement(AccordionSummary_default, { expandIcon: React30.createElement(import_ExpandMore.default, null), className: ErrorClasses.panelSumary }, translate(error.message, {
            _: error.message
          })),
          React30.createElement(
            AccordionDetails_default,
            { className: ErrorClasses.panelDetails },
            React30.createElement("p", null, translate(error.message, {
              _: error.message
            })),
            React30.createElement("p", null, errorInfo === null || errorInfo === void 0 ? void 0 : errorInfo.componentStack)
          )
        ),
        React30.createElement(
          "div",
          { className: ErrorClasses.advice },
          React30.createElement(Typography_default, { align: "center" }, "Need help with this error? Try the following:"),
          React30.createElement(
            Typography_default,
            { component: "div" },
            React30.createElement(
              ...
              React30.createElement(
                ...
                "Check the",
                " ",
                React30.createElement("a", { href: "https://marmelab.com/react-admin/Readme.html" }, "react-admin documentation")
              ),
              React30.createElement(
                "li",
                null,
                "Search on",
                " ",
                React30.createElement("a", { href: "https://stackoverflow.com/questions/tagged/react-admin" }, "StackOverflow"),
                " ",
              ...
              React30.createElement(
                ...
                " ",
                React30.createElement("a", { href: "https://marmelab.com/ra-enterprise/#fromsww" }, "react-admin Enterprise Edition")
              )
            )
          )
        )
      ...
      React30.createElement(
        ...
        React30.createElement(Button_default, { variant: "contained", startIcon: React30.createElement(import_History.default, null), onClick: goBack }, translate("ra.action.back"))
      )
    )
  );
};
Error2.propTypes = {
  ...
  error: import_prop_types15.default.object.isRequired,
  errorInfo: import_prop_types15.default.object,
  title: TitlePropType
};
...
var ErrorBoundary = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (error !== null) {
      ...
      if (React31.isValidElement(fallback)) {
        return fallback;
      } else if (typeof fallbackRender === "function") {
        return fallbackRender(_props);
      } else if (FallbackComponent) {
        return React31.createElement(FallbackComponent, _props);
      } else {
...
var Sidebar = function(props) {
  var appBarAlwaysOn = props.appBarAlwaysOn, children = props.children, closedSize = props.closedSize, size = props.size, rest = __rest16(props, ["appBarAlwaysOn", "children", "closedSize", "size"]);
  var isXSmall = useMediaQuery(function(theme) {
    return theme.breakpoints.down("sm");
  });
  var _a13 = useSidebarState(), open = _a13[0], setOpen = _a13[1];
  ...
  return isXSmall ? React32.createElement(StyledDrawer, __assign17({ variant: "temporary", open, onClose: toggleSidebar, classes: SidebarClasses }, rest), children) : React32.createElement(
    StyledDrawer,
    __assign17({ variant: "permanent", open, onClose: toggleSidebar, classes: SidebarClasses, className: trigger && !appBarAlwaysOn ? SidebarClasses.appBarCollapsed : "" }, rest),
    React32.createElement("div", { className: SidebarClasses.fixed }, children)
  );
};
Sidebar.propTypes = {
...
var ResourceMenuItem = function(_a13) {
  ...
  if (!resources || !resources[name])
    return null;
  return React33.createElement(MenuItemLink, { to: createPath({
    resource: name,
    type: "list"
  }), state: { _scrollToTop: true }, primaryText: React33.createElement(React33.Fragment, null, getResourceLabel(name, 2)), leftIcon: resources[name].icon ? (0, import_react21.createElement)(resources[name].icon) : React33.createElement(import_ViewList.default, null) });
};
...
var Menu = function(props) {
  var _a13;
  var resources = useResourceDefinitions();
  var hasDashboard = props.hasDashboard, _b = props.children, children = _b === void 0 ? __spreadArray2([
    hasDashboard ? React34.createElement(DashboardMenuItem, { key: "default-dashboard-menu-item" }) : null
  ], Object.keys(resources).filter(function(name) {
    return resources[name].hasList;
  }).map(function(name) {
    return React34.createElement(ResourceMenuItem, { key: name, name });
  }), true) : _b, className = props.className, rest = __rest17(props, ["hasDashboard", "children", "className"]);
  var open = useSidebarState()[0];
  return React34.createElement(Root7, __assign18({ className: clsx_m_default((_a13 = {}, _a13[MenuClasses.open] = open, _a13[MenuClasses.closed] = !open, _a13), className) }, rest), children);
};
Menu.propTypes = {
  className: import_prop_types17.default.string,
  dense: import_prop_types17.default.bool,
  hasDashboard: import_prop_types17.default.bool
};
...
var Root7 = styled_default(MenuList_default, {
  name: PREFIX15,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var Layout = function(props) {
  var _a13 = props.appBar, AppBar2 = _a13 === void 0 ? AppBar : _a13, appBarAlwaysOn = props.appBarAlwaysOn, children = props.children, className = props.className, dashboard = props.dashboard, errorComponent = props.error, _b = props.menu, Menu2 = _b === void 0 ? Menu : _b, _c = props.sidebar, Sidebar2 = _c === void 0 ? Sidebar : _c, title = props.title, rest = __rest18(props, ["appBar", "appBarAlwaysOn", "children", "className", "dashboard", "error", "menu", "sidebar", "title"]);
  var open = useSidebarState()[0];
  var _d = (0, import_react22.useState)(null), errorInfo = _d[0], setErrorInfo = _d[1];
  var handleError = function(error, info) {
    setErrorInfo(info);
  };
  return import_react22.default.createElement(
    StyledLayout,
    __assign19({ className: clsx_m_default("layout", className) }, rest),
    import_react22.default.createElement(SkipNavigationButton, null),
    import_react22.default.createElement(
      "div",
      { className: LayoutClasses.appFrame },
      import_react22.default.createElement(AppBar2, { open, title, alwaysOn: appBarAlwaysOn }),
      import_react22.default.createElement(
        "main",
        ...
        import_react22.default.createElement(
          Sidebar2,
          { appBarAlwaysOn },
          import_react22.default.createElement(Menu2, { hasDashboard: !!dashboard })
        ),
        import_react22.default.createElement(
          "div",
          { id: "main-content", className: LayoutClasses.content },
          import_react22.default.createElement(ErrorBoundary, { onError: handleError, fallbackRender: function(_a14) {
            var error = _a14.error, resetErrorBoundary = _a14.resetErrorBoundary;
            return import_react22.default.createElement(Error2, { error, errorComponent, errorInfo, resetErrorBoundary, title });
          } }, children)
        )
      ),
      import_react22.default.createElement(Inspector, null)
    )
  );
};
...
var StyledLayout = styled_default("div", {
  name: PREFIX16,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var LinearProgress = function(_a13) {
  var _b = _a13.timeout, timeout = _b === void 0 ? 1e3 : _b, props = __rest19(_a13, ["timeout"]);
  var className = props.className, rest = __rest19(props, ["className"]);
  var oneSecondHasPassed = useTimeout(timeout);
  return oneSecondHasPassed ? React36.createElement(StyledProgress, __assign20({ className }, rest)) : React36.createElement(Box_default, { my: 1, height: 4 });
};
LinearProgress.propTypes = {
  className: import_prop_types18.default.string,
  timeout: import_prop_types18.default.number
};
...
var Loading = function(props) {
  var className = props.className, _a13 = props.loadingPrimary, loadingPrimary = _a13 === void 0 ? "ra.page.loading" : _a13, _b = props.loadingSecondary, loadingSecondary = _b === void 0 ? "ra.message.loading" : _b, rest = __rest20(props, ["className", "loadingPrimary", "loadingSecondary"]);
  var translate = useTranslate();
  return React37.createElement(
    Root8,
    __assign21({ className }, rest),
    React37.createElement(
      "div",
      { className: LoadingClasses.message },
      React37.createElement(CircularProgress_default, { className: LoadingClasses.icon, color: "primary" }),
      React37.createElement("h1", null, translate(loadingPrimary, { _: loadingPrimary })),
      React37.createElement("div", null, translate(loadingSecondary, { _: loadingSecondary }))
    )
  );
};
Loading.propTypes = {
  className: import_prop_types19.default.string,
  loadingPrimary: import_prop_types19.default.string,
  loadingSecondary: import_prop_types19.default.string
};
...
var LoadingPage = function(_a13) {
  var _b = _a13.loadingPrimary, loadingPrimary = _b === void 0 ? "ra.page.loading" : _b, _c = _a13.loadingSecondary, loadingSecondary = _c === void 0 ? "ra.message.loading" : _c, props = __rest21(_a13, ["loadingPrimary", "loadingSecondary"]);
  return React38.createElement(Loading, __assign22({ loadingPrimary, loadingSecondary }, props));
};
LoadingPage.propTypes = {
  theme: import_prop_types20.default.object,
  className: import_prop_types20.default.string,
  loadingPrimary: import_prop_types20.default.string,
  loadingSecondary: import_prop_types20.default.string
};
...
var NotFound = function(props) {
  var className = props.className, title = props.title, rest = __rest22(props, ["className", "title"]);
  var translate = useTranslate();
  useAuthenticated();
  return React39.createElement(
    Root9,
    __assign23({ className }, sanitizeRestProps2(rest)),
    React39.createElement(Title, { defaultTitle: title }),
    React39.createElement(
      "div",
      { className: NotFoundClasses.message },
      React39.createElement(import_HotTub.default, { className: NotFoundClasses.icon }),
      React39.createElement("h1", null, translate("ra.page.not_found")),
      React39.createElement(
        "div",
        null,
    ...
    React39.createElement(
      ...
      React39.createElement(Button_default, { variant: "contained", startIcon: React39.createElement(import_History2.default, null), onClick: goBack2 }, translate("ra.action.back"))
    )
  );
};
var sanitizeRestProps2 = function(_a13) {
  var staticContext = _a13.staticContext, history = _a13.history, location = _a13.location, match = _a13.match, rest = __rest22(_a13, ["staticContext", "history", "location", "match"]);
  return rest;
};
NotFound.propTypes = {
...
var Notification = function(props) {
  ...
  var handleRequestClose = (0, import_react23.useCallback)(function() {
    setOpen(false);
  }, [setOpen]);
  var handleExited = (0, import_react23.useCallback)(function() {
  ...
  var handleUndo = (0, import_react23.useCallback)(function() {
    undoableEventEmitter_default.emit("end", { isUndo: true });
    setOpen(false);
  }, []);
  if (!messageInfo)
    return null;
  var message = messageInfo.message, typeFromMessage = messageInfo.type, _j = messageInfo.notificationOptions, autoHideDurationFromMessage = _j.autoHideDuration, messageArgs = _j.messageArgs, multilineFromMessage = _j.multiLine, undoable = _j.undoable, options = __rest23(_j, ["autoHideDuration", "messageArgs", "multiLine", "undoable"]);
  return React40.createElement(StyledSnackbar, __assign24({ className, open, message: message && typeof message === "string" && translate(message, messageArgs), autoHideDuration: autoHideDurationFromMessage || autoHideDuration, disableWindowBlurListener: undoable, TransitionProps: { onExited: handleExited }, onClose: handleRequestClose, ContentProps: {
  ...
  }, action: undoable ? React40.createElement(
    Button_default,
    { color: "primary", className: NotificationClasses.undo, size: "small", onClick: handleUndo },
    React40.createElement(React40.Fragment, null, translate("ra.action.undo"))
...
var ThemeProvider2 = function(_a13) {
  var children = _a13.children, themeOverride = _a13.theme;
  var _b = useThemesContext(), lightTheme = _b.lightTheme, darkTheme = _b.darkTheme, defaultTheme2 = _b.defaultTheme;
  var prefersDarkMode = useMediaQuery("(prefers-color-scheme: dark)", {
    noSsr: true
  });
  var mode = useTheme2(defaultTheme2 || (prefersDarkMode && darkTheme ? "dark" : "light"))[0];
  var themeValue = (0, import_react24.useMemo)(function() {
    try {
      return createTheme_default(typeof mode === "object" ? mode : mode === "dark" ? darkTheme : lightTheme || themeOverride);
    } catch (e) {
      console.warn("Failed to reuse custom theme from store", e);
      return createTheme_default();
    }
  }, [mode, themeOverride, lightTheme, darkTheme]);
  return React41.createElement(ThemeProvider, { theme: themeValue }, children);
};
...
var TopToolbar = function(props) {
  return React42.createElement(StyledToolbar, __assign25({}, props));
};
...
var useUserMenu = function() {
  return (0, import_react25.useContext)(UserMenuContext);
};
...
var BulkDeleteWithConfirmButton = function(props) {
  var _a13 = props.confirmTitle, confirmTitle = _a13 === void 0 ? "ra.message.bulk_delete_title" : _a13, _b = props.confirmContent, confirmContent = _b === void 0 ? "ra.message.bulk_delete_content" : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon6 : _c, _d = props.label, label = _d === void 0 ? "ra.action.delete" : _d, _e = props.mutationMode, mutationMode = _e === void 0 ? "pessimistic" : _e, _f = props.mutationOptions, mutationOptions = _f === void 0 ? {} : _f, onClick = props.onClick, rest = __rest24(props, ["confirmTitle", "confirmContent", "icon", "label", "mutationMode", "mutationOptions", "onClick"]);
  var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest24(mutationOptions, ["meta"]);
  ...
  var translate = useTranslate();
  var _j = useDeleteMany(resource, { ids: selectedIds, meta: mutationMeta }, __assign26({ onSuccess: function() {
    refresh();
  ...
  return React43.createElement(
    ...
    null,
    React43.createElement(StyledButton4, __assign26({ onClick: handleClick2, label }, sanitizeRestProps3(rest)), icon),
    React43.createElement(Confirm, { isOpen, loading: isLoading, title: confirmTitle, content: confirmContent, translateOptions: {
...
var sanitizeRestProps3 = function(_a13) {
  var classes = _a13.classes, filterValues = _a13.filterValues, label = _a13.label, selectedIds = _a13.selectedIds, rest = __rest24(_a13, ["classes", "filterValues", "label", "selectedIds"]);
  return rest;
};
...
var defaultIcon6 = React43.createElement(import_Delete.default, null);
BulkDeleteWithConfirmButton.propTypes = {
  confirmTitle: import_prop_types24.default.string,
  confirmContent: import_prop_types24.default.string,
  icon: import_prop_types24.default.element,
  label: import_prop_types24.default.string,
  mutationMode: import_prop_types24.default.oneOf(["pessimistic", "optimistic", "undoable"]),
  resource: import_prop_types24.default.string,
  selectedIds: import_prop_types24.default.arrayOf(import_prop_types24.default.any)
};
...
var BulkDeleteWithUndoButton = function(props) {
  var _a13 = props.label, label = _a13 === void 0 ? "ra.action.delete" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon7 : _b, onClick = props.onClick, _c = props.mutationOptions, mutationOptions = _c === void 0 ? {} : _c, rest = __rest25(props, ["label", "icon", "onClick", "mutationOptions"]);
  var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest25(mutationOptions, ["meta"]);
  ...
  var handleClick2 = function(e) {
    deleteMany(resource, { ids: selectedIds, meta: mutationMeta }, __assign27({ onSuccess: function() {
      notify("ra.notification.deleted", {
        type: "info",
        messageArgs: { smart_count: selectedIds.length },
        undoable: true
  ...
  return React44.createElement(StyledButton5, __assign27({ onClick: handleClick2, label, disabled: isLoading }, sanitizeRestProps4(rest)), icon);
};
var defaultIcon7 = React44.createElement(import_Delete2.default, null);
var sanitizeRestProps4 = function(_a13) {
  var classes = _a13.classes, filterValues = _a13.filterValues, label = _a13.label, selectedIds = _a13.selectedIds, rest = __rest25(_a13, ["classes", "filterValues", "label", "selectedIds"]);
  return rest;
};
...
BulkDeleteWithUndoButton.propTypes = {
  ...
  resource: import_prop_types25.default.string,
  selectedIds: import_prop_types25.default.arrayOf(import_prop_types25.default.any),
  icon: import_prop_types25.default.element
};
...
var BulkDeleteButton = function(_a13) {
  var _b = _a13.mutationMode, mutationMode = _b === void 0 ? "undoable" : _b, props = __rest26(_a13, ["mutationMode"]);
  return mutationMode === "undoable" ? React45.createElement(BulkDeleteWithUndoButton, __assign28({}, props)) : React45.createElement(BulkDeleteWithConfirmButton, __assign28({ mutationMode }, props));
};
BulkDeleteButton.propTypes = {
  label: import_prop_types26.default.string,
  resource: import_prop_types26.default.string,
  selectedIds: import_prop_types26.default.arrayOf(import_prop_types26.default.any),
  mutationMode: import_prop_types26.default.oneOf(["pessimistic", "optimistic", "undoable"]),
...
var BulkExportButton = function(props) {
  var onClick = props.onClick, _a13 = props.label, label = _a13 === void 0 ? "ra.action.export" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon8 : _b, customExporter = props.exporter, meta = props.meta, rest = __rest27(props, ["onClick", "label", "icon", "exporter", "meta"]);
  ...
  var notify = useNotify();
  var handleClick2 = (0, import_react27.useCallback)(function(event) {
  ...
  return React46.createElement(Button, __assign29({ onClick: handleClick2, label }, sanitizeRestProps5(rest)), icon);
};
var defaultIcon8 = React46.createElement(import_GetApp.default, null);
var sanitizeRestProps5 = function(_a13) {
  var filterValues = _a13.filterValues, selectedIds = _a13.selectedIds, resource = _a13.resource, rest = __rest27(_a13, ["filterValues", "selectedIds", "resource"]);
  return rest;
};
BulkExportButton.propTypes = {
  exporter: import_prop_types27.default.func,
  label: import_prop_types27.default.string,
  resource: import_prop_types27.default.string,
  selectedIds: import_prop_types27.default.arrayOf(import_prop_types27.default.any),
  icon: import_prop_types27.default.element,
  meta: import_prop_types27.default.any
};
...
var BulkUpdateWithConfirmButton = function(props) {
  ...
  var _a13 = (0, import_react28.useState)(false), isOpen = _a13[0], setOpen = _a13[1];
  var selectedIds = useListContext(props).selectedIds;
  var _b = props.confirmTitle, confirmTitle = _b === void 0 ? "ra.message.bulk_update_title" : _b, _c = props.confirmContent, confirmContent = _c === void 0 ? "ra.message.bulk_update_content" : _c, data = props.data, _d = props.icon, icon = _d === void 0 ? defaultIcon9 : _d, _e = props.label, label = _e === void 0 ? "ra.action.update" : _e, _f = props.mutationMode, mutationMode = _f === void 0 ? "pessimistic" : _f, onClick = props.onClick, _g = props.onSuccess, onSuccess = _g === void 0 ? function() {
    refresh();
    ...
    setOpen(false);
  } : _h, _j = props.mutationOptions, mutationOptions = _j === void 0 ? {} : _j, rest = __rest28(props, ["confirmTitle", "confirmContent", "data", "icon", "label", "mutationMode", "onClick", "onSuccess", "onError", "mutationOptions"]);
  var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest28(mutationOptions, ["meta"]);
  var _k = useUpdateMany(resource, { ids: selectedIds, data, meta: mutationMeta }, __assign30({ onSuccess, onError, mutationMode }, otherMutationOptions)), updateMany = _k[0], isLoading = _k[1].isLoading;
  var handleClick2 = function(e) {
    setOpen(true);
    e.stopPropagation();
  };
  ...
  return React47.createElement(
    ...
    null,
    React47.createElement(StyledButton6, __assign30({ onClick: handleClick2, label }, sanitizeRestProps6(rest)), icon),
    React47.createElement(Confirm, { isOpen, loading: isLoading, title: confirmTitle, content: confirmContent, translateOptions: {
      smart_count: selectedIds.length,
      name: translate("resources.".concat(resource, ".forcedCaseName"), {
        smart_count: selectedIds.length,
...
var sanitizeRestProps6 = function(_a13) {
  var filterValues = _a13.filterValues, label = _a13.label, onSuccess = _a13.onSuccess, onError = _a13.onError, rest = __rest28(_a13, ["filterValues", "label", "onSuccess", "onError"]);
  return rest;
};
BulkUpdateWithConfirmButton.propTypes = {
  confirmTitle: import_prop_types28.default.string,
  confirmContent: import_prop_types28.default.string,
  label: import_prop_types28.default.string,
  resource: import_prop_types28.default.string,
  selectedIds: import_prop_types28.default.arrayOf(import_prop_types28.default.any),
  icon: import_prop_types28.default.element,
  data: import_prop_types28.default.any.isRequired,
  mutationMode: import_prop_types28.default.oneOf(["pessimistic", "optimistic", "undoable"])
};
...
var defaultIcon9 = React47.createElement(import_Update.default, null);
...
var BulkUpdateWithUndoButton = function(props) {
  ...
  var unselectAll = useUnselectAll(resource);
  var refresh = useRefresh();
  var data = props.data, _a13 = props.label, label = _a13 === void 0 ? "ra.action.update" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon10 : _b, onClick = props.onClick, _c = props.onSuccess, onSuccess = _c === void 0 ? function() {
    notify("ra.notification.updated", {
      type: "info",
      messageArgs: { smart_count: selectedIds.length },
      undoable: true
    ...
    refresh();
  } : _d, _e = props.mutationOptions, mutationOptions = _e === void 0 ? {} : _e, rest = __rest29(props, ["data", "label", "icon", "onClick", "onSuccess", "onError", "mutationOptions"]);
  var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest29(mutationOptions, ["meta"]);
  var _f = useUpdateMany(resource, { ids: selectedIds, data, meta: mutationMeta }, __assign31({ onSuccess, onError, mutationMode: "undoable" }, otherMutationOptions)), updateMany = _f[0], isLoading = _f[1].isLoading;
  var handleClick2 = function(e) {
    updateMany();
    if (typeof onClick === "function") {
      onClick(e);
  ...
  return React48.createElement(StyledButton7, __assign31({ onClick: handleClick2, label, disabled: isLoading }, sanitizeRestProps7(rest)), icon);
};
var defaultIcon10 = React48.createElement(import_Update2.default, null);
var sanitizeRestProps7 = function(_a13) {
  var filterValues = _a13.filterValues, label = _a13.label, selectedIds = _a13.selectedIds, onSuccess = _a13.onSuccess, onError = _a13.onError, rest = __rest29(_a13, ["filterValues", "label", "selectedIds", "onSuccess", "onError"]);
  return rest;
};
BulkUpdateWithUndoButton.propTypes = {
  label: import_prop_types29.default.string,
  resource: import_prop_types29.default.string,
  selectedIds: import_prop_types29.default.arrayOf(import_prop_types29.default.any),
  icon: import_prop_types29.default.element,
  data: import_prop_types29.default.any.isRequired
};
...
var BulkUpdateButton = function(props) {
  var mutationMode = props.mutationMode, rest = __rest30(props, ["mutationMode"]);
  return mutationMode === "undoable" ? React49.createElement(BulkUpdateWithUndoButton, __assign32({}, rest)) : React49.createElement(BulkUpdateWithConfirmButton, __assign32({ mutationMode }, rest));
};
BulkUpdateButton.propTypes = {
  label: import_prop_types30.default.string,
  resource: import_prop_types30.default.string,
  selectedIds: import_prop_types30.default.arrayOf(import_prop_types30.default.any),
  mutationMode: import_prop_types30.default.oneOf(["pessimistic", "optimistic", "undoable"]),
...
var DeleteWithUndoButton = function(props) {
  var _a13 = props.label, label = _a13 === void 0 ? "ra.action.delete" : _a13, className = props.className, _b = props.icon, icon = _b === void 0 ? defaultIcon11 : _b, onClick = props.onClick, _c = props.redirect, redirect = _c === void 0 ? "list" : _c, mutationOptions = props.mutationOptions, _d = props.color, color = _d === void 0 ? "error" : _d, rest = __rest31(props, ["label", "className", "icon", "onClick", "redirect", "mutationOptions", "color"]);
  var record = useRecordContext(props);
  var resource = useResourceContext(props);
  ...
  return React50.createElement(Button, __assign33({ onClick: handleDelete, disabled: isLoading, label, className: clsx_m_default("ra-delete-button", className), key: "button", color }, rest), icon);
};
var defaultIcon11 = React50.createElement(import_Delete3.default, null);
DeleteWithUndoButton.propTypes = {
  className: import_prop_types31.default.string,
  label: import_prop_types31.default.string,
  record: import_prop_types31.default.any,
  redirect: import_prop_types31.default.oneOfType([
    import_prop_types31.default.string,
    import_prop_types31.default.bool,
    import_prop_types31.default.func
  ]),
  resource: import_prop_types31.default.string,
...
var DeleteWithConfirmButton = function(props) {
  var className = props.className, _a13 = props.confirmTitle, confirmTitle = _a13 === void 0 ? "ra.message.delete_title" : _a13, _b = props.confirmContent, confirmContent = _b === void 0 ? "ra.message.delete_content" : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon12 : _c, _d = props.label, label = _d === void 0 ? "ra.action.delete" : _d, _e = props.mutationMode, mutationMode = _e === void 0 ? "pessimistic" : _e, onClick = props.onClick, _f = props.redirect, redirect = _f === void 0 ? "list" : _f, _g = props.translateOptions, translateOptions = _g === void 0 ? {} : _g, mutationOptions = props.mutationOptions, _h = props.color, color = _h === void 0 ? "error" : _h, rest = __rest32(props, ["className", "confirmTitle", "confirmContent", "icon", "label", "mutationMode", "onClick", "redirect", "translateOptions", "mutationOptions", "color"]);
  var translate = useTranslate();
  var record = useRecordContext(props);
  var resource = useResourceContext(props);
  ...
  return import_react29.default.createElement(
    ...
    null,
    import_react29.default.createElement(Button, __assign34({ onClick: handleDialogOpen, label, className: clsx_m_default("ra-delete-button", className), key: "button", color }, rest), icon),
    import_react29.default.createElement(Confirm, { isOpen: open, loading: isLoading, title: confirmTitle, content: confirmContent, translateOptions: __assign34({ name: translate("resources.".concat(resource, ".forcedCaseName"), {
      smart_count: 1,
...
var defaultIcon12 = import_react29.default.createElement(import_Delete4.default, null);
DeleteWithConfirmButton.propTypes = {
  className: import_prop_types32.default.string,
  confirmTitle: import_prop_types32.default.string,
  confirmContent: import_prop_types32.default.string,
  label: import_prop_types32.default.string,
  mutationMode: import_prop_types32.default.oneOf(["pessimistic", "optimistic", "undoable"]),
  record: import_prop_types32.default.any,
  redirect: import_prop_types32.default.oneOfType([
    import_prop_types32.default.string,
    import_prop_types32.default.bool,
    import_prop_types32.default.func
  ]),
  resource: import_prop_types32.default.string,
  icon: import_prop_types32.default.element,
  translateOptions: import_prop_types32.default.object
};
...
var DeleteButton = function(props) {
  var mutationMode = props.mutationMode, rest = __rest33(props, ["mutationMode"]);
  var record = useRecordContext(props);
  ...
  return finalMutationMode === "undoable" ? (
    ...
    React52.createElement(DeleteWithUndoButton, __assign35({ record }, rest))
  ) : React52.createElement(DeleteWithConfirmButton, __assign35({
    // @ts-ignore I looked for the error for one hour without finding it
...
DeleteButton.propTypes = {
  ...
  mutationMode: import_prop_types33.default.oneOf(["pessimistic", "optimistic", "undoable"]),
  record: import_prop_types33.default.any,
  // @ts-ignore
  redirect: import_prop_types33.default.oneOfType([
    import_prop_types33.default.string,
    import_prop_types33.default.bool,
    import_prop_types33.default.func
  ]),
  resource: import_prop_types33.default.string,
...
var EditButton = function(props) {
  var _a13 = props.icon, icon = _a13 === void 0 ? defaultIcon13 : _a13, _b = props.label, label = _b === void 0 ? "ra.action.edit" : _b, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, className = props.className, rest = __rest34(props, ["icon", "label", "scrollToTop", "className"]);
  var resource = useResourceContext(props);
  var record = useRecordContext(props);
  var createPath = useCreatePath();
  if (!record)
    return null;
  return React53.createElement(StyledButton8, __assign36({ component: Link, to: createPath({ type: "edit", resource, id: record.id }), state: scrollStates3[String(scrollToTop)], label, onClick: stopPropagation3, className: clsx_m_default(EditButtonClasses.root, className) }, rest), icon);
};
var scrollStates3 = {
  true: { _scrollToTop: true },
  false: {}
};
var defaultIcon13 = React53.createElement(import_Create.default, null);
var stopPropagation3 = function(e) {
  return e.stopPropagation();
};
EditButton.propTypes = {
  icon: import_prop_types34.default.element,
  label: import_prop_types34.default.string,
  record: import_prop_types34.default.any,
  scrollToTop: import_prop_types34.default.bool
};
var PREFIX26 = "RaEditButton";
var EditButtonClasses = {
  root: "".concat(PREFIX26, "-root")
};
var StyledButton8 = styled_default(Button, {
  name: PREFIX26,
  overridesResolver: function(_props, styles) {
    return styles.root;
  }
...
var ExportButton = function(props) {
  var _a13 = props.maxResults, maxResults = _a13 === void 0 ? 1e3 : _a13, onClick = props.onClick, _b = props.label, label = _b === void 0 ? "ra.action.export" : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon14 : _c, customExporter = props.exporter, meta = props.meta, rest = __rest35(props, ["maxResults", "onClick", "label", "icon", "exporter", "meta"]);
  ...
  var dataProvider = useDataProvider();
  var notify = useNotify();
  var handleClick2 = (0, import_react30.useCallback)(function(event) {
    dataProvider.getList(resource, {
      sort,
      filter: filter ? __assign37(__assign37({}, filterValues), filter) : filterValues,
  ...
  return React54.createElement(Button, __assign37({ onClick: handleClick2, label, disabled: total === 0 }, sanitizeRestProps8(rest)), icon);
};
var defaultIcon14 = React54.createElement(import_GetApp2.default, null);
var sanitizeRestProps8 = function(_a13) {
  var filterValues = _a13.filterValues, resource = _a13.resource, rest = __rest35(_a13, ["filterValues", "resource"]);
  return rest;
};
ExportButton.propTypes = {
  exporter: import_prop_types35.default.func,
  filterValues: import_prop_types35.default.object,
  label: import_prop_types35.default.string,
  maxResults: import_prop_types35.default.number,
  resource: import_prop_types35.default.string,
  sort: import_prop_types35.default.exact({
    field: import_prop_types35.default.string,
    order: import_prop_types35.default.string
  }),
  icon: import_prop_types35.default.element,
  meta: import_prop_types35.default.any
};
...
var IconButtonWithTooltip = function(_a13) {
  var label = _a13.label, onClick = _a13.onClick, props = __rest36(_a13, ["label", "onClick"]);
  var translate = useTranslate();
  var _b = React55.useState(false), open = _b[0], setOpen = _b[1];
  var handleClose = function() {
    setOpen(false);
  };
  ...
  return React55.createElement(
    ...
    React55.createElement(IconButton_default, __assign38({ "aria-label": translatedLabel, onClick: handleClick2 }, props))
  );
};
...
var LocalesMenuButton = function(props) {
  var _a13 = (0, import_react31.useState)(null), anchorEl = _a13[0], setAnchorEl = _a13[1];
  ...
  return React56.createElement(
    Root10,
    { component: "span" },
    React56.createElement(Button_default, { color: "inherit", "aria-controls": "simple-menu", "aria-label": "", "aria-haspopup": "true", onClick: handleLanguageClick, startIcon: React56.createElement(import_Translate.default, null), endIcon: React56.createElement(import_ExpandMore2.default, { fontSize: "small" }) }, getNameForLocale(locale)),
    React56.createElement(Menu_default, { id: "simple-menu", anchorEl, keepMounted: true, open: Boolean(anchorEl), onClose: handleClose }, languages.map(function(language) {
      return React56.createElement(MenuItem_default, { key: language.locale, onClick: changeLocale(language.locale), selected: language.locale === locale }, language.name);
    }))
  );
};
var PREFIX27 = "RaLocalesMenuButton";
var LocalesMenuButtonClasses = {};
var Root10 = styled_default(Box_default, {
  name: PREFIX27,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ListButton = function(props) {
  var _a13 = props.icon, icon = _a13 === void 0 ? defaultIcon15 : _a13, _b = props.label, label = _b === void 0 ? "ra.action.list" : _b, resourceProp = props.resource, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, rest = __rest37(props, ["icon", "label", "resource", "scrollToTop"]);
  var resource = useResourceContext(props);
  var createPath = useCreatePath();
  return React57.createElement(Button, __assign39({ component: Link, to: createPath({ type: "list", resource }), state: scrollStates4[String(scrollToTop)], label }, rest), icon);
};
var scrollStates4 = {
  true: { _scrollToTop: true },
  false: {}
};
var defaultIcon15 = React57.createElement(import_List.default, null);
...
var RefreshButton = function(props) {
  var _a13 = props.label, label = _a13 === void 0 ? "ra.action.refresh" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon16 : _b, onClick = props.onClick, rest = __rest38(props, ["label", "icon", "onClick"]);
  var refresh = useRefresh();
  var handleClick2 = (0, import_react32.useCallback)(function(event) {
    event.preventDefault();
    refresh();
    if (typeof onClick === "function") {
      onClick(event);
  ...
  return React58.createElement(Button, __assign40({ label, onClick: handleClick2 }, rest), icon);
};
var defaultIcon16 = React58.createElement(import_Refresh.default, null);
...
var RefreshIconButton = function(props) {
  var _a13 = props.label, label = _a13 === void 0 ? "ra.action.refresh" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon17 : _b, onClick = props.onClick, className = props.className, rest = __rest39(props, ["label", "icon", "onClick", "className"]);
  var refresh = useRefresh();
  var translate = useTranslate();
  var handleClick2 = (0, import_react33.useCallback)(function(event) {
    event.preventDefault();
    refresh();
    if (typeof onClick === "function") {
      onClick(event);
  ...
  return React59.createElement(
    ...
    React59.createElement(IconButton_default, __assign41({ "aria-label": label && translate(label, { _: "Refresh" }), className, color: "inherit", onClick: handleClick2 }, rest), icon)
  );
};
var defaultIcon17 = React59.createElement(import_Refresh2.default, null);
...
var SaveButton = function(props) {
  var _a13 = props.color, color = _a13 === void 0 ? "primary" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon18 : _b, invalid = props.invalid, _c = props.label, label = _c === void 0 ? "ra.action.save" : _c, onClick = props.onClick, mutationOptions = props.mutationOptions, disabledProp = props.disabled, _d = props.type, type = _d === void 0 ? "submit" : _d, transform = props.transform, _e = props.variant, variant = _e === void 0 ? "contained" : _e, _f = props.alwaysEnable, alwaysEnable = _f === void 0 ? false : _f, rest = __rest40(props, ["color", "icon", "invalid", "label", "onClick", "mutationOptions", "disabled", "type", "transform", "variant", "alwaysEnable"]);
  var translate = useTranslate();
  ...
  var handleSubmit2 = (0, import_react34.useCallback)(function(values) {
        ...
        switch (_a14.label) {
          case 0:
            if (!(saveContext === null || saveContext === void 0 ? void 0 : saveContext.save))
              return [3, 2];
            return [4, saveContext.save(values, __assign42(__assign42({}, mutationOptions), { transform }))];
          case 1:
            errors = _a14.sent();
            _a14.label = 2;
          case 2:
  ...
  var handleClick2 = (0, import_react34.useCallback)(function(event) {
    return __awaiter(void 0, void 0, void 0, function() {
      return __generator(this, function(_a14) {
        switch (_a14.label) {
          case 0:
  ...
  return React60.createElement(
    StyledButton9,
    __assign42({ variant, type, color, "aria-label": displayedLabel, disabled, onClick: handleClick2 }, rest),
    isSubmitting ? React60.createElement(CircularProgress_default, { sx: circularProgressStyle, size: 14, thickness: 3, color: "inherit" }) : icon,
    displayedLabel
  );
};
...
var defaultIcon18 = React60.createElement(import_Save.default, null);
SaveButton.propTypes = {
  className: import_prop_types39.default.string,
  invalid: import_prop_types39.default.bool,
  label: import_prop_types39.default.string,
  variant: import_prop_types39.default.oneOf(["text", "outlined", "contained"]),
  icon: import_prop_types39.default.element,
  alwaysEnable: import_prop_types39.default.bool
};
var PREFIX28 = "RaSaveButton";
var StyledButton9 = styled_default(Button_default, {
  name: PREFIX28,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var SkipNavigationButton = function() {
  return import_react35.default.createElement(StyledButton10, { onClick: skipToContent, className: "skip-nav-button", label: "ra.navigation.skip_nav", variant: "contained" });
};
...
var AuthError = function(props) {
  var className = props.className, _a13 = props.title, title = _a13 === void 0 ? "ra.page.error" : _a13, _b = props.message, message = _b === void 0 ? "ra.message.auth_error" : _b, rest = __rest41(props, ["className", "title", "message"]);
  var translate = useTranslate();
  return React62.createElement(
    Root11,
    __assign43({ className }, rest),
    React62.createElement(
      "div",
      { className: AuthErrorClasses.message },
      React62.createElement("h1", null, translate(title, { _: title })),
      React62.createElement("div", null, translate(message, { _: message })),
      React62.createElement(
        Button,
        { to: "/login", label: "ra.auth.sign_in" },
        React62.createElement(import_Lock.default, null)
      )
    )
  );
};
AuthError.propTypes = {
  ...
  message: import_prop_types40.default.string
};
var PREFIX30 = "RaAuthError";
var AuthErrorClasses = {
  root: "".concat(PREFIX30, "-root"),
  message: "".concat(PREFIX30, "-message")
};
...
var AuthCallback = function() {
  ...
  if (error) {
    return React63.createElement(AuthError, { message: error ? error.message : void 0 });
  }
  return hasOneSecondPassed ? React63.createElement(Loading, null) : null;
};
...
var InputHelperText = function(props) {
  ...
  if (touched && error) {
    if (error.message) {
      return React64.createElement(ValidationError_default, { error });
    }
    return React64.createElement(React64.Fragment, null, error);
  }
  if (helperText === false) {
    return null;
  }
  if ((0, import_react36.isValidElement)(helperText)) {
    return helperText;
  }
  if (typeof helperText === "string") {
    return React64.createElement(React64.Fragment, null, translate(helperText, { _: helperText }));
  }
  return React64.createElement("span", { dangerouslySetInnerHTML: defaultInnerHTML });
};
...
var Labeled = function(_a13) {
  var _b;
  var _c, _d;
  var children = _a13.children, _e = _a13.className, className = _e === void 0 ? "" : _e, _f = _a13.color, color = _f === void 0 ? "textSecondary" : _f, _g = _a13.component, component = _g === void 0 ? "span" : _g, fullWidth = _a13.fullWidth, isRequired2 = _a13.isRequired, label = _a13.label, resource = _a13.resource, source = _a13.source, rest = __rest43(_a13, ["children", "className", "color", "component", "fullWidth", "isRequired", "label", "resource", "source"]);
  return React65.createElement(
    ...
    label !== false && children.props.label !== false && typeof children.type !== "string" && // @ts-ignore
    ((_c = children.type) === null || _c === void 0 ? void 0 : _c.displayName) !== "Labeled" && // @ts-ignore
    ((_d = children.type) === null || _d === void 0 ? void 0 : _d.displayName) !== "Labeled" ? React65.createElement(
      Typography_default,
      { color, className: LabeledClasses.label },
      React65.createElement(FieldTitle_default, { label: label || children.props.label, source: source || children.props.source, resource, isRequired: isRequired2 })
    ) : null,
    children
  );
};
Labeled.displayName = "Labeled";
var PREFIX31 = "RaLabeled";
var LabeledClasses = {
  label: "".concat(PREFIX31, "-label"),
  fullWidth: "".concat(PREFIX31, "-fullWidth")
};
var Root12 = styled_default(Stack_default, {
  name: PREFIX31,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ArrayInputContext = (0, import_react37.createContext)(void 0);
...
var ArrayInput = function(props) {
  ...
  if (isLoading) {
    return React66.createElement(
      Labeled,
      { label, className },
      React66.createElement(LinearProgress, null)
    );
  }
  var renderHelperText = helperText !== false || (isDirty || isSubmitted) && !!error;
  return React66.createElement(
    Root13,
    __assign45({ fullWidth: true, margin, className: clsx_m_default("ra-input", "ra-input-".concat(source), ArrayInputClasses.root, className), error: (isDirty || isSubmitted) && !!error }, sanitizeInputRestProps(rest)),
    React66.createElement(
      InputLabel_default,
      { htmlFor: source, className: ArrayInputClasses.label, shrink: true, error: (isDirty || isSubmitted) && !!error },
      React66.createElement(FieldTitle_default, { label, source, resource: resourceFromProps, isRequired: isRequired(validate) })
    ),
    React66.createElement(ArrayInputContext.Provider, { value: fieldProps }, (0, import_react38.cloneElement)(import_react38.Children.only(children), __assign45(__assign45({}, fieldProps), { record, resource: resourceFromProps, source, variant, margin, disabled }))),
    renderHelperText ? React66.createElement(
      FormHelperText_default,
      { error: (isDirty || isSubmitted) && !!error },
      React66.createElement(InputHelperText, {
...
var PREFIX32 = "RaArrayInput";
var ArrayInputClasses = {
  root: "".concat(PREFIX32, "-root"),
  label: "".concat(PREFIX32, "-label")
};
var Root13 = styled_default(FormControl_default, {
  name: PREFIX32,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var useArrayInput = function(props) {
  var context = (0, import_react39.useContext)(ArrayInputContext);
  var memo22 = (0, import_react39.useMemo)(function() {
    return {
...
var SimpleFormIteratorContext = (0, import_react40.createContext)(void 0);
...
var useSimpleFormIterator = function() {
  return (0, import_react41.useContext)(SimpleFormIteratorContext);
};

// node_modules/ra-ui-materialui/dist/esm/input/ArrayInput/SimpleFormIteratorItemContext.js
var import_react42 = __toESM(require_react());
var SimpleFormIteratorItemContext = (0, import_react42.createContext)(void 0);
...
var SimpleFormIteratorItem = React67.forwardRef(function(props, ref) {
  var children = props.children, disabled = props.disabled, disableReordering = props.disableReordering, disableRemove = props.disableRemove, getItemLabel = props.getItemLabel, index = props.index, _a13 = props.inline, inline = _a13 === void 0 ? false : _a13, member = props.member, record = props.record, removeButton = props.removeButton, reOrderButtons = props.reOrderButtons, resource = props.resource, source = props.source;
  ...
  var handleRemoveButtonClick = function(originalOnClickHandler, index2) {
  ...
  var context = (0, import_react43.useMemo)(function() {
    return {
      index,
      total,
  ...
  return React67.createElement(
    ...
    React67.createElement(
      ...
      label && React67.createElement(Typography_default, { variant: "body2", className: SimpleFormIteratorClasses.index }, label),
      React67.createElement("section", { className: clsx_m_default(SimpleFormIteratorClasses.form, inline && SimpleFormIteratorClasses.inline) }, import_react43.Children.map(children, function(input, index2) {
        if (!(0, import_react43.isValidElement)(input)) {
          return null;
        }
        var _a14 = input.props, source2 = _a14.source, inputProps = __rest45(_a14, ["source"]);
        return (0, import_react43.cloneElement)(input, __assign46({ source: source2 ? "".concat(member, ".").concat(source2) : member, index: source2 ? void 0 : index2, resource, disabled }, inputProps));
      })),
      !disabled && React67.createElement(
        "span",
        { className: SimpleFormIteratorClasses.action },
        !disableReordering && (0, import_react43.cloneElement)(reOrderButtons, {
          index,
          max: total,
          reOrder,
          className: clsx_m_default("button-reorder", "button-reorder-".concat(source, "-").concat(index))
        }),
        !disableRemoveField(record) && (0, import_react43.cloneElement)(removeButton, {
          onClick: handleRemoveButtonClick(removeButton.props.onClick, index),
          className: clsx_m_default("button-remove", "button-remove-".concat(source, "-").concat(index))
        })
      )
    )
  );
...
var AddItemButton = function(props) {
  ...
  return React68.createElement(
    ...
    __assign47({ label: "ra.action.add", size: "small", onClick: function() {
      return add();
    }, color: "primary" }, props),
    React68.createElement(import_AddCircleOutline.default, { fontSize: "small" })
  );
};
...
var useSimpleFormIteratorItem = function() {
  return (0, import_react44.useContext)(SimpleFormIteratorItemContext);
};
...
var RemoveItemButton = function(props) {
  ...
  return React69.createElement(
    IconButtonWithTooltip,
    __assign48({ label: "ra.action.remove", size: "small", onClick: function() {
      return remove();
    }, color: "warning" }, props),
    React69.createElement(import_RemoveCircleOutline.default, { fontSize: "small" })
  );
};
...
var ReOrderButtons = function(_a13) {
  ...
  return React70.createElement(
    ...
    React70.createElement(
      ...
      React70.createElement(import_ArrowCircleUp.default, { fontSize: "small" })
    ),
    React70.createElement(
      IconButtonWithTooltip,
      { label: "ra.action.move_down", size: "small", onClick: function() {
        return reOrder(index + 1);
      }, disabled: total == null || index >= total - 1, color: "primary" },
      React70.createElement(import_ArrowCircleDown.default, { fontSize: "small" })
    )
  );
};
...
var ClearArrayButton = function(props) {
  return React71.createElement(
    IconButtonWithTooltip,
    __assign49({ label: "ra.action.clear_array_input", size: "small", color: "warning" }, props),
    React71.createElement(import_HighlightOff.default, { fontSize: "small" })
  );
};
...
var SimpleFormIterator = function(props) {
  var _a13 = props.addButton, addButton = _a13 === void 0 ? React72.createElement(AddItemButton, null) : _a13, _b = props.removeButton, removeButton = _b === void 0 ? React72.createElement(RemoveItemButton, null) : _b, _c = props.reOrderButtons, reOrderButtons = _c === void 0 ? React72.createElement(ReOrderButtons, null) : _c, children = props.children, className = props.className, resource = props.resource, source = props.source, disabled = props.disabled, disableAdd = props.disableAdd, disableClear = props.disableClear, disableRemove = props.disableRemove, disableReordering = props.disableReordering, inline = props.inline, _d = props.getItemLabel, getItemLabel = _d === void 0 ? false : _d, fullWidth = props.fullWidth, sx = props.sx;
  var _e = (0, import_react45.useState)(false), confirmIsOpen = _e[0], setConfirmIsOpen = _e[1];
  var _f = useArrayInput(props), append = _f.append, fields = _f.fields, move = _f.move, remove = _f.remove, replace = _f.replace;
  var translate = useTranslate();
  var record = useRecordContext(props);
  var initialDefaultValue = (0, import_react45.useRef)({});
  var removeField = (0, import_react45.useCallback)(function(index) {
    remove(index);
  }, [remove]);
  if (fields.length > 0) {
    var _g = fields[0], id = _g.id, rest = __rest46(_g, ["id"]);
    initialDefaultValue.current = rest;
    for (var k in initialDefaultValue.current)
      initialDefaultValue.current[k] = null;
  }
  var addField = (0, import_react45.useCallback)(function(item) {
    if (item === void 0) {
      item = void 0;
    }
    ...
    if (item == null) {
      ...
      if (import_react45.Children.count(children) === 1 && React72.isValidElement(import_react45.Children.only(children)) && // @ts-ignore
      !import_react45.Children.only(children).props.source) {
        defaultValue = "";
      } else {
        defaultValue = defaultValue || {};
        import_react45.Children.forEach(children, function(input) {
          var _a14;
          if (React72.isValidElement(input) && input.type !== FormDataConsumer_default && input.props.source) {
  ...
  var handleReorder = (0, import_react45.useCallback)(function(origin, destination) {
    move(origin, destination);
  }, [move]);
  var handleArrayClear = (0, import_react45.useCallback)(function() {
    replace([]);
    setConfirmIsOpen(false);
  }, [replace]);
  var records = (0, import_get3.default)(record, source);
  var context = (0, import_react45.useMemo)(function() {
    return {
      total: fields.length,
      add: addField,
      remove: removeField,
  ...
  return fields ? React72.createElement(
    SimpleFormIteratorContext.Provider,
    { value: context },
    React72.createElement(
      Root14,
      { className: clsx_m_default(className, fullWidth && "fullwidth", disabled && "disabled"), sx },
      React72.createElement("ul", { className: SimpleFormIteratorClasses.list }, fields.map(function(member, index) {
        return React72.createElement(SimpleFormIteratorItem, { key: member.id, disabled, disableRemove, disableReordering, fields, getItemLabel, index, member: "".concat(source, ".").concat(index), onRemoveField: removeField, onReorder: handleReorder, record: records && records[index] || {}, removeButton, reOrderButtons, resource, source, inline }, children);
      })),
      !disabled && !(disableAdd && (disableClear || disableRemove)) && React72.createElement(
        "div",
        { className: SimpleFormIteratorClasses.buttons },
        !disableAdd && React72.createElement("div", { className: SimpleFormIteratorClasses.add }, (0, import_react45.cloneElement)(addButton, {
          className: clsx_m_default("button-add", "button-add-".concat(source)),
          onClick: handleAddButtonClick(addButton.props.onClick)
        })),
        fields.length > 0 && !disableClear && !disableRemove && React72.createElement(
          "div",
          { className: SimpleFormIteratorClasses.clear },
          React72.createElement(Confirm, { isOpen: confirmIsOpen, title: translate("ra.action.clear_array_input"), content: translate("ra.message.clear_array_input"), onConfirm: handleArrayClear, onClose: function() {
            return setConfirmIsOpen(false);
          } }),
          React72.createElement(ClearArrayButton, { onClick: function() {
...
SimpleFormIterator.propTypes = {
  addButton: import_prop_types41.default.element,
  removeButton: import_prop_types41.default.element,
  children: import_prop_types41.default.node,
  className: import_prop_types41.default.string,
  field: import_prop_types41.default.object,
  fields: import_prop_types41.default.array,
  fieldState: import_prop_types41.default.object,
  formState: import_prop_types41.default.object,
  fullWidth: import_prop_types41.default.bool,
  inline: import_prop_types41.default.bool,
  record: import_prop_types41.default.object,
  source: import_prop_types41.default.string,
  resource: import_prop_types41.default.string,
  translate: import_prop_types41.default.func,
  disableAdd: import_prop_types41.default.bool,
  disableRemove: import_prop_types41.default.oneOfType([import_prop_types41.default.func, import_prop_types41.default.bool]),
  TransitionProps: import_prop_types41.default.shape({})
};
var Root14 = styled_default("div", {
...
var useSupportCreateSuggestion = function(options) {
  ...
  var translate = useTranslate();
  var _e = (0, import_react46.useState)(false), renderOnCreate = _e[0], setRenderOnCreate = _e[1];
  var filterRef = (0, import_react46.useRef)(filter);
  ...
  return {
          ...
          switch (_b2.label) {
            case 0:
              ...
              if (!((finalValue === null || finalValue === void 0 ? void 0 : finalValue.id) === createValue || finalValue === createValue))
                return [3, 3];
              if (!!(0, import_react46.isValidElement)(create2))
                return [3, 2];
    ...
    createElement: renderOnCreate && (0, import_react46.isValidElement)(create2) ? React73.createElement(CreateSuggestionContext.Provider, { value: context }, create2) : null
  };
};
var CreateSuggestionContext = (0, import_react46.createContext)(void 0);
var useCreateSuggestionContext = function() {
  return (0, import_react46.useContext)(CreateSuggestionContext);
};
...
var AutocompleteInput = function(props) {
  ...
  var translate = useTranslate();
  var _l = useInput(__assign50({ defaultValue, id: idOverride, field: fieldOverride, fieldState: fieldStateOverride, formState: formStateOverride, isRequired: isRequiredOverride, onBlur, onChange, parse, format, resource, source, validate }, rest)), id = _l.id, field = _l.field, isRequired2 = _l.isRequired, _m = _l.fieldState, error = _m.error, invalid = _m.invalid, isTouched = _m.isTouched, isSubmitted = _l.formState.isSubmitted;
  var finalChoices = (0, import_react47.useMemo)(function() {
    var _a14;
  ...
  (0, import_react47.useEffect)(function() {
    if ((0, import_react47.isValidElement)(optionText) && emptyText != void 0) {
      throw new Error("optionText of type React element is not supported when setting emptyText");
    }
    if ((0, import_react47.isValidElement)(optionText) && inputText == void 0) {
      throw new Error("\nIf you provided a React element for the optionText prop, you must also provide the inputText prop (used for the text input)");
    }
    if ((0, import_react47.isValidElement)(optionText) && !isFromReference && // eslint-disable-next-line eqeqeq
  ...
  var _p = (0, import_react47.useState)(""), filterValue = _p[0], setFilterValue = _p[1];
  ...
  var debouncedSetFilter = (0, import_react47.useCallback)((0, import_debounce.default)(function(filter) {
    if (setFilter) {
  ...
  var currentValue = (0, import_react47.useRef)(field.value);
  (0, import_react47.useEffect)(function() {
  ...
  var _q = useSupportCreateSuggestion({
    ...
    onCreate,
    optionText
  }), getCreateItem = _q.getCreateItem, handleChangeWithCreateSupport = _q.handleChange, createElement195 = _q.createElement, createId = _q.createId;
  var getOptionLabel = (0, import_react47.useCallback)(function(option, isListItem) {
  ...
  var finalOnBlur = (0, import_react47.useCallback)(function() {
  ...
  var doesQueryMatchSelection = (0, import_react47.useCallback)(function(filter) {
  ...
  var doesQueryMatchSuggestion = (0, import_react47.useCallback)(function(filter) {
  ...
  return React74.createElement(
    React74.Fragment,
    null,
    React74.createElement(StyledAutocomplete, __assign50({ blurOnSelect: true, className: clsx_m_default("ra-input", "ra-input-".concat(source), className), clearText: translate(clearText, { _: clearText }), closeText: translate(closeText, { _: closeText }), openOnFocus: true, openText: translate(openText, { _: openText }), id, isOptionEqualToValue, filterSelectedOptions: true, renderInput: function(params) {
      return React74.createElement(TextField_default, __assign50({ name: field.name, label: React74.createElement(FieldTitle_default, { label, source, resource: resourceProp, isRequired: isRequired2 }), error: !!fetchError || (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React74.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText }) : null, margin, variant, className: AutocompleteInputClasses.textField }, TextFieldProps, params, { size }));
    }, multiple, renderTags: function(value, getTagProps) {
      return value.map(function(option, index) {
        return React74.createElement(Chip_default, __assign50({ label: (0, import_react47.isValidElement)(optionText) ? inputText(option) : getChoiceText(option), sx: {
          ".MuiSvgIcon-root": {
    ...
    shouldRenderSuggestions(filterValue) ? suggestions : [], getOptionLabel, inputValue: filterValue, loading: isLoading && (!finalChoices || finalChoices.length === 0) && oneSecondHasPassed, value: selectedChoice, onChange: handleAutocompleteChange, onBlur: finalOnBlur, onInputChange: handleInputChange, renderOption: function(props2, record) {
      ...
      return React74.createElement("li", __assign50({}, props2), optionLabel === "" ? " " : optionLabel);
    } })),
    createElement195
  );
};
var PREFIX33 = "RaAutocompleteInput";
var AutocompleteInputClasses = {
  textField: "".concat(PREFIX33, "-textField")
};
...
var useSelectedChoice = function(value, _a13) {
  ...
  var selectedChoiceRef = (0, import_react47.useRef)(getSelectedItems(choices2, value, optionValue, multiple));
  var _b = (0, import_react47.useState)(function() {
...
var AutocompleteArrayInput = function(_a13) {
  var defaultValue = _a13.defaultValue, props = __rest48(_a13, ["defaultValue"]);
  return React75.createElement(AutocompleteInput, __assign51({}, props, { multiple: true, defaultValue: defaultValue !== null && defaultValue !== void 0 ? defaultValue : [] }));
};
...
var InputPropTypes = {
  label: import_prop_types42.default.oneOfType([
    import_prop_types42.default.string,
    import_prop_types42.default.bool,
    import_prop_types42.default.element
  ]),
  resource: import_prop_types42.default.string,
  source: import_prop_types42.default.string
};
...
var BooleanInput = function(props) {
  var className = props.className, _a13 = props.row, row = _a13 === void 0 ? false : _a13, _b = props.defaultValue, defaultValue = _b === void 0 ? false : _b, format = props.format, label = props.label, fullWidth = props.fullWidth, helperText = props.helperText, onBlur = props.onBlur, onChange = props.onChange, onFocus = props.onFocus, disabled = props.disabled, parse = props.parse, resource = props.resource, source = props.source, validate = props.validate, options = props.options, sx = props.sx, rest = __rest49(props, ["className", "row", "defaultValue", "format", "label", "fullWidth", "helperText", "onBlur", "onChange", "onFocus", "disabled", "parse", "resource", "source", "validate", "options", "sx"]);
  var _c = useInput(__assign52({ defaultValue, format, parse, resource, source, onBlur, onChange, type: "checkbox", validate }, rest)), id = _c.id, field = _c.field, isRequired2 = _c.isRequired, _d = _c.fieldState, error = _d.error, invalid = _d.invalid, isTouched = _d.isTouched, isSubmitted = _c.formState.isSubmitted;
  var handleChange = (0, import_react48.useCallback)(function(event) {
  ...
  return React76.createElement(
    ...
    React76.createElement(FormControlLabel_default, { control: React76.createElement(Switch_default, __assign52({ id, name: field.name, color: "primary", onChange: handleChange, onFocus, checked: Boolean(field.value) }, sanitizeInputRestProps(rest), options, { disabled })), label: React76.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }) }),
    renderHelperText ? React76.createElement(
      FormHelperText_default,
      { error: (isTouched || isSubmitted) && invalid },
      React76.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText })
    ) : null
  );
};
BooleanInput.propTypes = __assign52(__assign52({}, InputPropTypes), {
  // @ts-ignore
  options: import_prop_types43.default.shape(Switch_default.propTypes),
...
var CheckboxGroupInputItem = function(props) {
  var id = props.id, choice = props.choice, className = props.className, fullWidth = props.fullWidth, onChange = props.onChange, optionText = props.optionText, optionValue = props.optionValue, options = props.options, translateChoice = props.translateChoice, value = props.value, labelPlacement = props.labelPlacement, rest = __rest50(props, ["id", "choice", "className", "fullWidth", "onChange", "optionText", "optionValue", "options", "translateChoice", "value", "labelPlacement"]);
  var _a13 = useChoices({
    optionText,
    optionValue,
    translateChoice
  ...
  return React77.createElement(StyledFormControlLabel, { htmlFor: "".concat(id, "_").concat(getChoiceValue(choice)), key: getChoiceValue(choice), onChange, className, control: React77.createElement(Checkbox_default, __assign53({ id: "".concat(id, "_").concat(getChoiceValue(choice)), color: "primary", className: CheckboxGroupInputItemClasses.checkbox, checked: value ? value.find(function(v) {
...
var PREFIX34 = "RaCheckboxGroupInputItem";
var CheckboxGroupInputItemClasses = {
  checkbox: "".concat(PREFIX34, "-checkbox")
};
var StyledFormControlLabel = styled_default(FormControlLabel_default, {
  name: PREFIX34,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var CheckboxGroupInput = function(props) {
  var choicesProp = props.choices, className = props.className, classesOverride = props.classes, format = props.format, helperText = props.helperText, label = props.label, labelPlacement = props.labelPlacement, isLoadingProp = props.isLoading, isFetchingProp = props.isFetching, _a13 = props.margin, margin = _a13 === void 0 ? "dense" : _a13, onBlur = props.onBlur, onChange = props.onChange, options = props.options, _b = props.optionText, optionText = _b === void 0 ? "name" : _b, _c = props.optionValue, optionValue = _c === void 0 ? "id" : _c, parse = props.parse, resourceProp = props.resource, _d = props.row, row = _d === void 0 ? true : _d, sourceProp = props.source, _e = props.translateChoice, translateChoice = _e === void 0 ? true : _e, validate = props.validate, rest = __rest51(props, ["choices", "className", "classes", "format", "helperText", "label", "labelPlacement", "isLoading", "isFetching", "margin", "onBlur", "onChange", "options", "optionText", "optionValue", "parse", "resource", "row", "source", "translateChoice", "validate"]);
  ...
  var _g = useInput(__assign54({ format, parse, resource, source, validate, onChange, onBlur }, rest)), _h = _g.field, formOnChange = _h.onChange, formOnBlur = _h.onBlur, value = _h.value, _j = _g.fieldState, error = _j.error, invalid = _j.invalid, isTouched = _j.isTouched, isSubmitted = _g.formState.isSubmitted, id = _g.id, isRequired2 = _g.isRequired;
  var handleCheck = (0, import_react49.useCallback)(function(event, isChecked) {
    var newValue;
  ...
  if (isLoading && (!allChoices || allChoices.length === 0)) {
    return React78.createElement(
      Labeled,
      __assign54({ id, label, source, resource, className: clsx_m_default("ra-input", "ra-input-".concat(source), className), isRequired: isRequired2 }, rest),
      React78.createElement(LinearProgress, null)
    );
  }
  var renderHelperText = !!fetchError || helperText !== false || (isTouched || isSubmitted) && invalid;
  return React78.createElement(
    StyledFormControl,
    __assign54({ component: "fieldset", margin, error: fetchError || (isTouched || isSubmitted) && invalid, className: clsx_m_default("ra-input", "ra-input-".concat(source), className) }, sanitizeRestProps9(rest)),
    React78.createElement(
      FormLabel_default,
      { component: "legend", className: CheckboxGroupInputClasses.label },
      React78.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 })
    ),
    React78.createElement(FormGroup_default, { row }, allChoices === null || allChoices === void 0 ? void 0 : allChoices.map(function(choice) {
      return React78.createElement(CheckboxGroupInputItem, __assign54({ key: (0, import_get5.default)(choice, optionValue), choice, id, onChange: handleCheck, options, optionText, optionValue, translateChoice, value, labelPlacement }, sanitizeRestProps9(rest)));
    })),
    renderHelperText ? React78.createElement(
      FormHelperText_default,
      { error: fetchError || (isTouched || isSubmitted) && !!error, className: CheckboxGroupInputClasses.helperText },
      React78.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText })
    ) : null
  );
};
var sanitizeRestProps9 = function(_a13) {
  var refetch = _a13.refetch, setFilter = _a13.setFilter, setPagination = _a13.setPagination, setSort = _a13.setSort, loaded = _a13.loaded, touched = _a13.touched, rest = __rest51(_a13, ["refetch", "setFilter", "setPagination", "setSort", "loaded", "touched"]);
  return sanitizeInputRestProps(rest);
};
CheckboxGroupInput.propTypes = {
  choices: import_prop_types44.default.arrayOf(import_prop_types44.default.any),
  className: import_prop_types44.default.string,
  source: import_prop_types44.default.string,
  optionText: import_prop_types44.default.oneOfType([
    import_prop_types44.default.string,
    import_prop_types44.default.func,
    import_prop_types44.default.element
  ]),
  optionValue: import_prop_types44.default.string,
  row: import_prop_types44.default.bool,
  resource: import_prop_types44.default.string,
  translateChoice: import_prop_types44.default.bool
};
var PREFIX35 = "RaCheckboxGroupInput";
var CheckboxGroupInputClasses = {
  label: "".concat(PREFIX35, "-label"),
  helperText: "".concat(PREFIX35, "-helperText")
};
var StyledFormControl = styled_default(FormControl_default, {
  name: PREFIX35,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var PREFIX36 = "RaDatagrid";
var DatagridClasses = {
  root: "".concat(PREFIX36, "-root"),
  table: "".concat(PREFIX36, "-table"),
  tableWrapper: "".concat(PREFIX36, "-tableWrapper"),
  thead: "".concat(PREFIX36, "-thead"),
  tbody: "".concat(PREFIX36, "-tbody"),
  headerRow: "".concat(PREFIX36, "-headerRow"),
  headerCell: "".concat(PREFIX36, "-headerCell"),
  checkbox: "".concat(PREFIX36, "-checkbox"),
  row: "".concat(PREFIX36, "-row"),
  clickableRow: "".concat(PREFIX36, "-clickableRow"),
  rowEven: "".concat(PREFIX36, "-rowEven"),
  rowOdd: "".concat(PREFIX36, "-rowOdd"),
  rowCell: "".concat(PREFIX36, "-rowCell"),
  selectable: "".concat(PREFIX36, "-selectable"),
  expandHeader: "".concat(PREFIX36, "-expandHeader"),
  expandIconCell: "".concat(PREFIX36, "-expandIconCell"),
  expandIcon: "".concat(PREFIX36, "-expandIcon"),
  expandable: "".concat(PREFIX36, "-expandable"),
  expanded: "".concat(PREFIX36, "-expanded"),
  expandedPanel: "".concat(PREFIX36, "-expandedPanel")
};
var DatagridRoot = styled_default("div", {
  name: PREFIX36,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var DatagridCell = React79.forwardRef(function(_a13, ref) {
  var className = _a13.className, field = _a13.field, record = _a13.record, resource = _a13.resource, rest = __rest52(_a13, ["className", "field", "record", "resource"]);
  return React79.createElement(TableCell_default, __assign55({ className: clsx_m_default(className, field.props.cellClassName), align: field.props.textAlign, ref }, rest), field);
});
DatagridCell.propTypes = {
  className: import_prop_types45.default.string,
  field: import_prop_types45.default.element,
  // @ts-ignore
  record: import_prop_types45.default.object,
  resource: import_prop_types45.default.string
};
...
var ExpandRowButton = function(_a13) {
  var expanded = _a13.expanded, expandContentId = _a13.expandContentId, props = __rest53(_a13, ["expanded", "expandContentId"]);
  var translate = useTranslate();
  return React80.createElement(
    IconButton_default,
    __assign56({ "aria-label": translate(expanded ? "ra.action.close" : "ra.action.expand"), "aria-expanded": expanded, "aria-controls": expandContentId, tabIndex: -1, "aria-hidden": "true", component: "div" }, props, { size: "small" }),
    React80.createElement(import_ExpandMore3.default, { fontSize: "inherit" })
  );
};
var ExpandRowButton_default = (0, import_react50.memo)(ExpandRowButton);
...
var DatagridContext = (0, import_react51.createContext)({});
...
var useDatagridContext = function(props) {
  var context = (0, import_react52.useContext)(DatagridContext_default);
...
var DatagridRow = import_react53.default.forwardRef(function(props, ref) {
  ...
  var _d = (0, import_react53.useState)(function() {
  ...
  var handleToggleExpand = (0, import_react53.useCallback)(function(event) {
    toggleExpanded();
    event.stopPropagation();
  }, [toggleExpanded]);
  var handleToggleSelection = (0, import_react53.useCallback)(function(event) {
    if (!selectable)
      return;
    onToggleItem(id, event);
    event.stopPropagation();
  }, [id, onToggleItem, selectable]);
  var handleClick2 = (0, import_react53.useCallback)(function(event) {
  ...
  return import_react53.default.createElement(
    ...
    import_react53.default.createElement(
      TableRow_default,
      __assign57({ ref, className: clsx_m_default(className, (_a13 = {}, _a13[DatagridClasses.expandable] = expandable, _a13[DatagridClasses.selectable] = selectable, _a13[DatagridClasses.clickableRow] = typeof rowClick === "function" ? true : rowClick, _a13)), key: id, style, hover, onClick: handleClick2 }, rest),
      expand && import_react53.default.createElement(TableCell_default, { padding: "none", className: DatagridClasses.expandIconCell }, expandable && import_react53.default.createElement(ExpandRowButton_default, { className: clsx_m_default(DatagridClasses.expandIcon, (_b = {}, _b[DatagridClasses.expanded] = expanded, _b)), expanded, onClick: handleToggleExpand, expandContentId: "".concat(id, "-expand") })),
      hasBulkActions && import_react53.default.createElement(
        TableCell_default,
        { padding: "checkbox" },
        import_react53.default.createElement(Checkbox_default, { "aria-label": translate("ra.action.select_row", {
          _: "Select this row"
      ...
      import_react53.default.Children.map(children, function(field, index) {
        return (0, import_react53.isValidElement)(field) ? import_react53.default.createElement(DatagridCell_default, { key: "".concat(id, "-").concat(field.props.source || index), className: clsx_m_default("column-".concat(field.props.source), DatagridClasses.rowCell), record, field, resource }) : null;
      })
    ),
    expandable && expanded && import_react53.default.createElement(
      TableRow_default,
      { key: "".concat(id, "-expand"), id: "".concat(id, "-expand"), className: DatagridClasses.expandedPanel },
      import_react53.default.createElement(TableCell_default, { colSpan: nbColumns }, (0, import_react_is.isElement)(expand) ? (0, import_react53.cloneElement)(expand, {
        // @ts-ignore
        record,
        resource,
        id: String(id)
      }) : (0, import_react53.createElement)(expand, {
        record,
        resource,
        id: String(id)
      }))
...
DatagridRow.propTypes = {
  ...
  // @ts-ignore
  expand: import_prop_types46.default.oneOfType([import_prop_types46.default.element, import_prop_types46.default.elementType]),
  hasBulkActions: import_prop_types46.default.bool.isRequired,
  hover: import_prop_types46.default.bool,
  id: import_prop_types46.default.any,
  onToggleItem: import_prop_types46.default.func,
  // @ts-ignore
  record: import_prop_types46.default.object,
  resource: import_prop_types46.default.string,
  // @ts-ignore
  rowClick: import_prop_types46.default.oneOfType([
    import_prop_types46.default.string,
    import_prop_types46.default.func,
    import_prop_types46.default.bool
  ]),
  selected: import_prop_types46.default.bool,
  style: import_prop_types46.default.object,
  selectable: import_prop_types46.default.bool
};
...
var areEqual = function(prevProps, nextProps) {
  var _1 = prevProps.children, _2 = prevProps.expand, prevPropsWithoutChildren = __rest54(prevProps, ["children", "expand"]);
  var _3 = nextProps.children, _4 = nextProps.expand, nextPropsWithoutChildren = __rest54(nextProps, ["children", "expand"]);
  return shallowEqual(prevPropsWithoutChildren, nextPropsWithoutChildren);
};
var PureDatagridRow = (0, import_react53.memo)(DatagridRow, areEqual);
...
var DatagridBody = React82.forwardRef(function(_a13, ref) {
  var children = _a13.children, className = _a13.className, data = _a13.data, expand = _a13.expand, hasBulkActions = _a13.hasBulkActions, hover = _a13.hover, onToggleItem = _a13.onToggleItem, resource = _a13.resource, row = _a13.row, rowClick = _a13.rowClick, rowStyle = _a13.rowStyle, selectedIds = _a13.selectedIds, isRowSelectable = _a13.isRowSelectable, rest = __rest55(_a13, ["children", "className", "data", "expand", "hasBulkActions", "hover", "onToggleItem", "resource", "row", "rowClick", "rowStyle", "selectedIds", "isRowSelectable"]);
  return React82.createElement(TableBody_default, __assign58({ ref, className: clsx_m_default("datagrid-body", className, DatagridClasses.tbody) }, rest), data.map(function(record, rowIndex) {
    var _a14;
    var _b, _c;
    return (0, import_react54.cloneElement)(row, {
...
DatagridBody.propTypes = {
  ...
  // @ts-ignore
  data: import_prop_types47.default.arrayOf(import_prop_types47.default.object).isRequired,
  // @ts-ignore
  expand: import_prop_types47.default.oneOfType([import_prop_types47.default.element, import_prop_types47.default.elementType]),
  hasBulkActions: import_prop_types47.default.bool.isRequired,
  hover: import_prop_types47.default.bool,
  onToggleItem: import_prop_types47.default.func,
  resource: import_prop_types47.default.string,
  row: import_prop_types47.default.element,
  // @ts-ignore
  rowClick: import_prop_types47.default.oneOfType([
    import_prop_types47.default.string,
    import_prop_types47.default.func,
    import_prop_types47.default.bool
  ]),
  rowStyle: import_prop_types47.default.func,
  selectedIds: import_prop_types47.default.arrayOf(import_prop_types47.default.any),
  styles: import_prop_types47.default.object,
  isRowSelectable: import_prop_types47.default.func
};
DatagridBody.defaultProps = {
  data: [],
  hasBulkActions: false,
  row: React82.createElement(DatagridRow_default, null)
};
DatagridBody.muiName = "TableBody";
var PureDatagridBody = (0, import_react54.memo)(DatagridBody);
PureDatagridBody.muiName = "TableBody";
PureDatagridBody.defaultProps = {
  row: React82.createElement(PureDatagridRow, null)
};
...
var DatagridHeaderCell = function(props) {
  var className = props.className, field = props.field, sort = props.sort, updateSort = props.updateSort, isSorting = props.isSorting, rest = __rest56(props, ["className", "field", "sort", "updateSort", "isSorting"]);
  var resource = useResourceContext(props);
  var translate = useTranslate();
  return React83.createElement(StyledTableCell, __assign59({ className: clsx_m_default(className, field.props.headerClassName), align: field.props.textAlign, variant: "head" }, rest), updateSort && field.props.sortable !== false && (field.props.sortBy || field.props.source) ? React83.createElement(
    Tooltip_default,
    ...
    React83.createElement(
      ...
      React83.createElement(FieldTitle_default, { label: field.props.label, source: field.props.source, resource })
    )
  ) : React83.createElement(FieldTitle_default, { label: field.props.label, source: field.props.source, resource }));
};
DatagridHeaderCell.propTypes = {
  className: import_prop_types48.default.string,
  field: import_prop_types48.default.element,
  sort: import_prop_types48.default.shape({
    field: import_prop_types48.default.string,
    order: import_prop_types48.default.string
  }).isRequired,
  isSorting: import_prop_types48.default.bool,
  resource: import_prop_types48.default.string,
  updateSort: import_prop_types48.default.func
};
var DatagridHeaderCell_default = (0, import_react55.memo)(DatagridHeaderCell, function(props, nextProps) {
...
var PREFIX37 = "RaDatagridHeaderCell";
var DatagridHeaderCellClasses = {
  icon: "".concat(PREFIX37, "-icon")
};
var StyledTableCell = styled_default(TableCell_default, {
  name: PREFIX37,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var Placeholder = function(props) {
  return React84.createElement(Root15, { className: props.className }, " ");
};
var PREFIX38 = "RaPlaceholder";
var Root15 = styled_default("span", {
  name: PREFIX38,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var times = function(nbChildren, fn) {
  return Array.from({ length: nbChildren }, function(_, key) {
    return fn(key);
  });
};
var DatagridLoading = function(_a13) {
  var className = _a13.className, expand = _a13.expand, hasBulkActions = _a13.hasBulkActions, nbChildren = _a13.nbChildren, _b = _a13.nbFakeLines, nbFakeLines = _b === void 0 ? 5 : _b, size = _a13.size;
  var oneSecondHasPassed = useTimeout(1e3);
  return oneSecondHasPassed ? React85.createElement(
    "div",
    { className: DatagridClasses.root },
    React85.createElement(
      Table_default,
      { className: clsx_m_default(DatagridClasses.table, className), size },
      React85.createElement(
        TableHead_default,
        null,
        React85.createElement(
          ...
          expand && React85.createElement(TableCell_default, { padding: "none", className: DatagridClasses.expandHeader }),
          hasBulkActions && React85.createElement(
            TableCell_default,
            { padding: "checkbox", className: DatagridClasses.expandIconCell },
            React85.createElement(Checkbox_default, { className: "select-all", color: "primary", checked: false })
          ),
          times(nbChildren, function(key) {
            return React85.createElement(
              TableCell_default,
              { variant: "head", className: DatagridClasses.headerCell, key },
              React85.createElement(Placeholder, null)
            );
          })
        )
      ),
      React85.createElement(TableBody_default, null, times(nbFakeLines, function(key1) {
        return React85.createElement(
          TableRow_default,
          { key: key1, style: { opacity: 1 / (key1 + 1) } },
          expand && React85.createElement(
            TableCell_default,
            ...
            React85.createElement(
              ...
              React85.createElement(import_ExpandMore4.default, null)
            )
          ),
          hasBulkActions && React85.createElement(
            TableCell_default,
...
DatagridLoading.propTypes = {
  ...
  expand: import_prop_types49.default.oneOfType([import_prop_types49.default.element, import_prop_types49.default.elementType]),
  hasBulkActions: import_prop_types49.default.bool,
  nbChildren: import_prop_types49.default.number,
  nbFakeLines: import_prop_types49.default.number,
  size: import_prop_types49.default.oneOf(["small", "medium"])
};
var DatagridLoading_default = (0, import_react56.memo)(DatagridLoading);
...
var ExpandAllButton = function(_a13) {
  ...
  return React86.createElement(
    ...
    React86.createElement(import_ExpandMore5.default, { fontSize: "inherit" })
  );
};
var ExpandAllButton_default = (0, import_react57.memo)(ExpandAllButton);

// node_modules/ra-ui-materialui/dist/esm/list/datagrid/DatagridHeader.js
var DatagridHeader = function(props) {
  var children = props.children, className = props.className, _a13 = props.hasExpand, hasExpand = _a13 === void 0 ? false : _a13, _b = props.hasBulkActions, hasBulkActions = _b === void 0 ? false : _b, isRowSelectable = props.isRowSelectable;
  var resource = useResourceContext(props);
  var translate = useTranslate();
  ...
  var updateSortCallback = (0, import_react58.useCallback)(function(event) {
    event.stopPropagation();
  ...
  var handleSelectAll = (0, import_react58.useCallback)(function(event) {
  ...
  return React87.createElement(
    ...
    React87.createElement(
      ...
      hasExpand && React87.createElement(TableCell_default, { padding: "none", className: clsx_m_default(DatagridClasses.headerCell, DatagridClasses.expandHeader) }, !expandSingle ? React87.createElement(ExpandAllButton_default, { resource, ids: data.map(function(record) {
        return record.id;
      }) }) : null),
      hasBulkActions && selectedIds && React87.createElement(
        TableCell_default,
        { padding: "checkbox", className: DatagridClasses.headerCell },
        React87.createElement(Checkbox_default, { "aria-label": translate("ra.action.select_all", {
          _: "Select all"
      ...
      import_react58.Children.map(children, function(field, index) {
        return (0, import_react58.isValidElement)(field) ? React87.createElement(DatagridHeaderCell_default, { className: clsx_m_default(DatagridClasses.headerCell, "column-".concat(field.props.source)), sort, field, isSorting: sort.field === (field.props.sortBy || field.props.source), key: field.props.source || index, resource, updateSort }) : null;
      })
    )
  );
};
DatagridHeader.propTypes = {
  ...
  sort: import_prop_types50.default.exact({
    field: import_prop_types50.default.string,
    order: import_prop_types50.default.string
  }),
  data: import_prop_types50.default.arrayOf(import_prop_types50.default.any),
  hasExpand: import_prop_types50.default.bool,
  hasBulkActions: import_prop_types50.default.bool,
  isRowSelectable: import_prop_types50.default.func,
  isRowExpandable: import_prop_types50.default.func,
  onSelect: import_prop_types50.default.func,
  onToggleItem: import_prop_types50.default.func,
  resource: import_prop_types50.default.string,
  selectedIds: import_prop_types50.default.arrayOf(import_prop_types50.default.any),
  setSort: import_prop_types50.default.func
};
...
var DatagridContextProvider = function(_a13) {
  var children = _a13.children, value = _a13.value;
  return import_react59.default.createElement(DatagridContext_default.Provider, { value }, children);
};
...
var BulkActionsToolbar = function(props) {
  var _a13;
  var _b = props.label, label = _b === void 0 ? "ra.action.bulk_actions" : _b, children = props.children, className = props.className, rest = __rest57(props, ["label", "children", "className"]);
  ...
  var translate = useTranslate();
  var handleUnselectAllClick = (0, import_react60.useCallback)(function() {
    onUnselectItems();
  }, [onUnselectItems]);
  return React89.createElement(
    ...
    React89.createElement(
      Toolbar_default,
      __assign60({ "data-test": "bulk-actions-toolbar", className: clsx_m_default(BulkActionsToolbarClasses.toolbar, (_a13 = {}, _a13[BulkActionsToolbarClasses.collapsed] = selectedIds.length === 0, _a13)) }, sanitizeListRestProps(rest)),
      React89.createElement(
        "div",
        ...
        React89.createElement(
          ...
          React89.createElement(import_Close.default, { fontSize: "small" })
        ),
        React89.createElement(Typography_default, { color: "inherit", variant: "subtitle1" }, translate(label, {
          _: label,
          smart_count: selectedIds.length
        }))
      ),
      React89.createElement(TopToolbar_default, { className: BulkActionsToolbarClasses.topToolbar }, import_react60.Children.map(children, function(child) {
        return (0, import_react60.isValidElement)(child) ? (0, import_react60.cloneElement)(child, {
          filterValues,
          resource,
          selectedIds
        }) : null;
...
var PREFIX39 = "RaBulkActionsToolbar";
var BulkActionsToolbarClasses = {
  toolbar: "".concat(PREFIX39, "-toolbar"),
  topToolbar: "".concat(PREFIX39, "-topToolbar"),
  buttons: "".concat(PREFIX39, "-buttons"),
  collapsed: "".concat(PREFIX39, "-collapsed"),
  title: "".concat(PREFIX39, "-title"),
  icon: "".concat(PREFIX39, "-icon")
};
var Root16 = styled_default("div", {
  name: PREFIX39,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ListNoResults = (0, import_react61.memo)(function() {
  var translate = useTranslate();
  var resource = useResourceContext();
  return React90.createElement(
    CardContent_default,
    null,
    React90.createElement(Typography_default, { variant: "body2" }, translate("ra.navigation.no_results", { resource }))
  );
});
...
var defaultBulkActionButtons = React91.createElement(BulkDeleteButton, null);
var Datagrid = React91.forwardRef(function(props, ref) {
  var _a13 = props.optimized, optimized = _a13 === void 0 ? false : _a13, _b = props.body, body = _b === void 0 ? optimized ? PureDatagridBody : DatagridBody_default : _b, _c = props.header, header = _c === void 0 ? DatagridHeader : _c, children = props.children, className = props.className, _d = props.empty, empty = _d === void 0 ? DefaultEmpty : _d, expand = props.expand, _e = props.bulkActionButtons, bulkActionButtons = _e === void 0 ? defaultBulkActionButtons : _e, hover = props.hover, isRowSelectable = props.isRowSelectable, isRowExpandable = props.isRowExpandable, resource = props.resource, rowClick = props.rowClick, rowStyle = props.rowStyle, _f = props.size, size = _f === void 0 ? "small" : _f, sx = props.sx, _g = props.expandSingle, expandSingle = _g === void 0 ? false : _g, rest = __rest58(props, ["optimized", "body", "header", "children", "className", "empty", "expand", "bulkActionButtons", "hover", "isRowSelectable", "isRowExpandable", "resource", "rowClick", "rowStyle", "size", "sx", "expandSingle"]);
  ...
  var lastSelected = (0, import_react62.useRef)(null);
  (0, import_react62.useEffect)(function() {
    if (!selectedIds || selectedIds.length === 0) {
      lastSelected.current = null;
    }
  }, [JSON.stringify(selectedIds)]);
  var handleToggleItem = (0, import_react62.useCallback)(function(id, event) {
  ...
  if (isLoading === true) {
    return React91.createElement(DatagridLoading_default, { className, expand, hasBulkActions, nbChildren: React91.Children.count(children), size });
  }
  ...
  return React91.createElement(
    ...
    React91.createElement(
      ...
      bulkActionButtons !== false ? React91.createElement(BulkActionsToolbar, { selectedIds }, (0, import_react62.isValidElement)(bulkActionButtons) ? bulkActionButtons : defaultBulkActionButtons) : null,
      React91.createElement(
        "div",
        { className: DatagridClasses.tableWrapper },
        React91.createElement(
          Table_default,
          __assign61({ ref, className: DatagridClasses.table, size }, sanitizeRestProps10(rest)),
...
var createOrCloneElement = function(element, props, children) {
  return (0, import_react62.isValidElement)(element) ? (0, import_react62.cloneElement)(element, props, children) : (0, import_react62.createElement)(element, props, children);
};
Datagrid.propTypes = {
  // @ts-ignore
  body: import_prop_types52.default.oneOfType([import_prop_types52.default.element, import_prop_types52.default.elementType]),
  // @ts-ignore-line
  bulkActionButtons: import_prop_types52.default.oneOfType([import_prop_types52.default.bool, import_prop_types52.default.element]),
  children: import_prop_types52.default.node.isRequired,
  className: import_prop_types52.default.string,
  sort: import_prop_types52.default.exact({
    field: import_prop_types52.default.string,
    order: import_prop_types52.default.string
  }),
  data: import_prop_types52.default.arrayOf(import_prop_types52.default.any),
  empty: import_prop_types52.default.element,
  // @ts-ignore
  expand: import_prop_types52.default.oneOfType([import_prop_types52.default.element, import_prop_types52.default.elementType]),
  // @ts-ignore
  header: import_prop_types52.default.oneOfType([import_prop_types52.default.element, import_prop_types52.default.elementType]),
  hover: import_prop_types52.default.bool,
  isLoading: import_prop_types52.default.bool,
  onSelect: import_prop_types52.default.func,
  onToggleItem: import_prop_types52.default.func,
  resource: import_prop_types52.default.string,
  // @ts-ignore
  rowClick: import_prop_types52.default.oneOfType([
    import_prop_types52.default.string,
    import_prop_types52.default.func,
    import_prop_types52.default.bool
  ]),
  rowStyle: import_prop_types52.default.func,
  selectedIds: import_prop_types52.default.arrayOf(import_prop_types52.default.any),
  setSort: import_prop_types52.default.func,
  total: import_prop_types52.default.number,
  isRowSelectable: import_prop_types52.default.func,
  isRowExpandable: import_prop_types52.default.func,
  expandSingle: import_prop_types52.default.bool
};
var injectedProps2 = [
  "isRequired",
  "setFilter",
...
var sanitizeRestProps10 = function(props) {
  return Object.keys(sanitizeListRestProps(props)).filter(function(propName) {
    return !injectedProps2.includes(propName);
  }).reduce(function(acc, key) {
    var _a13;
    return __assign61(__assign61({}, acc), (_a13 = {}, _a13[key] = props[key], _a13));
  }, {});
};
Datagrid.displayName = "Datagrid";
var DefaultEmpty = React91.createElement(ListNoResults, null);
...
var DatagridEditor = function() {
  ...
  return React92.createElement(FieldsSelector, { name: "columns", availableName: "availableColumns" });
};
...
var DatagridConfigurable = function(_a13) {
  var preferenceKey = _a13.preferenceKey, omit = _a13.omit, props = __rest59(_a13, ["preferenceKey", "omit"]);
  if (props.optimized) {
  ...
  React93.useEffect(function() {
    var columns = React93.Children.toArray(props.children).filter(function(child) {
  ...
  return React93.createElement(
    Configurable,
    { editor: React93.createElement(DatagridEditor, null), preferenceKey: finalPreferenceKey, sx: { display: "block", minHeight: 2 } },
    React93.createElement(DatagridWithPreferences, __assign62({}, props))
  );
};
DatagridConfigurable.propTypes = Datagrid.propTypes;
var DatagridWithPreferences = function(_a13) {
  var children = _a13.children, props = __rest59(_a13, ["children"]);
  ...
  var childrenArray = React93.Children.toArray(children);
  return React93.createElement(Datagrid, __assign62({}, props), columns === void 0 ? children : columns.map(function(index) {
...
var SelectColumnsButton = function(props) {
  ...
  var resource = useResourceContext(props);
  var finalPreferenceKey = preferenceKey || "".concat(resource, ".datagrid");
  var _a13 = React94.useState(null), anchorEl = _a13[0], setAnchorEl = _a13[1];
  var _b = useStore("preferences.".concat(finalPreferenceKey, ".availableColumns"), []), availableColumns = _b[0], setAvailableColumns = _b[1];
  ...
  var handleMove = function(index1, index2) {
    ...
    setColumns(function(columns2) {
      return newAvailableColumns.filter(function(column) {
        return columns2.includes(column.index);
      }).map(function(column) {
        return column.index;
      });
    });
  ...
  return React94.createElement(
    React94.Fragment,
    null,
    isXSmall ? React94.createElement(
      Tooltip_default,
      { title },
      React94.createElement(
        IconButton_default,
        __assign63({ "aria-label": title, color: "primary", onClick: handleClick2, size: "large" }, sanitizeRestProps11(props)),
        React94.createElement(import_ViewWeek.default, null)
      )
    ) : React94.createElement(StyledButton11, __assign63({ size: "small", onClick: handleClick2, startIcon: React94.createElement(import_ViewWeek.default, null) }, sanitizeRestProps11(props)), title),
    React94.createElement(
      Popover_default,
      ...
      React94.createElement(Box_default, { p: 1 }, availableColumns.map(function(column) {
        return React94.createElement(FieldToggle, { key: column.index, source: column.source, label: column.label, index: column.index, selected: columns.includes(column.index), onToggle: handleToggle, onMove: handleMove });
      }))
    )
  );
};
var StyledButton11 = styled_default(Button_default, {
...
var sanitizeRestProps11 = function(_a13) {
  var _b = _a13.resource, resource = _b === void 0 ? null : _b, _c = _a13.preferenceKey, preferenceKey = _c === void 0 ? null : _c, rest = __rest60(_a13, ["resource", "preferenceKey"]);
  return rest;
};
...
var FilterFormInput = function(props) {
  ...
  return React95.createElement(
    ...
    !filterElement.props.alwaysOn && React95.createElement(
      IconButton_default,
      ...
      React95.createElement(import_HighlightOff2.default, null)
    ),
    React95.cloneElement(filterElement, {
      resource,
      record: emptyRecord,
    ...
    React95.createElement("div", { className: FilterFormInputClasses.spacer }, " ")
  );
};
FilterFormInput.propTypes = {
  filterElement: import_prop_types53.default.node,
  handleHide: import_prop_types53.default.func,
  resource: import_prop_types53.default.string,
  className: import_prop_types53.default.string
};
var PREFIX40 = "RaFilterFormInput";
var FilterFormInputClasses = {
  spacer: "".concat(PREFIX40, "-spacer"),
  hideButton: "".concat(PREFIX40, "-hideButton")
};
var Root17 = styled_default("div", {
  name: PREFIX40,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var FilterContext = React96.createContext(void 0);
...
var FilterForm = function(props) {
  var defaultValues = props.defaultValues, filtersProps = props.filters, rest = __rest61(props, ["defaultValues", "filters"]);
  ...
  var filters = (0, import_react63.useContext)(FilterContext) || filtersProps;
  ...
  (0, import_react63.useEffect)(function() {
    var subscription = form.watch(function(values, _a14) {
      var name = _a14.name;
        ...
        return __generator5(this, function(_b) {
          switch (_b.label) {
            ...
            case 1:
              isFormValid = _b.sent();
              if (isFormValid) {
                if ((0, import_get6.default)(values, name) === "") {
                  newValues = (0, import_cloneDeep.default)(values);
  ...
  return React97.createElement(
    FormProvider,
    __assign64({}, form),
    React97.createElement(FilterFormBase, __assign64({ onSubmit: handleFormSubmit, filters }, rest))
  );
};
var FilterFormBase = function(props) {
  var className = props.className, filters = props.filters, rest = __rest61(props, ["className", "filters"]);
  var resource = useResourceContext(props);
  var form = useFormContext();
  ...
  var getShownFilters = function() {
    ...
    return filters.filter(function(filterElement) {
      var filterValue = (0, import_get6.default)(values, filterElement.props.source);
      return filterElement.props.alwaysOn || displayedFilters[filterElement.props.source] || filterValue !== "" && typeof filterValue !== "undefined";
    });
  };
  var handleHide = (0, import_react63.useCallback)(function(event) {
  ...
  return React97.createElement(
    ...
    React97.createElement(
      StyledForm,
      __assign64({ className }, sanitizeRestProps12(rest), { onSubmit: handleSubmit }),
      getShownFilters().map(function(filterElement) {
        return React97.createElement(FilterFormInput, { key: filterElement.props.source, filterElement, handleHide, resource, className: FilterFormClasses.filterFormInput });
      }),
      React97.createElement("div", { className: FilterFormClasses.clearFix })
    )
  );
};
...
FilterFormBase.propTypes = {
  resource: import_prop_types54.default.string,
  filters: import_prop_types54.default.arrayOf(import_prop_types54.default.node).isRequired,
  displayedFilters: import_prop_types54.default.object,
  hideFilter: import_prop_types54.default.func,
  initialValues: import_prop_types54.default.object,
  className: import_prop_types54.default.string
};
var sanitizeRestProps12 = function(_a13) {
  var displayedFilters = _a13.displayedFilters, filterValues = _a13.filterValues, hasCreate = _a13.hasCreate, hideFilter = _a13.hideFilter, setFilters = _a13.setFilters, resource = _a13.resource, props = __rest61(_a13, ["displayedFilters", "filterValues", "hasCreate", "hideFilter", "setFilters", "resource"]);
  return props;
};
var mergeInitialValuesWithDefaultValues = function(initialValues, filters) {
  return __assign64(__assign64({}, filters.filter(function(filterElement) {
    return filterElement.props.alwaysOn && filterElement.props.defaultValue;
  }).reduce(function(acc, filterElement) {
    return (0, import_set2.default)(__assign64({}, acc), filterElement.props.source, filterElement.props.defaultValue);
  }, {})), initialValues);
};
var handleFormSubmit = function() {
};
var PREFIX41 = "RaFilterForm";
var FilterFormClasses = {
  clearFix: "".concat(PREFIX41, "-clearFix"),
  filterFormInput: "".concat(PREFIX41, "-filterFormInput")
};
var StyledForm = styled_default("form", {
  name: PREFIX41,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var FilterButtonMenuItem = (0, import_react64.forwardRef)(function(props, ref) {
  var filter = props.filter, onShow = props.onShow, autoFocus = props.autoFocus;
  var resource = useResourceContext(props);
  var handleShow = (0, import_react64.useCallback)(function() {
    onShow({
  ...
  return React98.createElement(
    ...
    React98.createElement(FieldTitle_default, { label: filter.props.label, source: filter.props.source, resource })
  );
});
FilterButtonMenuItem.propTypes = {
  filter: import_prop_types55.default.element.isRequired,
  onShow: import_prop_types55.default.func.isRequired,
  resource: import_prop_types55.default.string,
...
var AddSavedQueryDialog = function(_a13) {
  ...
  var _d = (0, import_react65.useState)(""), queryName = _d[0], setQueryName = _d[1];
  ...
  return React99.createElement(
    ...
    React99.createElement(DialogTitle_default, { id: "form-dialog-title" }, translate("ra.saved_queries.new_dialog_title", {
    ...
    React99.createElement(
      DialogActions_default,
      null,
      React99.createElement(Button_default, { onClick: onClose }, translate("ra.action.cancel")),
      React99.createElement(Button_default, { onClick: addQuery, color: "primary" }, translate("ra.action.save"))
    )
  );
};
...
var RemoveSavedQueryDialog = function(_a13) {
  ...
  var removeQuery = function() {
    ...
    setSavedQueries(__spreadArray7(__spreadArray7([], newSavedQueries.slice(0, index), true), newSavedQueries.slice(index + 1), true));
    onClose();
  };
  return React100.createElement(
    Dialog_default,
    { open, onClose, "aria-labelledby": "alert-dialog-title", "aria-describedby": "alert-dialog-description" },
    React100.createElement(DialogTitle_default, { id: "alert-dialog-title" }, translate("ra.saved_queries.remove_dialog_title", {
      _: "Remove saved query?"
    })),
    React100.createElement(
      DialogContent_default,
      null,
      React100.createElement(DialogContentText_default, null, translate("ra.saved_queries.remove_message", {
    ...
    React100.createElement(
      DialogActions_default,
      null,
      React100.createElement(Button_default, { onClick: onClose }, translate("ra.action.cancel")),
      React100.createElement(Button_default, {
        onClick: removeQuery,
        color: "primary",
        // eslint-disable-next-line jsx-a11y/no-autofocus
        autoFocus: true
...
var FilterButton = function(props) {
  var filtersProp = props.filters, className = props.className, disableSaveQuery = props.disableSaveQuery, rest = __rest62(props, ["filters", "className", "disableSaveQuery"]);
  var filters = (0, import_react66.useContext)(FilterContext) || filtersProp;
  var resource = useResourceContext(props);
  var translate = useTranslate();
  ...
  var _c = (0, import_react66.useState)(false), open = _c[0], setOpen = _c[1];
  var anchorEl = (0, import_react66.useRef)();
  if (filters === void 0) {
  ...
  var handleClickButton = (0, import_react66.useCallback)(function(event) {
    event.preventDefault();
    setOpen(true);
    anchorEl.current = event.currentTarget;
  }, [anchorEl, setOpen]);
  var handleRequestClose = (0, import_react66.useCallback)(function() {
    setOpen(false);
  }, [setOpen]);
  var handleShow = (0, import_react66.useCallback)(function(_a14) {
    var source = _a14.source, defaultValue = _a14.defaultValue;
    showFilter(source, defaultValue === "" ? void 0 : defaultValue);
    setOpen(false);
  }, [showFilter, setOpen]);
  var _d = (0, import_react66.useState)(false), addSavedQueryDialogOpen = _d[0], setAddSavedQueryDialogOpen = _d[1];
  ...
  var _e = (0, import_react66.useState)(false), removeSavedQueryDialogOpen = _e[0], setRemoveSavedQueryDialogOpen = _e[1];
  ...
  return React101.createElement(
    Root18,
    __assign65({ className }, sanitizeRestProps13(rest)),
    React101.createElement(
      Button,
      { className: "add-filter", label: "ra.action.add_filter", "aria-haspopup": "true", onClick: handleClickButton },
      React101.createElement(import_FilterList.default, null)
    ),
    React101.createElement(
      Menu_default,
      { open, anchorEl: anchorEl.current, onClose: handleRequestClose },
      hiddenFilters.map(function(filterElement, index) {
        return React101.createElement(FilterButtonMenuItem, { key: filterElement.props.source, filter: filterElement, resource, onShow: handleShow, autoFocus: index === 0 });
      }),
      validSavedQueries.map(function(savedQuery, index) {
        return (0, import_isEqual6.default)(savedQuery.value, {
          ...
          perPage,
          displayedFilters
        }) ? React101.createElement(MenuItem_default, { onClick: showRemoveSavedQueryDialog, key: index }, translate("ra.saved_queries.remove_label_with_name", {
          _: 'Remove query "%{name}"',
          name: savedQuery.label
        })) : React101.createElement(MenuItem_default, { onClick: function() {
          navigate({
      ...
      hasFilterValues && !hasSavedCurrentQuery && !disableSaveQuery && React101.createElement(MenuItem_default, { onClick: showAddSavedQueryDialog }, translate("ra.saved_queries.new_label", {
        _: "Save current query..."
      })),
      hasFilterValues && React101.createElement(MenuItem_default, { onClick: function() {
        return setFilters({}, {}, false);
      } }, translate("ra.action.remove_all_filters", {
        _: "Remove all filters"
      }))
    ),
    !disableSaveQuery && React101.createElement(
      React101.Fragment,
      null,
      React101.createElement(AddSavedQueryDialog, { open: addSavedQueryDialogOpen, onClose: hideAddSavedQueryDialog }),
      React101.createElement(RemoveSavedQueryDialog, { open: removeSavedQueryDialogOpen, onClose: hideRemoveSavedQueryDialog })
    )
  );
};
var sanitizeRestProps13 = function(_a13) {
  var _b = _a13.displayedFilters, displayedFilters = _b === void 0 ? null : _b, _c = _a13.filterValues, filterValues = _c === void 0 ? null : _c, _d = _a13.showFilter, showFilter = _d === void 0 ? null : _d, rest = __rest62(_a13, ["displayedFilters", "filterValues", "showFilter"]);
  return rest;
};
FilterButton.propTypes = {
  resource: import_prop_types56.default.string,
  filters: import_prop_types56.default.arrayOf(import_prop_types56.default.node),
  displayedFilters: import_prop_types56.default.object,
  filterValues: import_prop_types56.default.object,
  showFilter: import_prop_types56.default.func,
  className: import_prop_types56.default.string
};
var PREFIX42 = "RaFilterButton";
var Root18 = styled_default("div", {
  name: PREFIX42,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var Filter = function(props) {
  ...
  var renderButton = function() {
    return React102.createElement(FilterButton, { className: FilterClasses.button });
  };
  var renderForm = function() {
    return React102.createElement(FilterForm, { className: FilterClasses.form });
  };
  return React102.createElement(FilterContext.Provider, { value: import_react67.Children.toArray(children) }, props.context === "button" ? renderButton() : renderForm());
};
Filter.propTypes = {
  children: import_prop_types57.default.node,
  classes: import_prop_types57.default.object,
  context: import_prop_types57.default.oneOf(["form", "button"])
};
var PREFIX43 = "RaFilter";
var FilterClasses = {
  button: "".concat(PREFIX43, "-button"),
  form: "".concat(PREFIX43, "-form")
};
...
var FilterList = function(props) {
  var label = props.label, icon = props.icon, children = props.children, rest = __rest63(props, ["label", "icon", "children"]);
  var translate = useTranslate();
  return React103.createElement(
    ...
    React103.createElement(
      ...
      React103.createElement(Box_default, { mr: 1 }, icon),
      React103.createElement(Typography_default, { variant: "overline" }, translate(label, { _: label }))
    ),
    React103.createElement(List_default, { dense: true, disablePadding: true }, children)
  );
};
...
var FilterListItem = (0, import_react68.memo)(function(props) {
  var label = props.label, value = props.value, _a13 = props.isSelected, getIsSelected = _a13 === void 0 ? DefaultIsSelected : _a13, _b = props.toggleFilter, userToggleFilter = _b === void 0 ? DefaultToggleFilter : _b, rest = __rest64(props, ["label", "value", "isSelected", "toggleFilter"]);
  ...
  return React104.createElement(
    StyledListItem,
    __assign67({ onClick: handleClick2, selected: isSelected, disablePadding: true }, rest),
    React104.createElement(
      ListItemButton_default,
      { disableGutters: true, className: FilterListItemClasses.listItemButton },
      React104.createElement(ListItemText_default, { primary: (0, import_react_is2.isElement)(label) ? label : translate(label, { _: label }), className: FilterListItemClasses.listItemText, "data-selected": isSelected ? "true" : "false" }),
      isSelected && React104.createElement(
        ListItemSecondaryAction_default,
        ...
        React104.createElement(
          IconButton_default,
          { size: "small" },
          React104.createElement(import_CancelOutlined2.default, null)
        )
      )
    )
  );
...
var DefaultToggleFilter = function(value, filters) {
  ...
  if (isSelected) {
    ...
    return Object.keys(filters).reduce(function(acc, key) {
      var _a13;
      return keysToRemove_1.includes(key) ? acc : __assign67(__assign67({}, acc), (_a13 = {}, _a13[key] = filters[key], _a13));
    }, {});
  }
  return __assign67(__assign67({}, filters), value);
};
var PREFIX44 = "RaFilterListItem";
var FilterListItemClasses = {
  listItemButton: "".concat(PREFIX44, "-listItemButton"),
  listItemText: "".concat(PREFIX44, "-listItemText")
};
var StyledListItem = styled_default(ListItem_default, {
  name: PREFIX44,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var FilterLiveSearch = (0, import_react69.memo)(function(props) {
  var _a13 = useListFilterContext(), filterValues = _a13.filterValues, setFilters = _a13.setFilters;
  var translate = useTranslate();
  var _b = props.source, source = _b === void 0 ? "q" : _b, variant = props.variant, _c = props.label, label = _c === void 0 ? translate("ra.action.search") : _c, rest = __rest65(props, ["source", "variant", "label"]);
  var handleChange = function(event) {
    var _a14;
    if (event.target) {
      setFilters(__assign68(__assign68({}, filterValues), (_a14 = {}, _a14[source] = event.target.value, _a14)), null);
    } else {
      var _b2 = filterValues, _c2 = source, _1 = _b2[_c2], filters = __rest65(_b2, [typeof _c2 === "symbol" ? _c2 : _c2 + ""]);
      setFilters(filters, null);
    }
  };
  var initialValues = (0, import_react69.useMemo)(function() {
    var _a14;
  ...
  return React105.createElement(
    Form,
    { defaultValues: initialValues, onSubmit },
    React105.createElement(TextInput, __assign68({ resettable: true, helperText: false, source, InputProps: {
      endAdornment: React105.createElement(
        InputAdornment_default,
        { position: "end" },
        React105.createElement(import_Search.default, { color: "disabled" })
      )
    }, onChange: handleChange, size: "small" }, variant === "outlined" ? { variant: "outlined", label } : {
      placeholder: label,
      label: false,
      hiddenLabel: true
    }, rest))
...
var AddSavedQueryIconButton = function(props) {
  var _a13 = (0, import_react70.useState)(false), open = _a13[0], setOpen = _a13[1];
  var handleOpen = function() {
    setOpen(true);
  };
  var handleClose = function() {
  ...
  return React106.createElement(
    ...
    React106.createElement(
      IconButton_default,
      __assign69({ "aria-label": translate("ra.saved_queries.new_label", {
        _: "Save current query..."
      }), size: "small", onClick: handleOpen }, props),
      React106.createElement(import_AddCircleOutline2.default, null)
    ),
    React106.createElement(AddSavedQueryDialog, { open, onClose: handleClose })
  );
};
...
var RemoveSavedQueryIconButton = function(props) {
  var _a13 = (0, import_react71.useState)(false), confirmationOpen = _a13[0], setConfirmationOpen = _a13[1];
  ...
  return React107.createElement(
    ...
    React107.createElement(
      IconButton_default,
      __assign70({ "aria-label": translate("ra.saved_queries.remove_label", {
        _: "Remove saved query"
      }), size: "small", onClick: handleRemoveQueryClick }, props),
      React107.createElement(import_RemoveCircleOutline2.default, null)
    ),
    React107.createElement(RemoveSavedQueryDialog, { open: confirmationOpen, onClose: handleConfirmationClose })
  );
};
...
var SavedQueryFilterListItem = (0, import_react72.memo)(function(props) {
  ...
  return (
    ...
    React108.createElement(
      ...
      React108.createElement(
        ...
        React108.createElement(ListItemText_default, { primary: label, className: SavedQueryFilterListItemClasses.listItemText }),
        isSelected && React108.createElement(
          ListItemSecondaryAction_default,
          null,
          React108.createElement(
            IconButton_default,
            { size: "small", onClick: toggleFilter },
            React108.createElement(import_CancelOutlined3.default, null)
          )
        )
      )
    )
...
var PREFIX45 = "RaSavedQueryFilterListItem";
var SavedQueryFilterListItemClasses = {
  listItemButton: "".concat(PREFIX45, "-listItemButton"),
  listItemText: "".concat(PREFIX45, "-listItemText")
};
var StyledListItem2 = styled_default(ListItem_default, {
  name: PREFIX45,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var SavedQueriesList = function(_a13) {
  var _b = _a13.icon, icon = _b === void 0 ? defaultIcon19 : _b;
  var translate = useTranslate();
  ...
  return React109.createElement(
    ...
    hasSavedCurrentFilterValue ? React109.createElement(RemoveSavedQueryIconButton, { className: SavedQueriesListClasses.floatingIcon }) : hasFilterValues ? React109.createElement(AddSavedQueryIconButton, { className: SavedQueriesListClasses.floatingIcon }) : React109.createElement(
      Tooltip_default,
      { title: translate("ra.saved_queries.help"), className: SavedQueriesListClasses.floatingTooltip },
      React109.createElement(import_HelpOutline.default, null)
    ),
    validSavedQueries.map(function(savedQuery, index) {
      return React109.createElement(SavedQueryFilterListItem, { label: savedQuery.label, value: savedQuery.value, key: index });
    })
  );
};
var PREFIX46 = "RaSavedQueriesList";
var SavedQueriesListClasses = {
  floatingIcon: "".concat(PREFIX46, "-floatingIcon"),
  floatingTooltip: "".concat(PREFIX46, "-floatingTooltip"),
  titleContainer: "".concat(PREFIX46, "-titleContainer"),
  titleIcon: "".concat(PREFIX46, "-titleIcon")
};
var Root19 = styled_default(FilterList, {
  name: PREFIX46,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var defaultIcon19 = React109.createElement(import_BookmarkBorder.default, null);
...
var InfinitePagination = function(_a13) {
  var _b = _a13.options, options = _b === void 0 ? defaultOptions : _b, sx = _a13.sx;
  ...
  var observerElem = (0, import_react73.useRef)(null);
  ...
  if (isLoading)
    return null;
  return React110.createElement(Box_default, { ref: observerElem, py: 2, textAlign: "center", sx }, isFetchingNextPage && hasNextPage && React110.createElement(CircularProgress_default, { size: "1.5em" }));
};
...
var PaginationActions = (0, import_react74.memo)(function(props) {
  var page = props.page, rowsPerPage = props.rowsPerPage, count = props.count, onPageChange = props.onPageChange, _a13 = props.size, size = _a13 === void 0 ? "small" : _a13, className = props.className, rest = __rest66(props, ["page", "rowsPerPage", "count", "onPageChange", "size", "className"]);
  var translate = useTranslate();
  var nbPages = Math.ceil(count / rowsPerPage) || 1;
  if (nbPages === 1) {
    return React111.createElement(Root20, { className });
  }
  ...
  return React111.createElement(
    Root20,
    { className },
    React111.createElement(Pagination_default, __assign71({
      size,
      count: nbPages,
    ...
    }, sanitizeRestProps14(rest), { getItemAriaLabel }))
  );
});
PaginationActions.propTypes = {
  count: import_prop_types58.default.number.isRequired,
  onPageChange: import_prop_types58.default.func.isRequired,
  page: import_prop_types58.default.number.isRequired,
  rowsPerPage: import_prop_types58.default.number.isRequired,
  color: import_prop_types58.default.oneOf(["primary", "secondary", "standard"]),
  size: import_prop_types58.default.oneOf(["small", "medium", "large"])
};
var PREFIX47 = "RaPaginationActions";
var Root20 = styled_default("div", {
  name: PREFIX47,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var sanitizeRestProps14 = function(_a13) {
  var nextIconButtonProps = _a13.nextIconButtonProps, backIconButtonProps = _a13.backIconButtonProps, rest = __rest66(_a13, ["nextIconButtonProps", "backIconButtonProps"]);
  return rest;
};
...
var Pagination = (0, import_react75.memo)(function(props) {
  var _a13 = props.rowsPerPageOptions, rowsPerPageOptions = _a13 === void 0 ? DefaultRowsPerPageOptions : _a13, actions = props.actions, _b = props.limit, limit = _b === void 0 ? null : _b, rest = __rest67(props, ["rowsPerPageOptions", "actions", "limit"]);
  ...
  var totalPages = (0, import_react75.useMemo)(function() {
    return total != null ? Math.ceil(total / perPage) : void 0;
  }, [perPage, total]);
  var handlePageChange = (0, import_react75.useCallback)(function(event, page2) {
  ...
  var handlePerPageChange = (0, import_react75.useCallback)(function(event) {
    setPerPage(event.target.value);
  }, [setPerPage]);
  var labelDisplayedRows = (0, import_react75.useCallback)(function(_a14) {
    var from = _a14.from, to = _a14.to, count = _a14.count;
  ...
  var labelItem = (0, import_react75.useCallback)(function(type) {
    return translate("ra.navigation.".concat(type), { _: "Go to ".concat(type, " page") });
  }, [translate]);
  if (isLoading) {
    return React112.createElement(Toolbar_default, { variant: "dense" });
  }
  ...
  if (isSmall) {
    return React112.createElement(TablePagination_default, __assign72({ count: total == null ? -1 : total, rowsPerPage: perPage, page: page - 1, onPageChange: handlePageChange, rowsPerPageOptions: emptyArray, component: "span", labelDisplayedRows }, sanitizeListRestProps(rest)));
  }
  var ActionsComponent = actions ? actions : !isLoading && total != null ? PaginationActions : void 0;
  return React112.createElement(TablePagination_default, __assign72({
...
Pagination.propTypes = {
  ...
  limit: import_prop_types59.default.element,
  rowsPerPageOptions: import_prop_types59.default.arrayOf(import_prop_types59.default.number)
};
...
var PaginationLimit = (0, import_react76.memo)(function() {
  var translate = useTranslate();
  return React113.createElement(
    CardContent_default,
    null,
    React113.createElement(Typography_default, { variant: "body2" }, translate("ra.navigation.no_results"))
  );
});
...
var defaultPagination = React114.createElement(Pagination, null);
var DatagridInput = function(props) {
  var _a13;
  var choices2 = props.choices, className = props.className, _b = props.pagination, pagination = _b === void 0 ? defaultPagination : _b, filters = props.filters, sourceProp = props.source, resourceProp = props.resource, rest = __rest68(props, ["choices", "className", "pagination", "filters", "source", "resource"]);
  var _c = useChoicesContext({
    choices: choices2,
    resource: resourceProp,
    source: sourceProp
  }), allChoices = _c.allChoices, availableChoices = _c.availableChoices, selectedChoices = _c.selectedChoices, fetchError = _c.error, source = _c.source, choicesContext = __rest68(_c, ["allChoices", "availableChoices", "selectedChoices", "error", "source"]);
  var _d = useInput(__assign73(__assign73(__assign73({}, props), choicesContext), { source })), field = _d.field, fieldState = _d.fieldState, formState = _d.formState;
  var onSelect = (0, import_react77.useCallback)(function(idsToAdd) {
    field.onChange(idsToAdd);
  }, [field]);
  var onToggleItem = (0, import_react77.useCallback)(function(id) {
  ...
  var onUnselectItems = (0, import_react77.useCallback)(function() {
    field.onChange([]);
  }, [field]);
  var listContext = React114.useMemo(function() {
    return __assign73(__assign73({}, choicesContext), { data: availableChoices, onSelect, onToggleItem, onUnselectItems, selectedIds: field.value });
  }, [
    availableChoices,
    choicesContext,
    field,
  ...
  return React114.createElement(
    ...
    React114.createElement(
      ListContextProvider,
      { value: listContext },
      filters ? Array.isArray(filters) ? React114.createElement(
        FilterContext.Provider,
        { value: filters },
        React114.createElement(
          React114.Fragment,
          null,
          React114.createElement(FilterForm, null),
          React114.createElement(FilterButton, null)
        )
      ) : React114.createElement(
        React114.Fragment,
        null,
        (0, import_react77.cloneElement)(filters, {
          context: "form"
        }),
        (0, import_react77.cloneElement)(filters, {
          context: "button"
      ...
      !fieldState.error && !fetchError && React114.createElement(
        React114.Fragment,
        null,
        React114.createElement(Datagrid, __assign73({}, rest)),
        pagination !== false && pagination
      ),
      React114.createElement(InputHelperText, { touched: fieldState.isTouched || formState.isSubmitted || fetchError, error: ((_a13 = fieldState.error) === null || _a13 === void 0 ? void 0 : _a13.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message) })
    )
  );
};
...
var DateInput = function(_a13) {
  var className = _a13.className, defaultValue = _a13.defaultValue, _b = _a13.format, format = _b === void 0 ? getStringFromDate : _b, label = _a13.label, name = _a13.name, source = _a13.source, resource = _a13.resource, helperText = _a13.helperText, margin = _a13.margin, onBlur = _a13.onBlur, onChange = _a13.onChange, parse = _a13.parse, validate = _a13.validate, variant = _a13.variant, rest = __rest69(_a13, ["className", "defaultValue", "format", "label", "name", "source", "resource", "helperText", "margin", "onBlur", "onChange", "parse", "validate", "variant"]);
  var _c = useInput(__assign74({ defaultValue, name, format, parse, onBlur, onChange, resource, source, validate }, rest)), field = _c.field, fieldState = _c.fieldState, formState = _c.formState, id = _c.id, isRequired2 = _c.isRequired;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var isSubmitted = formState.isSubmitted;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React115.createElement(TextField_default, __assign74({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), type: "date", size: "small", variant, margin, error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React115.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null, label: React115.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), InputLabelProps: defaultInputLabelProps }, sanitizeInputRestProps(rest)));
};
DateInput.propTypes = {
  label: import_prop_types60.default.oneOfType([
    import_prop_types60.default.string,
    import_prop_types60.default.bool,
    import_prop_types60.default.element
  ]),
  resource: import_prop_types60.default.string,
  source: import_prop_types60.default.string
};
...
var DateTimeInput = function(_a13) {
  var className = _a13.className, defaultValue = _a13.defaultValue, _b = _a13.format, format = _b === void 0 ? formatDateTime : _b, label = _a13.label, helperText = _a13.helperText, margin = _a13.margin, onBlur = _a13.onBlur, onChange = _a13.onChange, source = _a13.source, resource = _a13.resource, _c = _a13.parse, parse = _c === void 0 ? parseDateTime : _c, validate = _a13.validate, variant = _a13.variant, rest = __rest70(_a13, ["className", "defaultValue", "format", "label", "helperText", "margin", "onBlur", "onChange", "source", "resource", "parse", "validate", "variant"]);
  var _d = useInput(__assign75({ defaultValue, format, parse, onBlur, onChange, resource, source, validate }, rest)), field = _d.field, fieldState = _d.fieldState, formState = _d.formState, id = _d.id, isRequired2 = _d.isRequired;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var isSubmitted = formState.isSubmitted;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React116.createElement(TextField_default, __assign75({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), type: "datetime-local", size: "small", variant, margin, error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React116.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null, label: React116.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), InputLabelProps: defaultInputLabelProps2 }, sanitizeInputRestProps(rest)));
};
DateTimeInput.propTypes = {
  label: import_prop_types61.default.oneOfType([
    import_prop_types61.default.string,
    import_prop_types61.default.bool,
    import_prop_types61.default.element
  ]),
  resource: import_prop_types61.default.string,
  source: import_prop_types61.default.string
};
...
var TimeInput = function(_a13) {
  var className = _a13.className, defaultValue = _a13.defaultValue, _b = _a13.format, format = _b === void 0 ? formatTime : _b, label = _a13.label, helperText = _a13.helperText, margin = _a13.margin, onBlur = _a13.onBlur, onChange = _a13.onChange, source = _a13.source, resource = _a13.resource, _c = _a13.parse, parse = _c === void 0 ? parseTime : _c, validate = _a13.validate, variant = _a13.variant, rest = __rest71(_a13, ["className", "defaultValue", "format", "label", "helperText", "margin", "onBlur", "onChange", "source", "resource", "parse", "validate", "variant"]);
  var _d = useInput(__assign76({ defaultValue, format, parse, onBlur, onChange, resource, source, validate }, rest)), field = _d.field, fieldState = _d.fieldState, formState = _d.formState, id = _d.id, isRequired2 = _d.isRequired;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var isSubmitted = formState.isSubmitted;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React117.createElement(TextField_default, __assign76({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), type: "time", size: "small", variant, margin, error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React117.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null, label: React117.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), InputLabelProps: defaultInputLabelProps3 }, sanitizeInputRestProps(rest)));
};
TimeInput.propTypes = {
  label: import_prop_types62.default.oneOfType([import_prop_types62.default.string, import_prop_types62.default.bool]),
  resource: import_prop_types62.default.string,
  source: import_prop_types62.default.string
};
...
var Dropzone = (0, import_react78.forwardRef)(function(_ref2, ref) {
  var children = _ref2.children, params = _objectWithoutProperties(_ref2, _excluded);
  ...
  return import_react78.default.createElement(import_react78.Fragment, null, children(_objectSpread2(_objectSpread2({}, props), {}, {
    open
  })));
});
...
Dropzone.propTypes = {
   ...
   */
  children: import_prop_types63.default.func,
  /**
   ...
   */
  accept: import_prop_types63.default.oneOfType([import_prop_types63.default.string, import_prop_types63.default.arrayOf(import_prop_types63.default.string)]),
  /**
   ...
   */
  preventDropOnDocument: import_prop_types63.default.bool,
  /**
   * If true, disables click to open the native file selection dialog
   */
  noClick: import_prop_types63.default.bool,
  /**
   * If true, disables SPACE/ENTER to open the native file selection dialog.
   * Note that it also stops tracking the focus state.
   */
  noKeyboard: import_prop_types63.default.bool,
  /**
   * If true, disables drag 'n' drop
   */
  noDrag: import_prop_types63.default.bool,
  /**
   * If true, stops drag event propagation to parents
   */
  noDragEventsBubbling: import_prop_types63.default.bool,
  /**
   * Minimum file size (in bytes)
   */
  minSize: import_prop_types63.default.number,
  /**
   * Maximum file size (in bytes)
   */
  maxSize: import_prop_types63.default.number,
  /**
   * Maximum accepted number of files
   * The default value is 0 which means there is no limitation to how many files are accepted.
   */
  maxFiles: import_prop_types63.default.number,
  /**
   ...
   */
  getFilesFromEvent: import_prop_types63.default.func,
  /**
   * Cb for when closing the file dialog with no selection
   */
  onFileDialogCancel: import_prop_types63.default.func,
  /**
   * Cb for when opening the file dialog
   */
  onFileDialogOpen: import_prop_types63.default.func,
  /**
   * Set to true to use the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API
   * to open the file picker instead of using an `<input type="file">` click event.
   */
  useFsAccessApi: import_prop_types63.default.bool,
  /**
   * Cb for when the `dragenter` event occurs.
   *
   * @param {DragEvent} event
   */
  onDragEnter: import_prop_types63.default.func,
  /**
   ...
   * @param {DragEvent} event
   */
  onDragOver: import_prop_types63.default.func,
  /**
   ...
   * @param {(DragEvent|Event)} event A drag event or input change event (if files were selected via the file dialog)
   */
  onDrop: import_prop_types63.default.func,
  /**
   * Cb for when the `drop` event occurs.
   ...
   */
  onDropAccepted: import_prop_types63.default.func,
  /**
   * Cb for when the `drop` event occurs.
   ...
   * @param {(DragEvent|Event)} event
   */
  onDropRejected: import_prop_types63.default.func,
  /**
   * Custom validation function
   * @param {File} file
   * @returns {FileError|FileError[]}
   */
  validator: import_prop_types63.default.func
};
var initialState2 = {
  isFocused: false,
...
function useDropzone() {
  ...
  var onFileDialogOpenCb = (0, import_react78.useMemo)(function() {
    return typeof onFileDialogOpen === "function" ? onFileDialogOpen : noop;
  }, [onFileDialogOpen]);
  var onFileDialogCancelCb = (0, import_react78.useMemo)(function() {
    return typeof onFileDialogCancel === "function" ? onFileDialogCancel : noop;
  }, [onFileDialogCancel]);
  var rootRef = (0, import_react78.useRef)(null);
  var inputRef = (0, import_react78.useRef)(null);
  var _useReducer = (0, import_react78.useReducer)(reducer, initialState2), _useReducer2 = _slicedToArray2(_useReducer, 2), state = _useReducer2[0], dispatch = _useReducer2[1];
  var isFocused = state.isFocused, isFileDialogActive = state.isFileDialogActive, draggedFiles = state.draggedFiles;
  var fsAccessApiWorksRef = (0, import_react78.useRef)(typeof window !== "undefined" && window.isSecureContext && useFsAccessApi && canUseFileSystemAccessAPI());
  ...
  var dragTargetsRef = (0, import_react78.useRef)([]);
  ...
  var onDragEnterCb = (0, import_react78.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
  ...
  var onDragOverCb = (0, import_react78.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation8(event);
  ...
  var onDragLeaveCb = (0, import_react78.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation8(event);
  ...
  var setFiles = (0, import_react78.useCallback)(function(files, event) {
    var acceptedFiles = [];
    var fileRejections = [];
  ...
  var onDropCb = (0, import_react78.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation8(event);
    dragTargetsRef.current = [];
  ...
  var openFileDialog = (0, import_react78.useCallback)(function() {
  ...
  var onKeyDownCb = (0, import_react78.useCallback)(function(event) {
  ...
  var onFocusCb = (0, import_react78.useCallback)(function() {
    dispatch({
      type: "focus"
    });
  }, []);
  var onBlurCb = (0, import_react78.useCallback)(function() {
    dispatch({
      type: "blur"
    });
  }, []);
  var onClickCb = (0, import_react78.useCallback)(function() {
    if (noClick) {
      return;
    }
    if (isIeOrEdge()) {
  ...
  var getRootProps = (0, import_react78.useMemo)(function() {
    return function() {
  ...
  var onInputElementClick = (0, import_react78.useCallback)(function(event) {
    event.stopPropagation();
  }, []);
  var getInputProps = (0, import_react78.useMemo)(function() {
    return function() {
...
var FileInputPreview = function(props) {
  var children = props.children, className = props.className, onRemove = props.onRemove, file = props.file, _a13 = props.removeIcon, RemoveIcon2 = _a13 === void 0 ? import_RemoveCircle.default : _a13, rest = __rest72(props, ["children", "className", "onRemove", "file", "removeIcon"]);
  var translate = useTranslate();
  ...
  return React119.createElement(
    ...
    React119.createElement(
      ...
      React119.createElement(RemoveIcon2, { className: FileInputPreviewClasses.removeIcon })
    ),
    children
  );
};
FileInputPreview.propTypes = {
  ...
  file: import_prop_types64.default.object,
  onRemove: import_prop_types64.default.func.isRequired,
  removeIcon: import_prop_types64.default.element
};
FileInputPreview.defaultProps = {
  file: void 0
};
var PREFIX48 = "RaFileInputPreview";
var FileInputPreviewClasses = {
  removeButton: "".concat(PREFIX48, "-removeButton"),
  removeIcon: "".concat(PREFIX48, "-removeIcon")
};
var Root21 = styled_default("div", {
  name: PREFIX48,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var FileInput = function(props) {
  var accept = props.accept, children = props.children, className = props.className, format = props.format, helperText = props.helperText, inputPropsOptions = props.inputProps, maxSize = props.maxSize, minSize = props.minSize, _a13 = props.multiple, multiple = _a13 === void 0 ? false : _a13, label = props.label, _b = props.labelMultiple, labelMultiple = _b === void 0 ? "ra.input.file.upload_several" : _b, _c = props.labelSingle, labelSingle = _c === void 0 ? "ra.input.file.upload_single" : _c, _d = props.options, options = _d === void 0 ? {} : _d, onRemoveProp = props.onRemove, parse = props.parse, placeholder = props.placeholder, removeIcon = props.removeIcon, resource = props.resource, source = props.source, validate = props.validate, validateFileRemoval = props.validateFileRemoval, rest = __rest73(props, ["accept", "children", "className", "format", "helperText", "inputProps", "maxSize", "minSize", "multiple", "label", "labelMultiple", "labelSingle", "options", "onRemove", "parse", "placeholder", "removeIcon", "resource", "source", "validate", "validateFileRemoval"]);
  ...
  var _e = useInput(__assign78({ format: format || transformFiles, parse: parse || transformFiles, source, validate }, rest)), id = _e.id, _f = _e.field, onChange = _f.onChange, value = _f.value, fieldState = _e.fieldState, isSubmitted = _e.formState.isSubmitted, isRequired2 = _e.isRequired;
  ...
  var childrenElement = children && (0, import_react80.isValidElement)(import_react80.Children.only(children)) ? import_react80.Children.only(children) : void 0;
  var _g = useDropzone(__assign78(__assign78({ accept, maxSize, minSize, multiple }, options), { onDrop })), getRootProps = _g.getRootProps, getInputProps = _g.getInputProps;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return import_react80.default.createElement(
    StyledLabeled,
    __assign78({ htmlFor: id, label, className: clsx_m_default("ra-input", "ra-input-".concat(source), className), source, resource, isRequired: isRequired2, color: (isTouched || isSubmitted) && invalid ? "error" : void 0 }, sanitizeInputRestProps(rest)),
    import_react80.default.createElement(
      import_react80.default.Fragment,
      null,
      import_react80.default.createElement(
        "div",
        __assign78({}, getRootProps({
          className: FileInputClasses.dropZone,
          "data-testid": "dropzone"
        })),
        import_react80.default.createElement("input", __assign78({ id, name: id }, getInputProps(__assign78({}, inputPropsOptions)))),
        placeholder ? placeholder : multiple ? import_react80.default.createElement("p", null, translate(labelMultiple)) : import_react80.default.createElement("p", null, translate(labelSingle))
      ),
      renderHelperText ? import_react80.default.createElement(
        FormHelperText_default,
        { error: (isTouched || isSubmitted) && invalid },
        import_react80.default.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText })
      ) : null,
      children && import_react80.default.createElement("div", { className: "previews" }, files.map(function(file, index) {
        return import_react80.default.createElement(
          FileInputPreview,
          { key: index, file, onRemove: onRemove(file), className: FileInputClasses.removeButton, removeIcon },
          import_react80.default.createElement(RecordContextProvider, { value: file }, childrenElement)
        );
      }))
    )
  );
...
FileInput.propTypes = {
  accept: import_prop_types65.default.string,
  children: import_prop_types65.default.element,
  className: import_prop_types65.default.string,
  id: import_prop_types65.default.string,
  isRequired: import_prop_types65.default.bool,
  label: import_prop_types65.default.oneOfType([
    import_prop_types65.default.string,
    import_prop_types65.default.bool,
    import_prop_types65.default.element
  ]),
  labelMultiple: import_prop_types65.default.string,
  labelSingle: import_prop_types65.default.string,
  maxSize: import_prop_types65.default.number,
  minSize: import_prop_types65.default.number,
  multiple: import_prop_types65.default.bool,
  validateFileRemoval: import_prop_types65.default.func,
  options: import_prop_types65.default.object,
  removeIcon: import_prop_types65.default.elementType,
  resource: import_prop_types65.default.string,
  source: import_prop_types65.default.string,
  placeholder: import_prop_types65.default.node
};
var PREFIX49 = "RaFileInput";
var FileInputClasses = {
  dropZone: "".concat(PREFIX49, "-dropZone"),
  removeButton: "".concat(PREFIX49, "-removeButton")
};
var StyledLabeled = styled_default(Labeled, {
  name: PREFIX49,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ImageInput = function(props) {
  return React121.createElement(StyledFileInput, __assign79({ labelMultiple: "ra.input.image.upload_several", labelSingle: "ra.input.image.upload_single" }, props));
};
var PREFIX50 = "RaImageInput";
var StyledFileInput = styled_default(FileInput, {
  name: PREFIX50,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var _a6;
var ResettableTextField = (0, import_react81.forwardRef)(function(props, ref) {
  var clearAlwaysVisible = props.clearAlwaysVisible, InputProps = props.InputProps, value = props.value, resettable = props.resettable, disabled = props.disabled, variant = props.variant, margin = props.margin, className = props.className, rest = __rest74(props, ["clearAlwaysVisible", "InputProps", "value", "resettable", "disabled", "variant", "margin", "className"]);
  var translate = useTranslate();
  var onChange = props.onChange, onFocus = props.onFocus, onBlur = props.onBlur;
  var handleClickClearButton = (0, import_react81.useCallback)(function(event) {
    event.preventDefault();
    onChange("");
  }, [onChange]);
  var handleFocus = (0, import_react81.useCallback)(function(event) {
    onFocus && onFocus(event);
  }, [onFocus]);
  var handleBlur = (0, import_react81.useCallback)(function(event) {
    onBlur && onBlur(event);
  }, [onBlur]);
  ...
  var _a13 = InputProps || {}, endAdornment = _a13.endAdornment, InputPropsWithoutEndAdornment = __rest74(_a13, ["endAdornment"]);
    ...
    if (!resettable) {
      ...
      if (clearAlwaysVisible) {
        return React122.createElement(
          ...
          React122.createElement(
            ...
            React122.createElement(import_Clear.default, { className: clsx_m_default(clearIcon, visibleClearIcon) })
          )
        );
      } else {
        if (endAdornment) {
          ...
          return React122.createElement(
            ...
            React122.createElement("span", { className: clearButton }, " ")
          );
        }
      }
    } else {
      return React122.createElement(
        ...
        React122.createElement(
          ...
          React122.createElement(import_Clear.default, { className: clsx_m_default(clearIcon, (_a14 = {}, _a14[visibleClearIcon] = clearAlwaysVisible || value, _a14)) })
        )
      );
    }
  };
  return React122.createElement(StyledTextField, __assign80({ value, InputProps: __assign80({ classes: props.select && variant === "filled" ? { adornedEnd: inputAdornedEnd } : {}, endAdornment: getEndAdornment() }, InputPropsWithoutEndAdornment), disabled, variant, margin, className, size: "small" }, rest, { onFocus: handleFocus, onBlur: handleBlur, inputRef: ref }));
});
...
ResettableTextField.propTypes = {
  clearAlwaysVisible: import_prop_types66.default.bool,
  ...
  resettable: import_prop_types66.default.bool,
  value: import_prop_types66.default.any
};
var PREFIX51 = "RaResettableTextField";
var ResettableTextFieldClasses = {
  clearIcon: "".concat(PREFIX51, "-clearIcon"),
  visibleClearIcon: "".concat(PREFIX51, "-visibleClearIcon"),
  clearButton: "".concat(PREFIX51, "-clearButton"),
  selectAdornment: "".concat(PREFIX51, "-selectAdornment"),
  inputAdornedEnd: "".concat(PREFIX51, "-inputAdornedEnd")
};
...
var StyledTextField = styled_default(TextField_default, {
  name: PREFIX51,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var LoadingInput = function(_a13) {
  var fullWidth = _a13.fullWidth, label = _a13.label, helperText = _a13.helperText, margin = _a13.margin, size = _a13.size, sx = _a13.sx, _b = _a13.timeout, timeout = _b === void 0 ? 1e3 : _b, variant = _a13.variant;
  var oneSecondHasPassed = useTimeout(timeout);
  return React123.createElement(StyledResettableTextField, { sx, label, helperText, fullWidth, variant, margin, size, disabled: true, onChange: function() {
  }, InputProps: {
    endAdornment: React123.createElement(InputAdornment_default, { position: "end" }, oneSecondHasPassed ? React123.createElement(CircularProgress_default, { color: "inherit", size: 20 }) : (
      // use an adornment of the same size to avoid visual jumps
      React123.createElement("span", { style: { width: 20 } }, " ")
    ))
  } });
};
var PREFIX52 = "RaLoadingInput";
var StyledResettableTextField = styled_default(ResettableTextField, {
  name: PREFIX52,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var NullableBooleanInput = function(props) {
  var className = props.className, _a13 = props.format, format = _a13 === void 0 ? getStringFromBoolean : _a13, helperText = props.helperText, label = props.label, margin = props.margin, onBlur = props.onBlur, onChange = props.onChange, _b = props.parse, parse = _b === void 0 ? getBooleanFromString : _b, resource = props.resource, source = props.source, validate = props.validate, variant = props.variant, _c = props.nullLabel, nullLabel = _c === void 0 ? "ra.boolean.null" : _c, _d = props.falseLabel, falseLabel = _d === void 0 ? "ra.boolean.false" : _d, _e = props.trueLabel, trueLabel = _e === void 0 ? "ra.boolean.true" : _e, rest = __rest75(props, ["className", "format", "helperText", "label", "margin", "onBlur", "onChange", "parse", "resource", "source", "validate", "variant", "nullLabel", "falseLabel", "trueLabel"]);
  var translate = useTranslate();
  var _f = useInput(__assign81({ format, parse, onBlur, onChange, resource, source, validate }, rest)), field = _f.field, _g = _f.fieldState, error = _g.error, invalid = _g.invalid, isTouched = _g.isTouched, isSubmitted = _f.formState.isSubmitted, id = _f.id, isRequired2 = _f.isRequired;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React124.createElement(
    StyledTextField2,
    __assign81({ id, size: "small" }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), NullableBooleanInputClasses.input, className), select: true, margin, label: React124.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React124.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null, variant }, sanitizeInputRestProps(rest)),
    React124.createElement(MenuItem_default, { value: "" }, translate(nullLabel)),
    React124.createElement(MenuItem_default, { value: "false" }, translate(falseLabel)),
    React124.createElement(MenuItem_default, { value: "true" }, translate(trueLabel))
  );
};
NullableBooleanInput.propTypes = {
  label: import_prop_types67.default.oneOfType([
    import_prop_types67.default.string,
    import_prop_types67.default.bool,
    import_prop_types67.default.element
  ]),
  options: import_prop_types67.default.object,
  resource: import_prop_types67.default.string,
  source: import_prop_types67.default.string,
  nullLabel: import_prop_types67.default.string,
  falseLabel: import_prop_types67.default.string,
  trueLabel: import_prop_types67.default.string
};
var PREFIX53 = "RaNullableBooleanInput";
var NullableBooleanInputClasses = {
  input: "".concat(PREFIX53, "-input")
};
var StyledTextField2 = styled_default(TextField_default, {
  name: PREFIX53,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var NumberInput = function(_a13) {
  var className = _a13.className, _b = _a13.defaultValue, defaultValue = _b === void 0 ? null : _b, _c = _a13.format, format = _c === void 0 ? convertNumberToString : _c, helperText = _a13.helperText, label = _a13.label, margin = _a13.margin, onChange = _a13.onChange, onBlur = _a13.onBlur, onFocus = _a13.onFocus, parse = _a13.parse, resource = _a13.resource, source = _a13.source, step = _a13.step, min = _a13.min, max = _a13.max, validate = _a13.validate, variant = _a13.variant, overrideInputProps = _a13.inputProps, rest = __rest76(_a13, ["className", "defaultValue", "format", "helperText", "label", "margin", "onChange", "onBlur", "onFocus", "parse", "resource", "source", "step", "min", "max", "validate", "variant", "inputProps"]);
  var _d = useInput(__assign82({ defaultValue, onBlur, resource, source, validate }, rest)), field = _d.field, _e = _d.fieldState, error = _e.error, invalid = _e.invalid, isTouched = _e.isTouched, isSubmitted = _d.formState.isSubmitted, id = _d.id, isRequired2 = _d.isRequired;
  var onBlurFromField = field.onBlur;
  var inputProps = __assign82(__assign82({}, overrideInputProps), { step, min, max });
  var _f = React125.useState(format(field.value)), value = _f[0], setValue = _f[1];
  var hasFocus = React125.useRef(false);
  ...
  var handleChange = function(event) {
    ...
    var newValue = target.valueAsNumber !== void 0 && target.valueAsNumber !== null && !isNaN(target.valueAsNumber) ? parse ? parse(target.valueAsNumber) : target.valueAsNumber : parse ? parse(target.value) : convertStringToNumber(target.value);
  ...
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React125.createElement(TextField_default, __assign82({ id }, field, {
    ...
    variant,
    error: (isTouched || isSubmitted) && invalid,
    helperText: renderHelperText ? React125.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null,
    label: React125.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }),
    margin,
    inputProps
  }, sanitizeInputRestProps(rest)));
};
NumberInput.propTypes = {
  label: import_prop_types68.default.oneOfType([
    import_prop_types68.default.string,
    import_prop_types68.default.bool,
    import_prop_types68.default.element
  ]),
  options: import_prop_types68.default.object,
  resource: import_prop_types68.default.string,
  source: import_prop_types68.default.string,
  step: import_prop_types68.default.oneOfType([import_prop_types68.default.string, import_prop_types68.default.number])
};
...
var TextInput = function(props) {
  var className = props.className, defaultValue = props.defaultValue, label = props.label, format = props.format, helperText = props.helperText, onBlur = props.onBlur, onChange = props.onChange, parse = props.parse, resource = props.resource, source = props.source, validate = props.validate, rest = __rest77(props, ["className", "defaultValue", "label", "format", "helperText", "onBlur", "onChange", "parse", "resource", "source", "validate"]);
  var _a13 = useInput(__assign83({ defaultValue, format, parse, resource, source, type: "text", validate, onBlur, onChange }, rest)), field = _a13.field, _b = _a13.fieldState, error = _b.error, invalid = _b.invalid, isTouched = _b.isTouched, isSubmitted = _a13.formState.isSubmitted, id = _a13.id, isRequired2 = _a13.isRequired;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
  return React126.createElement(ResettableTextField, __assign83({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), label: label !== "" && label !== false ? React126.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }) : null, error: (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React126.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }) : null }, sanitizeInputRestProps(rest)));
};
TextInput.propTypes = {
  className: import_prop_types69.default.string,
  label: import_prop_types69.default.oneOfType([
    import_prop_types69.default.string,
    import_prop_types69.default.bool,
    import_prop_types69.default.element
  ]),
  options: import_prop_types69.default.object,
  resource: import_prop_types69.default.string,
  source: import_prop_types69.default.string
};
...
var PasswordInput = function(props) {
  var _a13 = props.initiallyVisible, initiallyVisible = _a13 === void 0 ? false : _a13, rest = __rest78(props, ["initiallyVisible"]);
  var _b = (0, import_react82.useState)(initiallyVisible), visible = _b[0], setVisible = _b[1];
  var translate = useTranslate();
  var handleClick2 = function() {
    setVisible(!visible);
  };
  return React127.createElement(TextInput, __assign84({ type: visible ? "text" : "password", size: "small", InputProps: {
    endAdornment: React127.createElement(
      InputAdornment_default,
      { position: "end" },
      React127.createElement(IconButton_default, { "aria-label": translate(visible ? "ra.input.password.toggle_visible" : "ra.input.password.toggle_hidden"), onClick: handleClick2, size: "large" }, visible ? React127.createElement(import_Visibility.default, null) : React127.createElement(import_VisibilityOff.default, null))
    )
  } }, rest));
};
...
var RadioButtonGroupInputItem = function(_a13) {
  ...
  return React128.createElement(FormControlLabel_default, { label, htmlFor: nodeId, value, control: React128.createElement(Radio_default, { id: nodeId, color: "primary" }) });
};
...
var RadioButtonGroupInput = function(props) {
  var choicesProp = props.choices, className = props.className, format = props.format, helperText = props.helperText, isFetchingProp = props.isFetching, isLoadingProp = props.isLoading, label = props.label, _a13 = props.margin, margin = _a13 === void 0 ? "dense" : _a13, onBlur = props.onBlur, onChange = props.onChange, options = props.options, optionText = props.optionText, optionValue = props.optionValue, parse = props.parse, resourceProp = props.resource, row = props.row, sourceProp = props.source, translateChoice = props.translateChoice, validate = props.validate, rest = __rest79(props, ["choices", "className", "format", "helperText", "isFetching", "isLoading", "label", "margin", "onBlur", "onChange", "options", "optionText", "optionValue", "parse", "resource", "row", "source", "translateChoice", "validate"]);
  ...
  var _c = useInput(__assign85({ format, onBlur, onChange, parse, resource, source, validate }, rest)), id = _c.id, isRequired2 = _c.isRequired, fieldState = _c.fieldState, field = _c.field, formState = _c.formState;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var isSubmitted = formState.isSubmitted;
  if (isLoading) {
    return React129.createElement(
      ...
      React129.createElement(LinearProgress, null)
    );
  }
  var renderHelperText = !!fetchError || helperText !== false || (isTouched || isSubmitted) && invalid;
  return React129.createElement(
    StyledFormControl2,
    __assign85({ component: "fieldset", className: clsx_m_default("ra-input", "ra-input-".concat(source), className), margin, error: fetchError || (isTouched || isSubmitted) && invalid }, sanitizeRestProps15(rest)),
    React129.createElement(
      FormLabel_default,
      { component: "legend", className: RadioButtonGroupInputClasses.label },
      React129.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 })
    ),
    React129.createElement(RadioGroup_default, __assign85({ id, row }, field, options, sanitizeRestProps15(rest)), allChoices === null || allChoices === void 0 ? void 0 : allChoices.map(function(choice) {
      return React129.createElement(RadioButtonGroupInputItem, { key: (0, import_get8.default)(choice, optionValue), choice, optionText, optionValue, source: id, translateChoice });
    })),
    renderHelperText ? React129.createElement(
      FormHelperText_default,
      null,
      React129.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText })
    ) : null
  );
};
RadioButtonGroupInput.propTypes = {
  choices: import_prop_types70.default.arrayOf(import_prop_types70.default.any),
  label: import_prop_types70.default.oneOfType([
    import_prop_types70.default.string,
    import_prop_types70.default.bool,
    import_prop_types70.default.element
  ]),
  options: import_prop_types70.default.object,
  optionText: import_prop_types70.default.oneOfType([
    import_prop_types70.default.string,
    import_prop_types70.default.func,
    import_prop_types70.default.element
  ]),
  optionValue: import_prop_types70.default.string,
  resource: import_prop_types70.default.string,
  source: import_prop_types70.default.string,
  translateChoice: import_prop_types70.default.bool
};
...
var ReferenceArrayInput = function(props) {
  ...
  if (React130.Children.count(children) !== 1) {
  ...
  return React130.createElement(
    ResourceContextProvider,
    { value: reference },
    React130.createElement(ChoicesContextProvider, { value: controllerProps }, children)
  );
};
ReferenceArrayInput.propTypes = {
  children: import_prop_types71.default.element,
  filter: import_prop_types71.default.object,
  label: import_prop_types71.default.string,
  page: import_prop_types71.default.number,
  perPage: import_prop_types71.default.number,
  reference: import_prop_types71.default.string.isRequired,
  resource: import_prop_types71.default.string,
  sort: import_prop_types71.default.shape({
    field: import_prop_types71.default.string,
    order: import_prop_types71.default.oneOf(["ASC", "DESC"])
  }),
  source: import_prop_types71.default.string
};
ReferenceArrayInput.defaultProps = {
  ...
  children: React130.createElement(AutocompleteArrayInput, null)
};
...
var ReferenceError2 = function(_a13) {
  ...
  return React131.createElement(TextField_default, { error: true, disabled: true, label, helperText: error === null || error === void 0 ? void 0 : error.message, margin: "normal" });
};
ReferenceError2.propTypes = {
  error: import_prop_types72.default.object.isRequired,
  label: import_prop_types72.default.oneOfType([
    import_prop_types72.default.string,
    import_prop_types72.default.element,
    import_prop_types72.default.bool
  ])
};
...
var ReferenceInput = function(props) {
  ...
  if (import_react83.Children.count(children) !== 1) {
    throw new Error("<ReferenceInput> only accepts a single child");
  }
  return import_react83.default.createElement(
    ResourceContextProvider,
    { value: reference },
    import_react83.default.createElement(ChoicesContextProvider, { value: controllerProps }, children)
  );
};
ReferenceInput.propTypes = {
  children: import_prop_types73.default.element,
  filter: import_prop_types73.default.object,
  label: import_prop_types73.default.string,
  page: import_prop_types73.default.number,
  perPage: import_prop_types73.default.number,
  record: import_prop_types73.default.object,
  reference: import_prop_types73.default.string.isRequired,
  resource: import_prop_types73.default.string,
  sort: import_prop_types73.default.shape({
    field: import_prop_types73.default.string,
    order: import_prop_types73.default.oneOf(["ASC", "DESC"])
  }),
  source: import_prop_types73.default.string
};
ReferenceInput.defaultProps = {
  ...
  perPage: 25,
  sort: { field: "id", order: "DESC" },
  children: import_react83.default.createElement(AutocompleteInput, null)
};
...
var SearchInput = function(props) {
  var label = props.label, rest = __rest80(props, ["label"]);
  var translate = useTranslate();
  if (label) {
    throw new Error("<SearchInput> isn't designed to be used with a label prop. Use <TextInput> if you need a label.");
  }
  return React133.createElement(StyledTextInput, __assign86({ hiddenLabel: true, label: "", resettable: true, placeholder: translate("ra.action.search"), InputProps: {
    endAdornment: React133.createElement(
      InputAdornment_default,
      { position: "end" },
      React133.createElement(import_Search2.default, { color: "disabled" })
    )
  }, size: "small" }, rest));
};
var PREFIX55 = "RaSearchInput";
var StyledTextInput = styled_default(TextInput, {
  name: PREFIX55,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var SelectArrayInput = function(props) {
  var _a13;
  var choicesProp = props.choices, className = props.className, create2 = props.create, createLabel = props.createLabel, createValue = props.createValue, disableValue = props.disableValue, format = props.format, helperText = props.helperText, label = props.label, isFetchingProp = props.isFetching, isLoadingProp = props.isLoading, margin = props.margin, onBlur = props.onBlur, onChange = props.onChange, onCreate = props.onCreate, options = props.options, optionText = props.optionText, optionValue = props.optionValue, parse = props.parse, resourceProp = props.resource, _b = props.size, size = _b === void 0 ? "small" : _b, sourceProp = props.source, translateChoice = props.translateChoice, validate = props.validate, variant = props.variant, rest = __rest81(props, ["choices", "className", "create", "createLabel", "createValue", "disableValue", "format", "helperText", "label", "isFetching", "isLoading", "margin", "onBlur", "onChange", "onCreate", "options", "optionText", "optionValue", "parse", "resource", "size", "source", "translateChoice", "validate", "variant"]);
  var inputLabel = (0, import_react84.useRef)(null);
  var _c = useChoicesContext({
    choices: choicesProp,
    isLoading: isLoadingProp,
    isFetching: isFetchingProp,
    resource: resourceProp,
    source: sourceProp
  }), allChoices = _c.allChoices, isLoading = _c.isLoading, fetchError = _c.error, source = _c.source, resource = _c.resource;
  var _d = useChoices({
    optionText,
    optionValue,
    disableValue,
  ...
  var _e = useInput(__assign87({ format, onBlur, onChange, parse, resource, source, validate }, rest)), field = _e.field, isRequired2 = _e.isRequired, _f = _e.fieldState, error = _f.error, invalid = _f.invalid, isTouched = _f.isTouched, isSubmitted = _e.formState.isSubmitted;
  var handleChange = (0, import_react84.useCallback)(function(eventOrChoice) {
    if (eventOrChoice === null || eventOrChoice === void 0 ? void 0 : eventOrChoice.target) {
      eventOrChoice.target.value = eventOrChoice.target.value.reduce(function(acc, value) {
        ...
        return index < 0 ? __spreadArray10(__spreadArray10([], acc, true), [value], false) : __spreadArray10(__spreadArray10([], acc.slice(0, index), true), acc.slice(index + 1), true);
      }, []);
  ...
  var _g = useSupportCreateSuggestion({
    ...
    onCreate,
    optionText
  }), getCreateItem = _g.getCreateItem, handleChangeWithCreateSupport = _g.handleChange, createElement195 = _g.createElement;
  ...
  var renderMenuItemOption = (0, import_react84.useCallback)(function(choice) {
  ...
  var renderMenuItem = (0, import_react84.useCallback)(function(choice) {
    return choice ? React134.createElement(MenuItem_default, { key: getChoiceValue(choice), value: getChoiceValue(choice), disabled: getDisableValue(choice) }, renderMenuItemOption(!!createItem && (choice === null || choice === void 0 ? void 0 : choice.id) === createItem.id ? createItem : choice)) : null;
  ...
  if (isLoading) {
    return React134.createElement(
      ...
      React134.createElement(LinearProgress, null)
    );
  }
  ...
  var outlinedInputProps = variant === "outlined" ? {
    input: React134.createElement(OutlinedInput_default, { id: "select-multiple-chip", label: React134.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }) })
  } : {};
  var renderHelperText = !!fetchError || helperText !== false || (isTouched || isSubmitted) && invalid;
  return React134.createElement(
    React134.Fragment,
    ...
    React134.createElement(
      StyledFormControl3,
      __assign87({ margin, className: clsx_m_default("ra-input", "ra-input-".concat(source), className), error: fetchError || (isTouched || isSubmitted) && invalid, variant }, sanitizeRestProps16(rest)),
      React134.createElement(
        InputLabel_default,
        { ref: inputLabel, id: "".concat(label, "-outlined-label") },
        React134.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 })
      ),
      React134.createElement(Select_default, __assign87({ autoWidth: true, labelId: "".concat(label, "-outlined-label"), label: React134.createElement(FieldTitle_default, { label, source, resource, isRequired: isRequired2 }), multiple: true, error: !!fetchError || (isTouched || isSubmitted) && invalid, renderValue: function(selected) {
        return React134.createElement("div", { className: SelectArrayInputClasses.chips }, (Array.isArray(selected) ? selected : []).map(function(item) {
          ...
          return React134.createElement(Chip_default, { key: getChoiceValue(item), label: renderMenuItemOption(item), className: SelectArrayInputClasses.chip, size: "small" });
        }));
      }, "data-testid": "selectArray", size }, field, options, { onChange: handleChangeWithCreateSupport, value: finalValue }, outlinedInputProps), finalChoices.map(renderMenuItem)),
      renderHelperText ? React134.createElement(
        FormHelperText_default,
        { error: fetchError || isTouched && !!error },
        React134.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText })
      ) : null
    ),
    createElement195
  );
...
SelectArrayInput.propTypes = {
  choices: import_prop_types74.default.arrayOf(import_prop_types74.default.object),
  className: import_prop_types74.default.string,
  children: import_prop_types74.default.node,
  label: import_prop_types74.default.oneOfType([
    import_prop_types74.default.string,
    import_prop_types74.default.bool,
    import_prop_types74.default.element
  ]),
  options: import_prop_types74.default.object,
  optionText: import_prop_types74.default.oneOfType([
    import_prop_types74.default.string,
    import_prop_types74.default.func,
    import_prop_types74.default.element
  ]).isRequired,
  optionValue: import_prop_types74.default.string.isRequired,
  disableValue: import_prop_types74.default.string,
  resource: import_prop_types74.default.string,
  source: import_prop_types74.default.string,
  translateChoice: import_prop_types74.default.bool
};
...
var SelectInput = function(props) {
  var choicesProp = props.choices, className = props.className, create2 = props.create, createLabel = props.createLabel, createValue = props.createValue, defaultValue = props.defaultValue, disableValue = props.disableValue, emptyText = props.emptyText, emptyValue = props.emptyValue, format = props.format, filter = props.filter, helperText = props.helperText, isFetchingProp = props.isFetching, isLoadingProp = props.isLoading, label = props.label, _a13 = props.margin, margin = _a13 === void 0 ? "dense" : _a13, onBlur = props.onBlur, onChange = props.onChange, onCreate = props.onCreate, optionText = props.optionText, optionValue = props.optionValue, parse = props.parse, resourceProp = props.resource, sourceProp = props.source, translateChoice = props.translateChoice, validate = props.validate, rest = __rest82(props, ["choices", "className", "create", "createLabel", "createValue", "defaultValue", "disableValue", "emptyText", "emptyValue", "format", "filter", "helperText", "isFetching", "isLoading", "label", "margin", "onBlur", "onChange", "onCreate", "optionText", "optionValue", "parse", "resource", "source", "translateChoice", "validate"]);
  var translate = useTranslate();
  ...
  var _d = useInput(__assign88({ defaultValue, parse, format, onBlur, onChange, resource, source, validate }, rest)), field = _d.field, fieldState = _d.fieldState, id = _d.id, isRequired2 = _d.isRequired, isSubmitted = _d.formState.isSubmitted;
  var error = fieldState.error, invalid = fieldState.invalid, isTouched = fieldState.isTouched;
  var renderEmptyItemOption = (0, import_react85.useCallback)(function() {
    return (0, import_react_is3.isElement)(emptyText) ? emptyText : emptyText === "" ? " " : translate(emptyText, { _: emptyText });
  }, [emptyText, translate]);
  var renderMenuItemOption = (0, import_react85.useCallback)(function(choice) {
    return getChoiceText(choice);
  }, [
    getChoiceText
  ]);
  var handleChange = (0, import_react85.useCallback)(function(eventOrChoice) {
  ...
  var _e = useSupportCreateSuggestion({
    ...
    onCreate,
    optionText
  }), getCreateItem = _e.getCreateItem, handleChangeWithCreateSupport = _e.handleChange, createElement195 = _e.createElement;
  var createItem = create2 || onCreate ? getCreateItem() : null;
  var finalChoices = allChoices;
  if (create2 || onCreate) {
    finalChoices = __spreadArray11(__spreadArray11([], finalChoices, true), [createItem], false);
  }
  var renderMenuItem = (0, import_react85.useCallback)(function(choice) {
    return choice ? React135.createElement(MenuItem_default, { key: getChoiceValue(choice), value: getChoiceValue(choice), disabled: getDisableValue(choice) }, renderMenuItemOption(!!createItem && (choice === null || choice === void 0 ? void 0 : choice.id) === createItem.id ? createItem : choice)) : null;
  }, [getChoiceValue, getDisableValue, renderMenuItemOption, createItem]);
  if (isLoading) {
    return React135.createElement(LoadingInput, { label: label !== "" && label !== false && React135.createElement(FieldTitle_default, { label, source, resource: resourceProp, isRequired: isRequired2 }), sx: props.sx, helperText: React135.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText }), variant: props.variant, size: props.size, margin: props.margin, fullWidth: props.fullWidth });
  }
  var renderHelperText = !!fetchError || helperText !== false || (isTouched || isSubmitted) && invalid;
  return React135.createElement(
    ...
    React135.createElement(
      ...
      __assign88({ id }, field, { className: clsx_m_default("ra-input", "ra-input-".concat(source), className), onChange: handleChangeWithCreateSupport, select: true, label: label !== "" && label !== false && React135.createElement(FieldTitle_default, { label, source, resource: resourceProp, isRequired: isRequired2 }), clearAlwaysVisible: true, error: !!fetchError || (isTouched || isSubmitted) && invalid, helperText: renderHelperText ? React135.createElement(InputHelperText, { touched: isTouched || isSubmitted || fetchError, error: (error === null || error === void 0 ? void 0 : error.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message), helperText }) : null, margin }, sanitizeRestProps17(rest)),
      !isRequired2 && React135.createElement(MenuItem_default, { value: emptyValue, key: "null", "aria-label": translate("ra.action.clear_input_value"), title: translate("ra.action.clear_input_value") }, renderEmptyItemOption()),
...
SelectInput.propTypes = {
  emptyText: import_prop_types75.default.oneOfType([import_prop_types75.default.string, import_prop_types75.default.element]),
  emptyValue: import_prop_types75.default.any,
  choices: import_prop_types75.default.arrayOf(import_prop_types75.default.object),
  className: import_prop_types75.default.string,
  label: import_prop_types75.default.oneOfType([
    import_prop_types75.default.string,
    import_prop_types75.default.bool,
    import_prop_types75.default.element
  ]),
  options: import_prop_types75.default.object,
  optionText: import_prop_types75.default.oneOfType([
    import_prop_types75.default.string,
    import_prop_types75.default.func,
    import_prop_types75.default.element
  ]),
  optionValue: import_prop_types75.default.string,
  disableValue: import_prop_types75.default.string,
  resettable: import_prop_types75.default.bool,
  resource: import_prop_types75.default.string,
  source: import_prop_types75.default.string,
  translateChoice: import_prop_types75.default.bool
};
...
var StyledResettableTextField2 = styled_default(ResettableTextField, {
  ...
  var theme = _a13.theme;
  return __assign88(__assign88({}, ResettableTextFieldStyles), { minWidth: theme.spacing(20), "& .MuiFilledInput-root": { paddingRight: 0 } });
});
...
var TranslatableInputsTab = function(props) {
  var _a13;
  var _b = props.groupKey, groupKey = _b === void 0 ? "" : _b, locale = props.locale, rest = __rest83(props, ["groupKey", "locale"]);
  var _c = useFormGroup("".concat(groupKey).concat(locale)), isValid = _c.isValid, isTouched = _c.isTouched;
  var translate = useTranslate();
  return import_react86.default.createElement(StyledTab, __assign89({ id: "translatable-header-".concat(groupKey).concat(locale), label: translate("ra.locales.".concat(locale), {
    _: (0, import_inflection4.capitalize)(locale)
...
var PREFIX58 = "RaTranslatableInputsTab";
var TranslatableInputsTabClasses = {
  root: "".concat(PREFIX58, "-root"),
  error: "".concat(PREFIX58, "-error")
};
var StyledTab = styled_default(Tab_default, { name: PREFIX58 })(function(_a13) {
  var _b;
  var theme = _a13.theme;
...
var TranslatableInputsTabs = function(props) {
  ...
  return React137.createElement(
    ...
    React137.createElement(Tabs_default, __assign90({ value: selectedLocale, onChange: handleChange, indicatorColor: "primary", textColor: "primary", className: TranslatableInputsTabsClasses.tabs }, tabsProps), locales.map(function(locale) {
      return React137.createElement(TranslatableInputsTab, { key: locale, value: locale, locale, groupKey });
    }))
  );
};
var PREFIX59 = "RaTranslatableInputsTabs";
var TranslatableInputsTabsClasses = {
  root: "".concat(PREFIX59, "-root"),
  tabs: "".concat(PREFIX59, "-tabs")
};
var StyledAppBar2 = styled_default(AppBar_default, { name: PREFIX59 })(function(_a13) {
  var _b;
  var theme = _a13.theme;
...
var TranslatableInputsTabContent = function(props) {
  var children = props.children, _a13 = props.groupKey, groupKey = _a13 === void 0 ? "" : _a13, locale = props.locale, margin = props.margin, variant = props.variant, other = __rest84(props, ["children", "groupKey", "locale", "margin", "variant"]);
  ...
  return React138.createElement(
    ...
    React138.createElement(Root22, __assign91({ role: "tabpanel", hidden: selectedLocale !== locale, id: "translatable-content-".concat(groupKey).concat(locale), "aria-labelledby": "translatable-header-".concat(groupKey).concat(locale), className: TranslatableInputsTabContentClasses.root }, other), import_react87.Children.map(children, function(child) {
      return (0, import_react87.isValidElement)(child) ? (0, import_react87.cloneElement)(child, __assign91(__assign91({}, child.props), { label: getLabel(child.props.source, child.props.label), source: getSource(child.props.source, locale) })) : null;
    }))
  );
};
var PREFIX60 = "RaTranslatableInputsTabContent";
var TranslatableInputsTabContentClasses = {
  root: "".concat(PREFIX60, "-root")
};
var Root22 = styled_default("div", { name: PREFIX60 })(function(_a13) {
  var _b;
  var theme = _a13.theme;
...
var TranslatableInputs = function(props) {
  var className = props.className, defaultLocale = props.defaultLocale, locales = props.locales, _a13 = props.groupKey, groupKey = _a13 === void 0 ? "" : _a13, _b = props.selector, selector = _b === void 0 ? React139.createElement(TranslatableInputsTabs, { groupKey }) : _b, children = props.children, variant = props.variant, margin = props.margin;
  ...
  return React139.createElement(
    ...
    React139.createElement(
      ...
      locales.map(function(locale) {
        return React139.createElement(TranslatableInputsTabContent, { key: locale, locale, groupKey, variant, margin }, children);
      })
    )
  );
};
var PREFIX61 = "RaTranslatableInputs";
var Root23 = styled_default("div", {
  name: PREFIX61,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var LoginForm = function(props) {
  ...
  return React140.createElement(
    ...
    React140.createElement(
      ...
      React140.createElement(TextInput, { autoFocus: true, source: "username", label: translate("ra.auth.username"), autoComplete: "username", validate: required(), fullWidth: true }),
      React140.createElement(TextInput, { source: "password", label: translate("ra.auth.password"), type: "password", autoComplete: "current-password", validate: required(), fullWidth: true }),
      React140.createElement(Button_default, { variant: "contained", type: "submit", color: "primary", disabled: loading, fullWidth: true, className: LoginFormClasses.button }, loading ? React140.createElement(CircularProgress_default, { className: LoginFormClasses.icon, size: 19, thickness: 3 }) : translate("ra.auth.sign_in"))
    )
  );
};
var PREFIX62 = "RaLoginForm";
var LoginFormClasses = {
  content: "".concat(PREFIX62, "-content"),
  button: "".concat(PREFIX62, "-button"),
  icon: "".concat(PREFIX62, "-icon")
};
var StyledForm2 = styled_default(Form, {
  name: PREFIX62,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
LoginForm.propTypes = {
  redirectTo: import_prop_types76.default.string
};
...
var Login = function(props) {
  var children = props.children, backgroundImage = props.backgroundImage, rest = __rest85(props, ["children", "backgroundImage"]);
  var containerRef = (0, import_react88.useRef)();
  ...
  return React141.createElement(
    Root24,
    __assign92({}, rest, { ref: containerRef }),
    React141.createElement(
      ...
      React141.createElement(
        ...
        React141.createElement(
          ...
          React141.createElement(import_Lock2.default, null)
        )
      ),
      children
    )
...
var PREFIX63 = "RaLogin";
var LoginClasses = {
  card: "".concat(PREFIX63, "-card"),
  avatar: "".concat(PREFIX63, "-avatar"),
  icon: "".concat(PREFIX63, "-icon")
};
var Root24 = styled_default("div", {
  name: PREFIX63,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
Login.propTypes = {
  backgroundImage: import_prop_types77.default.string,
  children: import_prop_types77.default.node,
  className: import_prop_types77.default.string
};
Login.defaultProps = {
  children: React141.createElement(LoginForm, null)
};
...
var defaultLightTheme = __assign93(__assign93({ palette: {
  background: {
    default: "#fafafb"
  },
  secondary: {
...
} }, defaultThemeInvariants), { components: __assign93(__assign93({}, defaultThemeInvariants.components), { MuiFilledInput: {
  styleOverrides: {
    root: {
...
var defaultDarkTheme = __assign93({ palette: {
  mode: "dark",
  primary: {
    main: "#90caf9"
  },
...
var defaultTheme = defaultLightTheme;
...
var CreateView = function(props) {
  var _a13;
  var actions = props.actions, aside = props.aside, children = props.children, className = props.className, _b = props.component, Content = _b === void 0 ? Card_default : _b, title = props.title, rest = __rest86(props, ["actions", "aside", "children", "className", "component", "title"]);
  var _c = useCreateContext(props), resource = _c.resource, defaultTitle = _c.defaultTitle;
  return React142.createElement(
    Root25,
    __assign94({ className: clsx_m_default("create-page", className) }, sanitizeRestProps18(rest)),
    React142.createElement(Title, { title, defaultTitle, preferenceKey: "".concat(resource, ".create.title") }),
    actions,
    React142.createElement(
      "div",
      { className: clsx_m_default(CreateClasses.main, (_a13 = {}, _a13[CreateClasses.noActions] = !actions, _a13)) },
      React142.createElement(Content, { className: CreateClasses.card }, children),
      aside
    )
  );
};
CreateView.propTypes = {
  actions: import_prop_types78.default.oneOfType([import_prop_types78.default.element, import_prop_types78.default.bool]),
  aside: import_prop_types78.default.element,
  children: import_prop_types78.default.node,
  className: import_prop_types78.default.string,
  defaultTitle: import_prop_types78.default.any,
  hasList: import_prop_types78.default.bool,
  hasShow: import_prop_types78.default.bool,
  mutationOptions: import_prop_types78.default.object,
  record: import_prop_types78.default.object,
  redirect: import_prop_types78.default.oneOfType([
    import_prop_types78.default.string,
    import_prop_types78.default.bool,
    import_prop_types78.default.func
  ]),
  resource: import_prop_types78.default.string,
  save: import_prop_types78.default.func,
  title: import_prop_types78.default.node
};
var sanitizeRestProps18 = function(_a13) {
  var _b = _a13.addMiddleware, addMiddleware = _b === void 0 ? null : _b, _c = _a13.defaultTitle, defaultTitle = _c === void 0 ? null : _c, _d = _a13.hasCreate, hasCreate = _d === void 0 ? null : _d, _e = _a13.hasEdit, hasEdit = _e === void 0 ? null : _e, _f = _a13.hasList, hasList = _f === void 0 ? null : _f, _g = _a13.hasShow, hasShow = _g === void 0 ? null : _g, _h = _a13.history, history = _h === void 0 ? null : _h, _j = _a13.isFetching, isFetching = _j === void 0 ? null : _j, _k = _a13.isLoading, isLoading = _k === void 0 ? null : _k, _l = _a13.location, location = _l === void 0 ? null : _l, _m = _a13.match, match = _m === void 0 ? null : _m, _o = _a13.mutationOptions, mutationOptions = _o === void 0 ? null : _o, _p = _a13.options, options = _p === void 0 ? null : _p, _q = _a13.permissions, permissions = _q === void 0 ? null : _q, _r = _a13.save, save = _r === void 0 ? null : _r, _s = _a13.saving, saving = _s === void 0 ? null : _s, _t = _a13.transform, transform = _t === void 0 ? null : _t, _u = _a13.removeMiddleware, removeMiddleware = _u === void 0 ? null : _u, rest = __rest86(_a13, ["addMiddleware", "defaultTitle", "hasCreate", "hasEdit", "hasList", "hasShow", "history", "isFetching", "isLoading", "location", "match", "mutationOptions", "options", "permissions", "save", "saving", "transform", "removeMiddleware"]);
  return rest;
};
var PREFIX64 = "RaCreate";
var CreateClasses = {
  main: "".concat(PREFIX64, "-main"),
  noActions: "".concat(PREFIX64, "-noActions"),
  card: "".concat(PREFIX64, "-card")
};
var Root25 = styled_default("div", {
  name: PREFIX64,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var Create = function(props) {
  ...
  var resource = props.resource, record = props.record, redirect = props.redirect, transform = props.transform, mutationOptions = props.mutationOptions, disableAuthentication = props.disableAuthentication, hasEdit = props.hasEdit, hasShow = props.hasShow, rest = __rest87(props, ["resource", "record", "redirect", "transform", "mutationOptions", "disableAuthentication", "hasEdit", "hasShow"]);
  return React143.createElement(
    CreateBase,
    { resource, record, redirect, transform, mutationOptions, disableAuthentication, hasEdit, hasShow },
    React143.createElement(CreateView, __assign95({}, rest))
  );
};
Create.propTypes = {
  actions: import_prop_types79.default.oneOfType([import_prop_types79.default.element, import_prop_types79.default.bool]),
  aside: import_prop_types79.default.element,
  children: import_prop_types79.default.node,
  className: import_prop_types79.default.string,
  disableAuthentication: import_prop_types79.default.bool,
  hasEdit: import_prop_types79.default.bool,
  hasShow: import_prop_types79.default.bool,
  redirect: import_prop_types79.default.oneOfType([
    import_prop_types79.default.string,
    import_prop_types79.default.bool,
    import_prop_types79.default.func
  ]),
  resource: import_prop_types79.default.string,
  title: import_prop_types79.default.node,
  record: import_prop_types79.default.object,
  mutationOptions: import_prop_types79.default.object,
  transform: import_prop_types79.default.func,
  sx: import_prop_types79.default.any
};
...
var CreateActions = function(_a13) {
  var className = _a13.className, rest = __rest88(_a13, ["className"]);
  var hasList = useResourceDefinition(rest).hasList;
  return React144.createElement(TopToolbar_default, __assign96({ className }, sanitizeRestProps19(rest)), hasList && React144.createElement(ListButton, null));
};
var sanitizeRestProps19 = function(_a13) {
  var _b = _a13.className, className = _b === void 0 ? null : _b, _c = _a13.hasList, hasList = _c === void 0 ? null : _c, _d = _a13.resource, resource = _d === void 0 ? null : _d, rest = __rest88(_a13, ["className", "hasList", "resource"]);
  return rest;
};
CreateActions.propTypes = {
  className: import_prop_types80.default.string,
  hasCreate: import_prop_types80.default.bool,
  hasEdit: import_prop_types80.default.bool,
  hasShow: import_prop_types80.default.bool,
  hasList: import_prop_types80.default.bool,
  resource: import_prop_types80.default.string
};
...
var EditActions = function(_a13) {
  var className = _a13.className, rest = __rest89(_a13, ["className"]);
  var record = useEditContext(rest).record;
  var hasShow = useResourceDefinition(rest).hasShow;
  return React145.createElement(TopToolbar_default, __assign97({ className }, sanitizeRestProps20(rest)), hasShow && React145.createElement(ShowButton_default, { record }));
};
var sanitizeRestProps20 = function(_a13) {
  var _b = _a13.hasCreate, hasCreate = _b === void 0 ? null : _b, _c = _a13.hasEdit, hasEdit = _c === void 0 ? null : _c, _d = _a13.hasShow, hasShow = _d === void 0 ? null : _d, _e = _a13.hasList, hasList = _e === void 0 ? null : _e, rest = __rest89(_a13, ["hasCreate", "hasEdit", "hasShow", "hasList"]);
  return rest;
};
EditActions.propTypes = {
  className: import_prop_types81.default.string,
  data: import_prop_types81.default.object,
  hasCreate: import_prop_types81.default.bool,
  hasEdit: import_prop_types81.default.bool,
  hasShow: import_prop_types81.default.bool,
  hasList: import_prop_types81.default.bool,
  resource: import_prop_types81.default.string
};
...
var EditView = function(props) {
  var _a13;
  var actions = props.actions, aside = props.aside, children = props.children, className = props.className, _b = props.component, Content = _b === void 0 ? Card_default : _b, title = props.title, mutationMode = props.mutationMode, rest = __rest90(props, ["actions", "aside", "children", "className", "component", "title", "mutationMode"]);
  ...
  var finalActions = typeof actions === "undefined" && hasShow ? React146.createElement(EditActions, null) : actions;
  if (!children) {
    return null;
  }
  return React146.createElement(
    Root26,
    __assign98({ className: clsx_m_default("edit-page", className) }, sanitizeRestProps21(rest)),
    React146.createElement(Title, { title, defaultTitle, preferenceKey: "".concat(resource, ".edit.title") }),
    finalActions,
    React146.createElement(
      "div",
      { className: clsx_m_default(EditClasses.main, (_a13 = {}, _a13[EditClasses.noActions] = !finalActions, _a13)) },
      React146.createElement(Content, { className: EditClasses.card }, record ? children : React146.createElement(CardContent_default, null, " ")),
      aside
    )
  );
};
EditView.propTypes = {
  actions: import_prop_types82.default.oneOfType([import_prop_types82.default.element, import_prop_types82.default.bool]),
  aside: import_prop_types82.default.element,
  ...
  defaultTitle: import_prop_types82.default.any,
  hasList: import_prop_types82.default.bool,
  hasShow: import_prop_types82.default.bool,
  mutationMode: import_prop_types82.default.oneOf(["pessimistic", "optimistic", "undoable"]),
  mutationOptions: import_prop_types82.default.object,
  record: import_prop_types82.default.object,
  redirect: import_prop_types82.default.oneOfType([
    import_prop_types82.default.string,
    import_prop_types82.default.bool,
    import_prop_types82.default.func
  ]),
  resource: import_prop_types82.default.string,
  save: import_prop_types82.default.func,
  title: import_prop_types82.default.node
};
var sanitizeRestProps21 = function(_a13) {
  var _b = _a13.addMiddleware, addMiddleware = _b === void 0 ? null : _b, _c = _a13.defaultTitle, defaultTitle = _c === void 0 ? null : _c, _d = _a13.hasCreate, hasCreate = _d === void 0 ? null : _d, _e = _a13.hasEdit, hasEdit = _e === void 0 ? null : _e, _f = _a13.hasList, hasList = _f === void 0 ? null : _f, _g = _a13.hasShow, hasShow = _g === void 0 ? null : _g, _h = _a13.history, history = _h === void 0 ? null : _h, _j = _a13.id, id = _j === void 0 ? null : _j, _k = _a13.isFetching, isFetching = _k === void 0 ? null : _k, _l = _a13.isLoading, isLoading = _l === void 0 ? null : _l, _m = _a13.location, location = _m === void 0 ? null : _m, _o = _a13.match, match = _o === void 0 ? null : _o, _p = _a13.options, options = _p === void 0 ? null : _p, _q = _a13.queryOptions, queryOptions = _q === void 0 ? null : _q, _r = _a13.mutationOptions, mutationOptions = _r === void 0 ? null : _r, _s = _a13.permissions, permissions = _s === void 0 ? null : _s, _t = _a13.refetch, refetch = _t === void 0 ? null : _t, _u = _a13.removeMiddleware, removeMiddleware = _u === void 0 ? null : _u, _v = _a13.resource, resource = _v === void 0 ? null : _v, _w = _a13.save, save = _w === void 0 ? null : _w, _x = _a13.saving, saving = _x === void 0 ? null : _x, _y = _a13.transform, transform = _y === void 0 ? null : _y, rest = __rest90(_a13, ["addMiddleware", "defaultTitle", "hasCreate", "hasEdit", "hasList", "hasShow", "history", "id", "isFetching", "isLoading", "location", "match", "options", "queryOptions", "mutationOptions", "permissions", "refetch", "removeMiddleware", "resource", "save", "saving", "transform"]);
  return rest;
};
var PREFIX65 = "RaEdit";
var EditClasses = {
  main: "".concat(PREFIX65, "-main"),
  noActions: "".concat(PREFIX65, "-noActions"),
  card: "".concat(PREFIX65, "-card")
};
var Root26 = styled_default("div", {
  name: PREFIX65,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var Edit = function(props) {
  ...
  var resource = props.resource, id = props.id, mutationMode = props.mutationMode, mutationOptions = props.mutationOptions, queryOptions = props.queryOptions, redirect = props.redirect, transform = props.transform, disableAuthentication = props.disableAuthentication, rest = __rest91(props, ["resource", "id", "mutationMode", "mutationOptions", "queryOptions", "redirect", "transform", "disableAuthentication"]);
  return React147.createElement(
    ...
    React147.createElement(EditView, __assign99({}, rest))
  );
};
Edit.propTypes = {
  actions: import_prop_types83.default.oneOfType([import_prop_types83.default.element, import_prop_types83.default.bool]),
  aside: import_prop_types83.default.element,
  children: import_prop_types83.default.node,
  className: import_prop_types83.default.string,
  disableAuthentication: import_prop_types83.default.bool,
  hasCreate: import_prop_types83.default.bool,
  hasEdit: import_prop_types83.default.bool,
  hasShow: import_prop_types83.default.bool,
  hasList: import_prop_types83.default.bool,
  id: import_prop_types83.default.any,
  mutationMode: import_prop_types83.default.oneOf(["pessimistic", "optimistic", "undoable"]),
  mutationOptions: import_prop_types83.default.object,
  queryOptions: import_prop_types83.default.object,
  redirect: import_prop_types83.default.oneOfType([
    import_prop_types83.default.string,
    import_prop_types83.default.bool,
    import_prop_types83.default.func
  ]),
  resource: import_prop_types83.default.string,
  title: import_prop_types83.default.node,
  transform: import_prop_types83.default.func,
  sx: import_prop_types83.default.any
};
...
var Toolbar = function(props) {
  var _a13;
  var children = props.children, className = props.className, resource = props.resource, rest = __rest92(props, ["children", "className", "resource"]);
  var isXs = useMediaQuery(function(theme) {
    return theme.breakpoints.down("sm");
  });
  return React148.createElement(StyledToolbar2, __assign100({ className: clsx_m_default((_a13 = {}, _a13[ToolbarClasses.mobileToolbar] = isXs, _a13[ToolbarClasses.desktopToolbar] = !isXs, _a13), className), role: "toolbar" }, rest), import_react89.Children.count(children) === 0 ? React148.createElement(
    "div",
    { className: ToolbarClasses.defaultToolbar },
    React148.createElement(SaveButton, null),
    React148.createElement(DeleteButton, { resource })
  ) : children);
};
Toolbar.propTypes = {
  children: import_prop_types84.default.node,
  className: import_prop_types84.default.string,
  resource: import_prop_types84.default.string
};
var PREFIX66 = "RaToolbar";
var ToolbarClasses = {
  desktopToolbar: "".concat(PREFIX66, "-desktopToolbar"),
  mobileToolbar: "".concat(PREFIX66, "-mobileToolbar"),
  defaultToolbar: "".concat(PREFIX66, "-defaultToolbar")
};
var StyledToolbar2 = styled_default(Toolbar_default, {
  name: PREFIX66,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var TabbedFormTabs = function(props) {
  var children = props.children, url = props.url, syncWithLocation = props.syncWithLocation, value = props.value, rest = __rest93(props, ["children", "url", "syncWithLocation", "value"]);
  var params = useParams();
  var tabValue = params["*"];
  return React149.createElement(Tabs_default, __assign101({ value: syncWithLocation ? tabValue : value, indicatorColor: "primary" }, rest), import_react90.Children.map(children, function(tab, index) {
    if (!(0, import_react90.isValidElement)(tab))
      return null;
    var tabPath = getTabbedFormTabFullPath(tab, index);
    return (0, import_react90.cloneElement)(tab, {
      intent: "header",
...
TabbedFormTabs.propTypes = {
  ...
  url: import_prop_types85.default.string,
  tabsWithErrors: import_prop_types85.default.arrayOf(import_prop_types85.default.string)
};
...
var TabbedFormView = function(props) {
  var children = props.children, className = props.className, _a13 = props.component, Component2 = _a13 === void 0 ? DefaultComponent : _a13, formRootPathname = props.formRootPathname, _b = props.syncWithLocation, syncWithLocation = _b === void 0 ? true : _b, _c = props.tabs, tabs = _c === void 0 ? DefaultTabs : _c, _d = props.toolbar, toolbar = _d === void 0 ? DefaultToolbar2 : _d, rest = __rest94(props, ["children", "className", "component", "formRootPathname", "syncWithLocation", "tabs", "toolbar"]);
  var location = useLocation();
  var resolvedPath = useResolvedPath("");
  var resource = useResourceContext(props);
  var _e = (0, import_react91.useState)(0), tabValue = _e[0], setTabValue = _e[1];
  ...
  var renderTabHeaders = function() {
    return (0, import_react91.cloneElement)(tabs, {
  ...
  return React150.createElement(
    Root27,
    __assign102({ className: clsx_m_default("tabbed-form", className) }, sanitizeRestProps22(rest)),
    syncWithLocation ? React150.createElement(
      Routes,
      null,
      React150.createElement(Route, { path: "/*", element: renderTabHeaders() })
    ) : renderTabHeaders(),
    React150.createElement(Divider_default, null),
    React150.createElement(Component2, null, import_react91.Children.map(children, function(tab, index) {
      if (!tab) {
        return null;
      }
      var tabPath = getTabbedFormTabFullPath(tab, index);
      var hidden = syncWithLocation ? !matchPath("".concat(resolvedPath.pathname, "/").concat(tabPath), location.pathname) : tabValue !== index;
      return (0, import_react91.isValidElement)(tab) ? React150.cloneElement(tab, {
        intent: "content",
        resource,
        hidden,
        value: syncWithLocation ? tabPath : index
...
TabbedFormView.propTypes = {
  ...
  location: import_prop_types86.default.object,
  match: import_prop_types86.default.object,
  // @ts-ignore
  resource: import_prop_types86.default.string,
  tabs: import_prop_types86.default.element,
  toolbar: import_prop_types86.default.oneOfType([import_prop_types86.default.element, import_prop_types86.default.oneOf([false])]),
  validate: import_prop_types86.default.func,
  value: import_prop_types86.default.number
};
var DefaultTabs = React150.createElement(TabbedFormTabs, null);
var DefaultComponent = function(_a13) {
  var children = _a13.children;
  return React150.createElement(CardContent_default, null, children);
};
var DefaultToolbar2 = React150.createElement(Toolbar, null);
var PREFIX67 = "RaTabbedForm";
var TabbedFormClasses = {
  errorTabButton: "".concat(PREFIX67, "-errorTabButton")
};
var Root27 = styled_default("div", {
  name: PREFIX67,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var sanitizeRestProps22 = function(_a13) {
  var record = _a13.record, resource = _a13.resource, rest = __rest94(_a13, ["record", "resource"]);
  return rest;
};
...
var FormTabHeader = function(_a13) {
  var _b;
  var count = _a13.count, label = _a13.label, value = _a13.value, icon = _a13.icon, className = _a13.className, onChange = _a13.onChange, syncWithLocation = _a13.syncWithLocation, rest = __rest95(_a13, ["count", "label", "value", "icon", "className", "onChange", "syncWithLocation"]);
  var translate = useTranslate();
  var location = useLocation();
  ...
  var propsForLink = {
    component: Link,
    to: __assign103(__assign103({}, location), { pathname: value })
  };
  var tabLabel = (0, import_react_is4.isElement)(label) ? label : translate(label, { _: label });
  if (count !== void 0) {
    tabLabel = React151.createElement(
      "span",
      null,
      tabLabel,
      " (",
  ...
  return React151.createElement(Tab_default, __assign103({ label: tabLabel, value, icon, className: clsx_m_default("form-tab", className, (_b = {}, _b[TabbedFormClasses.errorTabButton] = !formGroup.isValid && (formGroup.isTouched || isSubmitted), _b.error = !formGroup.isValid && (formGroup.isTouched || isSubmitted), _b)) }, syncWithLocation ? propsForLink : {}, { id: "tabheader-".concat(value), "aria-controls": "tabpanel-".concat(value), onChange }, rest));
};
FormTabHeader.propTypes = {
  className: import_prop_types87.default.string,
  contentClassName: import_prop_types87.default.string,
  count: import_prop_types87.default.node,
  children: import_prop_types87.default.node,
  intent: import_prop_types87.default.oneOf(["header", "content"]),
  hidden: import_prop_types87.default.bool,
  icon: import_prop_types87.default.element,
  label: import_prop_types87.default.oneOfType([import_prop_types87.default.string, import_prop_types87.default.element]).isRequired,
  margin: import_prop_types87.default.oneOf(["none", "dense", "normal"]),
  path: import_prop_types87.default.string,
  // @ts-ignore
  record: import_prop_types87.default.object,
  resource: import_prop_types87.default.string,
  value: import_prop_types87.default.oneOfType([import_prop_types87.default.string, import_prop_types87.default.number]),
...
var FormTab = function(props) {
  var children = props.children, className = props.className, contentClassName = props.contentClassName, count = props.count, hidden = props.hidden, icon = props.icon, intent = props.intent, label = props.label, onChange = props.onChange, path = props.path, resource = props.resource, syncWithLocation = props.syncWithLocation, value = props.value, rest = __rest96(props, ["children", "className", "contentClassName", "count", "hidden", "icon", "intent", "label", "onChange", "path", "resource", "syncWithLocation", "value"]);
  var renderHeader = function() {
    return React152.createElement(FormTabHeader, __assign104({ label, count, value, icon, className, syncWithLocation, onChange }, sanitizeRestProps23(rest)));
  };
  var renderContent = function() {
    return React152.createElement(
      FormGroupContextProvider,
      { name: value.toString() },
      React152.createElement(Stack_default, __assign104({ alignItems: "flex-start", style: hidden ? hiddenStyle : null, className: contentClassName, id: "tabpanel-".concat(value), "aria-labelledby": "tabheader-".concat(value), "aria-hidden": hidden || void 0 }, rest), children)
    );
  };
...
FormTab.propTypes = {
  ...
  contentClassName: import_prop_types88.default.string,
  children: import_prop_types88.default.node,
  count: import_prop_types88.default.node,
  intent: import_prop_types88.default.oneOf(["header", "content"]),
  hidden: import_prop_types88.default.bool,
  icon: import_prop_types88.default.element,
  label: import_prop_types88.default.oneOfType([import_prop_types88.default.string, import_prop_types88.default.element]).isRequired,
  path: import_prop_types88.default.string,
  // @ts-ignore
  resource: import_prop_types88.default.string,
  value: import_prop_types88.default.oneOfType([import_prop_types88.default.string, import_prop_types88.default.number])
};
FormTab.displayName = "FormTab";
var hiddenStyle = { display: "none" };
var sanitizeRestProps23 = function(_a13) {
  var classes = _a13.classes, ref = _a13.ref, margin = _a13.margin, rest = __rest96(_a13, ["classes", "ref", "margin"]);
  return rest;
};
...
var findTabsWithErrors = function(children, errors) {
  ...
  return import_react92.Children.toArray(children).reduce(function(acc, child) {
    if (!(0, import_react92.isValidElement)(child)) {
      return acc;
    }
    var inputs = import_react92.Children.toArray(child.props.children);
    if (inputs.some(function(input) {
      return (0, import_react92.isValidElement)(input) && (0, import_get9.default)(errors, input.props.source);
    })) {
...
var SimpleForm = function(props) {
  var children = props.children, className = props.className, _a13 = props.component, Component2 = _a13 === void 0 ? DefaultComponent2 : _a13, sx = props.sx, _b = props.toolbar, toolbar = _b === void 0 ? DefaultToolbar3 : _b, rest = __rest98(props, ["children", "className", "component", "sx", "toolbar"]);
  return React154.createElement(
    ...
    React154.createElement(
      Component2,
      { className, sx },
      React154.createElement(Stack_default, __assign106({ alignItems: "flex-start" }, sanitizeRestProps25(props)), children)
    ),
    toolbar !== false ? toolbar : null
  );
};
SimpleForm.propTypes = {
  ...
  defaultValues: import_prop_types90.default.oneOfType([import_prop_types90.default.object, import_prop_types90.default.func]),
  // @ts-ignore
  record: import_prop_types90.default.object,
  toolbar: import_prop_types90.default.oneOfType([import_prop_types90.default.element, import_prop_types90.default.oneOf([false])]),
  validate: import_prop_types90.default.func
};
var PREFIX68 = "RaSimpleForm";
var DefaultComponent2 = styled_default(CardContent_default, {
  name: PREFIX68,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var SimpleFormEditor = function() {
  ...
  return React155.createElement(FieldsSelector, { name: "inputs", availableName: "availableInputs" });
};
...
var SimpleFormConfigurable = function(_a13) {
  var preferenceKey = _a13.preferenceKey, omit = _a13.omit, props = __rest99(_a13, ["preferenceKey", "omit"]);
  var translate = useTranslate();
  var resource = useResourceContext(props);
  ...
  React156.useEffect(function() {
    var inputs = React156.Children.map(props.children, function(child, index) {
  ...
  return React156.createElement(
    Configurable,
    { editor: React156.createElement(SimpleFormEditor, null), preferenceKey: finalPreferenceKey, sx: {
      display: "block",
      "&.RaConfigurable-editMode": {
        margin: "2px"
      }
    } },
    React156.createElement(SimpleFormWithPreferences, __assign107({}, props))
  );
};
var SimpleFormWithPreferences = function(_a13) {
  var children = _a13.children, props = __rest99(_a13, ["children"]);
  ...
  var childrenArray = React156.Children.toArray(children);
  return React156.createElement(SimpleForm, __assign107({}, props), inputs === void 0 ? children : inputs.map(function(index) {
    return childrenArray[index];
  }));
};
...
var editFieldTypes = {
  ...
  array: {
    ...
    component: function(_a13) {
      var children = _a13.children, props = __rest100(_a13, ["children"]);
      return React157.createElement(
        ArrayInput,
        __assign108({}, props),
        React157.createElement(SimpleFormIterator, null, children)
      );
    },
  ...
  referenceArrayChild: {
    component: function(props) {
      return React157.createElement(SelectInput, __assign108({ optionText: "id" }, props));
    },
...
var EditGuesser = function(props) {
  var resource = props.resource, id = props.id, mutationMode = props.mutationMode, mutationOptions = props.mutationOptions, queryOptions = props.queryOptions, redirect = props.redirect, transform = props.transform, disableAuthentication = props.disableAuthentication, rest = __rest101(props, ["resource", "id", "mutationMode", "mutationOptions", "queryOptions", "redirect", "transform", "disableAuthentication"]);
  return React158.createElement(
    EditBase,
    { resource, id, mutationMode, mutationOptions, queryOptions, redirect, transform, disableAuthentication },
    React158.createElement(EditViewGuesser, __assign109({}, rest))
  );
};
var EditViewGuesser = function(props) {
  var resource = useResourceContext(props);
  var record = useEditContext().record;
  var _a13 = (0, import_react93.useState)(null), child = _a13[0], setChild = _a13[1];
  ...
  (0, import_react93.useEffect)(function() {
    if (record && !child) {
      ...
      console.log("Guessed Edit:\n\nimport { ".concat(components.join(", "), " } from 'react-admin';\n\nexport const ").concat(import_inflection5.default.capitalize(import_inflection5.default.singularize(resource)), "Edit = () => (\n    <Edit>\n").concat(representation, "\n    </Edit>\n);"));
    }
  }, [record, child, resource]);
  return React158.createElement(EditView, __assign109({}, props), child);
};
...
var ShowActions = function(props) {
  ...
  return React159.createElement(
    ...
    React159.createElement(EditButton, { record })
  );
};
ShowActions.propTypes = {
  className: import_prop_types91.default.string,
  record: import_prop_types91.default.any
};
...
var _a8;
var defaultActions = React160.createElement(ShowActions, null);
var ShowView = function(props) {
  var _a13;
  var actions = props.actions, aside = props.aside, children = props.children, className = props.className, _b = props.component, Content = _b === void 0 ? Card_default : _b, _c = props.emptyWhileLoading, emptyWhileLoading = _c === void 0 ? false : _c, title = props.title, rest = __rest102(props, ["actions", "aside", "children", "className", "component", "emptyWhileLoading", "title"]);
  ...
  return React160.createElement(
    Root28,
    __assign110({ className: clsx_m_default("show-page", className) }, sanitizeRestProps26(rest)),
    React160.createElement(Title, { title, defaultTitle, preferenceKey: "".concat(resource, ".show.title") }),
...
var Show = function(_a13) {
  var id = _a13.id, resource = _a13.resource, queryOptions = _a13.queryOptions, disableAuthentication = _a13.disableAuthentication, rest = __rest103(_a13, ["id", "resource", "queryOptions", "disableAuthentication"]);
  return React161.createElement(
    ShowBase,
    { id, disableAuthentication, queryOptions, resource },
    React161.createElement(ShowView, __assign111({}, rest))
  );
};
Show.propTypes = {
  actions: import_prop_types93.default.oneOfType([import_prop_types93.default.element, import_prop_types93.default.bool]),
  children: import_prop_types93.default.node.isRequired,
  className: import_prop_types93.default.string,
  disableAuthentication: import_prop_types93.default.bool,
  emptyWhileLoading: import_prop_types93.default.bool,
  component: import_prop_types93.default.elementType,
  resource: import_prop_types93.default.string,
  title: import_prop_types93.default.node,
  sx: import_prop_types93.default.any
};
...
var fieldPropTypes = {
  sortBy: import_prop_types94.default.string,
  sortByOrder: import_prop_types94.default.oneOf(["ASC", "DESC"]),
  source: import_prop_types94.default.string,
  label: import_prop_types94.default.oneOfType([
    import_prop_types94.default.string,
    import_prop_types94.default.element,
    import_prop_types94.default.bool
  ]),
  sortable: import_prop_types94.default.bool,
  className: import_prop_types94.default.string,
  cellClassName: import_prop_types94.default.string,
  headerClassName: import_prop_types94.default.string,
  textAlign: import_prop_types94.default.oneOf([
    "inherit",
    "left",
    "center",
    "right",
  ...
  emptyText: import_prop_types94.default.string
};
...
var genericMemo = function(component) {
  var _a13;
  var result = (0, import_react94.memo)(component);
...
var ArrayFieldImpl = function(props) {
  ...
  return React162.createElement(ListContextProvider, { value: listContext }, children);
};
ArrayFieldImpl.propTypes = __assign112({}, fieldPropTypes);
...
var BooleanFieldImpl = function(props) {
  var className = props.className, emptyText = props.emptyText, source = props.source, valueLabelTrue = props.valueLabelTrue, valueLabelFalse = props.valueLabelFalse, _a13 = props.TrueIcon, TrueIcon = _a13 === void 0 ? import_Done.default : _a13, _b = props.FalseIcon, FalseIcon = _b === void 0 ? import_Clear2.default : _b, _c = props.looseValue, looseValue = _c === void 0 ? false : _c, rest = __rest105(props, ["className", "emptyText", "source", "valueLabelTrue", "valueLabelFalse", "TrueIcon", "FalseIcon", "looseValue"]);
  var record = useRecordContext(props);
  var translate = useTranslate();
  ...
  if (looseValue || value === false || value === true) {
    return React163.createElement(
      StyledTypography,
      __assign113({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)),
      React163.createElement(Tooltip_default, { title: translate(ariaLabel, { _: ariaLabel }) }, isTruthyValue ? TrueIcon ? React163.createElement(TrueIcon, { "data-testid": "true", fontSize: "small" }) : React163.createElement(React163.Fragment, null) : FalseIcon ? React163.createElement(FalseIcon, { "data-testid": "false", fontSize: "small" }) : React163.createElement(React163.Fragment, null))
    );
  }
  return React163.createElement(Typography_default, __assign113({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText }));
};
BooleanFieldImpl.propTypes = __assign113(__assign113(__assign113({}, Typography_default.propTypes), fieldPropTypes), { valueLabelFalse: import_prop_types95.default.string, valueLabelTrue: import_prop_types95.default.string, TrueIcon: import_prop_types95.default.elementType, FalseIcon: import_prop_types95.default.elementType, looseValue: import_prop_types95.default.bool });
BooleanFieldImpl.displayName = "BooleanFieldImpl";
var BooleanField = genericMemo(BooleanFieldImpl);
var PREFIX70 = "RaBooleanField";
var StyledTypography = styled_default(Typography_default, {
  name: PREFIX70,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ChipFieldImpl = function(props) {
  var className = props.className, source = props.source, emptyText = props.emptyText, rest = __rest106(props, ["className", "source", "emptyText"]);
  var record = useRecordContext(props);
  var value = (0, import_get12.default)(record, source);
  var translate = useTranslate();
  if (value == null && emptyText) {
    return React164.createElement(Typography_default, __assign114({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText }));
  }
  return React164.createElement(StyledChip, __assign114({ className: clsx_m_default(ChipFieldClasses.chip, className), label: value }, sanitizeFieldRestProps(rest)));
};
ChipFieldImpl.propTypes = __assign114(__assign114({}, Chip_default.propTypes), fieldPropTypes);
ChipFieldImpl.displayName = "ChipFieldImpl";
var ChipField = genericMemo(ChipFieldImpl);
var PREFIX71 = "RaChipField";
var ChipFieldClasses = {
  chip: "".concat(PREFIX71, "-chip")
};
...
})((_a9 = {}, _a9["&.".concat(ChipFieldClasses.chip)] = { margin: 4, cursor: "inherit" }, _a9));
...
var DateFieldImpl = function(props) {
  var className = props.className, emptyText = props.emptyText, locales = props.locales, options = props.options, _a13 = props.showTime, showTime = _a13 === void 0 ? false : _a13, _b = props.showDate, showDate = _b === void 0 ? true : _b, source = props.source, rest = __rest107(props, ["className", "emptyText", "locales", "options", "showTime", "showDate", "source"]);
  var translate = useTranslate();
  ...
  if (value == null || value === "") {
    return emptyText ? React165.createElement(Typography_default, __assign115({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  var date = value instanceof Date ? value : typeof value === "string" || typeof value === "number" ? new Date(value) : void 0;
  ...
  return React165.createElement(Typography_default, __assign115({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), dateString);
};
DateFieldImpl.propTypes = __assign115(__assign115(__assign115({}, Typography_default.propTypes), fieldPropTypes), { locales: import_prop_types96.default.oneOfType([
  import_prop_types96.default.string,
  import_prop_types96.default.arrayOf(import_prop_types96.default.string)
]), options: import_prop_types96.default.object, showTime: import_prop_types96.default.bool, showDate: import_prop_types96.default.bool });
...
var EmailFieldImpl = function(props) {
  var className = props.className, source = props.source, emptyText = props.emptyText, rest = __rest108(props, ["className", "source", "emptyText"]);
  var record = useRecordContext(props);
  var value = (0, import_get14.default)(record, source);
  var translate = useTranslate();
  if (value == null) {
    return emptyText ? React166.createElement(Typography_default, __assign116({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  return React166.createElement(Link_default, __assign116({ className, href: "mailto:".concat(value), onClick: stopPropagation4, variant: "body2" }, sanitizeFieldRestProps(rest)), value);
};
...
var FileField = function(props) {
  var _a13;
  var className = props.className, emptyText = props.emptyText, source = props.source, title = props.title, src = props.src, target = props.target, download = props.download, ping = props.ping, rel = props.rel, rest = __rest109(props, ["className", "emptyText", "source", "title", "src", "target", "download", "ping", "rel"]);
  var record = useRecordContext(props);
  var sourceValue = (0, import_get15.default)(record, source);
  var translate = useTranslate();
  if (!sourceValue) {
    return emptyText ? React167.createElement(Typography_default, __assign117({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : React167.createElement(Root29, __assign117({ className }, sanitizeFieldRestProps(rest)));
  }
  if (Array.isArray(sourceValue)) {
    return React167.createElement(StyledList, __assign117({ className }, sanitizeFieldRestProps(rest)), sourceValue.map(function(file, index) {
      ...
      return React167.createElement(
        "li",
        { key: index },
        React167.createElement(Link_default, { href: srcValue, title: fileTitleValue, target, download, ping, rel, variant: "body2" }, fileTitleValue)
      );
    }));
  }
  ...
  return React167.createElement(
    Root29,
    __assign117({ className }, sanitizeFieldRestProps(rest)),
    React167.createElement(Link_default, { href: sourceValue === null || sourceValue === void 0 ? void 0 : sourceValue.toString(), title: titleValue, target, download, ping, rel, variant: "body2" }, titleValue)
  );
};
FileField.propTypes = __assign117(__assign117({}, fieldPropTypes), { src: import_prop_types97.default.string, title: import_prop_types97.default.string, target: import_prop_types97.default.string, download: import_prop_types97.default.oneOfType([import_prop_types97.default.bool, import_prop_types97.default.string]), ping: import_prop_types97.default.string, rel: import_prop_types97.default.string });
var PREFIX72 = "RaFileField";
var Root29 = styled_default("div", {
  name: PREFIX72,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var FunctionField = function(props) {
  var className = props.className, _a13 = props.source, source = _a13 === void 0 ? "" : _a13, render = props.render, rest = __rest110(props, ["className", "source", "render"]);
  var record = useRecordContext(props);
  return (0, import_react95.useMemo)(function() {
    return record ? React168.createElement(Typography_default, __assign118({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), render(record, source)) : null;
  }, [className, record, source, render, rest]);
};
FunctionField.propTypes = __assign118(__assign118(__assign118({}, Typography_default.propTypes), fieldPropTypes), { render: import_prop_types98.default.func.isRequired });
...
var ImageField = function(props) {
  var _a13;
  var className = props.className, emptyText = props.emptyText, source = props.source, src = props.src, title = props.title, rest = __rest111(props, ["className", "emptyText", "source", "src", "title"]);
  var record = useRecordContext(props);
  var sourceValue = (0, import_get16.default)(record, source);
  var translate = useTranslate();
  if (!sourceValue) {
    return emptyText ? React169.createElement(Typography_default, __assign119({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : React169.createElement(Typography_default, __assign119({ component: "div", className }, sanitizeFieldRestProps(rest)));
  }
  if (Array.isArray(sourceValue)) {
    return React169.createElement(
      Root30,
      __assign119({ className }, sanitizeFieldRestProps(rest)),
      React169.createElement("ul", { className: ImageFieldClasses.list }, sourceValue.map(function(file, index) {
        var fileTitleValue = (0, import_get16.default)(file, title) || title;
        var srcValue = (0, import_get16.default)(file, src) || title;
        return React169.createElement(
          "li",
          { key: index },
          React169.createElement("img", { alt: fileTitleValue, title: fileTitleValue, src: srcValue, className: ImageFieldClasses.image })
        );
      }))
    );
  }
  ...
  return React169.createElement(
    Root30,
    __assign119({ className }, sanitizeFieldRestProps(rest)),
    React169.createElement("img", { title: titleValue, alt: titleValue, src: sourceValue === null || sourceValue === void 0 ? void 0 : sourceValue.toString(), className: ImageFieldClasses.image })
  );
};
ImageField.displayName = "ImageField";
ImageField.propTypes = __assign119(__assign119({}, fieldPropTypes), { src: import_prop_types99.default.string, title: import_prop_types99.default.string });
var PREFIX73 = "RaImageField";
var ImageFieldClasses = {
  list: "".concat(PREFIX73, "-list"),
  image: "".concat(PREFIX73, "-image")
};
var Root30 = styled_default(Box_default, {
  name: PREFIX73,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
})((_a10 = {}, _a10["& .".concat(ImageFieldClasses.list)] = {
  display: "flex",
  listStyleType: "none"
}, _a10["& .".concat(ImageFieldClasses.image)] = {
  margin: "0.25rem",
  width: 200,
  height: 100,
  objectFit: "contain"
...
var NumberFieldImpl = function(props) {
  var className = props.className, emptyText = props.emptyText, source = props.source, locales = props.locales, options = props.options, textAlign = props.textAlign, rest = __rest112(props, ["className", "emptyText", "source", "locales", "options", "textAlign"]);
  var record = useRecordContext(props);
  var translate = useTranslate();
  if (!record) {
    return null;
  ...
  if (value == null) {
    return emptyText ? React170.createElement(Typography_default, __assign120({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  return React170.createElement(Typography_default, __assign120({ variant: "body2", component: "span", className }, sanitizeFieldRestProps(rest)), hasNumberFormat && typeof value === "number" ? value.toLocaleString(locales, options) : value);
};
NumberFieldImpl.propTypes = __assign120(__assign120(__assign120({}, Typography_default.propTypes), fieldPropTypes), { locales: import_prop_types100.default.oneOfType([
  import_prop_types100.default.string,
  import_prop_types100.default.arrayOf(import_prop_types100.default.string)
]), options: import_prop_types100.default.object });
...
var Link2 = function(props) {
  var to = props.to, children = props.children, className = props.className, rest = __rest113(props, ["to", "children", "className"]);
  return React171.createElement(StyledMuiLink, __assign121({ component: Link, to, className: clsx_m_default(LinkClasses.link, className), underline: "none" }, rest), children);
};
var PREFIX74 = "RaLink";
var LinkClasses = {
  link: "".concat(PREFIX74, "-link")
};
var StyledMuiLink = styled_default(Link_default)({});
Link2.propTypes = {
  className: import_prop_types101.default.string,
  children: import_prop_types101.default.node,
  to: import_prop_types101.default.oneOfType([import_prop_types101.default.string, import_prop_types101.default.object])
};
...
var SingleFieldList = function(props) {
  var className = props.className, children = props.children, _a13 = props.linkType, linkType = _a13 === void 0 ? "edit" : _a13, _b = props.component, Component2 = _b === void 0 ? Root31 : _b, rest = __rest114(props, ["className", "children", "linkType", "component"]);
  var _c = useListContext(props), data = _c.data, isLoading = _c.isLoading;
  var resource = useResourceContext(props);
  var createPath = useCreatePath();
  if (isLoading === true) {
    return React172.createElement(LinearProgress_default, null);
  }
  return React172.createElement(Component2, __assign122({ className }, sanitizeListRestProps(rest)), data.map(function(record, rowIndex) {
    var _a14, _b2;
    ...
    if (resourceLinkPath) {
      return React172.createElement(
        ...
        React172.createElement(Link2, { className: SingleFieldListClasses.link, to: resourceLinkPath, onClick: stopPropagation5 }, (0, import_react96.cloneElement)(import_react96.Children.only(children), {
          record,
          resource,
    ...
    return React172.createElement(RecordContextProvider, { value: record, key: (_b2 = record.id) !== null && _b2 !== void 0 ? _b2 : "row".concat(rowIndex) }, children);
  }));
};
SingleFieldList.propTypes = {
  children: import_prop_types102.default.element.isRequired,
  classes: import_prop_types102.default.object,
  className: import_prop_types102.default.string,
  component: ComponentPropType_default,
  data: import_prop_types102.default.any,
  ids: import_prop_types102.default.array,
  // @ts-ignore
  linkType: import_prop_types102.default.oneOfType([import_prop_types102.default.string, import_prop_types102.default.bool]),
  resource: import_prop_types102.default.string,
  sx: import_prop_types102.default.oneOfType([
    import_prop_types102.default.arrayOf(import_prop_types102.default.oneOfType([
      import_prop_types102.default.func,
      import_prop_types102.default.object,
      import_prop_types102.default.bool
    ])),
    import_prop_types102.default.func,
    import_prop_types102.default.object
  ])
};
var PREFIX75 = "RaSingleFieldList";
var SingleFieldListClasses = {
  link: "".concat(PREFIX75, "-link")
};
var Root31 = styled_default("div", {
  name: PREFIX75,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
  ...
  display: "flex",
  flexWrap: "wrap"
}, _a11["& .".concat(SingleFieldListClasses.link)] = {
  textDecoration: "none"
}, _a11));
...
var ReferenceArrayField = function(props) {
  var filter = props.filter, _a13 = props.page, page = _a13 === void 0 ? 1 : _a13, perPage = props.perPage, reference = props.reference, resource = props.resource, sort = props.sort, source = props.source;
  var record = useRecordContext(props);
  ...
  return React173.createElement(
    ...
    React173.createElement(
      ...
      React173.createElement(PureReferenceArrayFieldView, __assign123({}, props))
    )
  );
};
ReferenceArrayField.propTypes = __assign123(__assign123({}, fieldPropTypes), { className: import_prop_types103.default.string, children: import_prop_types103.default.node, label: fieldPropTypes.label, record: import_prop_types103.default.any, reference: import_prop_types103.default.string.isRequired, resource: import_prop_types103.default.string, sortBy: import_prop_types103.default.string, sortByOrder: fieldPropTypes.sortByOrder, source: import_prop_types103.default.string.isRequired });
var ReferenceArrayFieldView = function(props) {
  ...
  var child = children ? children : React173.createElement(
    SingleFieldList,
    null,
    React173.createElement(ChipField, { source: typeof recordRepresentation === "string" ? recordRepresentation : "id", size: "small" })
  );
  return React173.createElement(Root32, { className, sx }, isLoading ? React173.createElement(LinearProgress, { className: ReferenceArrayFieldClasses.progress }) : React173.createElement(
    "span",
    null,
    child,
...
ReferenceArrayFieldView.propTypes = {
  ...
  reference: import_prop_types103.default.string.isRequired
};
var PREFIX76 = "RaReferenceArrayField";
var ReferenceArrayFieldClasses = {
  progress: "".concat(PREFIX76, "-progress")
};
var Root32 = styled_default("div", {
  name: PREFIX76,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var PureReferenceArrayFieldView = (0, import_react97.memo)(ReferenceArrayFieldView);
...
var ReferenceField = function(props) {
  var source = props.source, emptyText = props.emptyText, rest = __rest115(props, ["source", "emptyText"]);
  var record = useRecordContext(props);
  var id = (0, import_get18.default)(record, source);
  var translate = useTranslate();
  return id == null ? emptyText ? React174.createElement(Typography_default, { component: "span", variant: "body2" }, emptyText && translate(emptyText, { _: emptyText })) : null : React174.createElement(NonEmptyReferenceField, __assign124({}, rest, { emptyText, record, id }));
};
ReferenceField.propTypes = {
  children: import_prop_types104.default.node,
  className: import_prop_types104.default.string,
  cellClassName: import_prop_types104.default.string,
  headerClassName: import_prop_types104.default.string,
  label: fieldPropTypes.label,
  record: import_prop_types104.default.any,
  reference: import_prop_types104.default.string.isRequired,
  resource: import_prop_types104.default.string,
  sortBy: import_prop_types104.default.string,
  sortByOrder: fieldPropTypes.sortByOrder,
  source: import_prop_types104.default.string.isRequired,
  translateChoice: import_prop_types104.default.oneOfType([import_prop_types104.default.func, import_prop_types104.default.bool]),
  // @ts-ignore
  link: import_prop_types104.default.oneOfType([
    import_prop_types104.default.string,
    import_prop_types104.default.bool,
    import_prop_types104.default.func
  ]).isRequired
};
...
var NonEmptyReferenceField = function(_a13) {
  var children = _a13.children, id = _a13.id, reference = _a13.reference, queryOptions = _a13.queryOptions, link = _a13.link, props = __rest115(_a13, ["children", "id", "reference", "queryOptions", "link"]);
  return React174.createElement(
    ResourceContextProvider,
    { value: reference },
    React174.createElement(PureReferenceFieldView, __assign124({ reference }, props, useReference({
      reference,
      id,
      options: queryOptions
    }), { resourceLinkPath: link }), children)
  );
};
...
var ReferenceFieldView = function(props) {
  ...
  if (error) {
    return (
      ...
      React174.createElement(import_Error2.default, { "aria-errormessage": error.message ? error.message : error, role: "presentation", color: "error", fontSize: "small" })
    );
  }
  if (isLoading) {
    return React174.createElement(LinearProgress, null);
  }
  if (!referenceRecord) {
    return emptyText ? React174.createElement(React174.Fragment, null, emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  ...
  var child = children || React174.createElement(Typography_default, { component: "span", variant: "body2" }, getRecordRepresentation(referenceRecord));
  if (link) {
    return React174.createElement(
      Root33,
      { className, sx },
      React174.createElement(
        ...
        React174.createElement(Link2, { to: link, className: ReferenceFieldClasses.link, onClick: stopPropagation6 }, child)
      )
    );
  }
  return React174.createElement(RecordContextProvider, { value: referenceRecord }, child);
};
ReferenceFieldView.propTypes = {
  children: import_prop_types104.default.element,
  className: import_prop_types104.default.string,
  isLoading: import_prop_types104.default.bool,
  record: import_prop_types104.default.any,
  reference: import_prop_types104.default.string,
  referenceRecord: import_prop_types104.default.any,
  resource: import_prop_types104.default.string,
  // @ts-ignore
  resourceLinkPath: import_prop_types104.default.oneOfType([
    import_prop_types104.default.string,
    import_prop_types104.default.bool,
    import_prop_types104.default.func
  ]).isRequired,
  source: import_prop_types104.default.string,
  translateChoice: import_prop_types104.default.oneOfType([import_prop_types104.default.func, import_prop_types104.default.bool])
};
var PureReferenceFieldView = genericMemo(ReferenceFieldView);
var PREFIX77 = "RaReferenceField";
var ReferenceFieldClasses = {
  link: "".concat(PREFIX77, "-link")
};
var Root33 = styled_default("span", {
  name: PREFIX77,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ReferenceManyCount = function(props) {
  var _a13;
  var reference = props.reference, target = props.target, filter = props.filter, sort = props.sort, link = props.link, resource = props.resource, _b = props.source, source = _b === void 0 ? "id" : _b, _c = props.timeout, timeout = _c === void 0 ? 1e3 : _c, rest = __rest116(props, ["reference", "target", "filter", "sort", "link", "resource", "source", "timeout"]);
  var record = useRecordContext(props);
  var oneSecondHasPassed = useTimeout(timeout);
  var createPath = useCreatePath();
  ...
  var body = isLoading ? oneSecondHasPassed ? import_react98.default.createElement(CircularProgress_default, { size: 14 }) : "" : error ? import_react98.default.createElement(import_Error3.default, { color: "error", fontSize: "small", titleAccess: "error" }) : total;
  return link ? import_react98.default.createElement(Link2, __assign125({ to: {
    pathname: createPath({ resource: reference, type: "list" }),
    search: "filter=".concat(JSON.stringify(__assign125(__assign125({}, filter || {}), (_a13 = {}, _a13[target] = record[source], _a13))))
  }, variant: "body2", onClick: function(e) {
    return e.stopPropagation();
  } }, sanitizeFieldRestProps(rest)), body) : import_react98.default.createElement(Typography_default, __assign125({ component: "span", variant: "body2" }, sanitizeFieldRestProps(rest)), body);
};
...
var ReferenceManyField = function(props) {
  var children = props.children, filter = props.filter, _a13 = props.page, page = _a13 === void 0 ? 1 : _a13, _b = props.pagination, pagination = _b === void 0 ? null : _b, perPage = props.perPage, reference = props.reference, resource = props.resource, sort = props.sort, source = props.source, target = props.target;
  var record = useRecordContext(props);
...
ReferenceManyField.propTypes = {
  children: import_prop_types105.default.node.isRequired,
  className: import_prop_types105.default.string,
  filter: import_prop_types105.default.object,
  label: fieldPropTypes.label,
  perPage: import_prop_types105.default.number,
  record: import_prop_types105.default.any,
  reference: import_prop_types105.default.string.isRequired,
  resource: import_prop_types105.default.string,
  sortBy: import_prop_types105.default.string,
  sortByOrder: fieldPropTypes.sortByOrder,
  source: import_prop_types105.default.string.isRequired,
  sort: import_prop_types105.default.exact({
    field: import_prop_types105.default.string,
    order: import_prop_types105.default.string
  }),
  target: import_prop_types105.default.string.isRequired
};
...
ReferenceManyFieldView.propTypes = {
  children: import_prop_types105.default.element,
  className: import_prop_types105.default.string,
  sort: import_prop_types105.default.exact({
    field: import_prop_types105.default.string,
    order: import_prop_types105.default.string
  }),
  data: import_prop_types105.default.any,
  isLoading: import_prop_types105.default.bool,
  pagination: import_prop_types105.default.element,
  reference: import_prop_types105.default.string,
  setSort: import_prop_types105.default.func
};
...
var ReferenceOneField = function(props) {
  var children = props.children, reference = props.reference, source = props.source, target = props.target, emptyText = props.emptyText, sort = props.sort, filter = props.filter, _a13 = props.link, link = _a13 === void 0 ? false : _a13, queryOptions = props.queryOptions;
  var record = useRecordContext(props);
  var createPath = useCreatePath();
  var translate = useTranslate();
  ...
  return !record || !isLoading && referenceRecord == null ? emptyText ? import_react100.default.createElement(Typography_default, { component: "span", variant: "body2" }, emptyText && translate(emptyText, { _: emptyText })) : null : import_react100.default.createElement(
    ResourceContextProvider,
    { value: reference },
    import_react100.default.createElement(ReferenceFieldView, { isLoading, isFetching, referenceRecord, resourceLinkPath, reference, refetch, error }, children)
  );
};
ReferenceOneField.propTypes = {
  ...
  label: fieldPropTypes.label,
  record: import_prop_types106.default.any,
  reference: import_prop_types106.default.string.isRequired,
  source: import_prop_types106.default.string.isRequired,
  target: import_prop_types106.default.string.isRequired,
  queryOptions: import_prop_types106.default.any
};
...
var RichTextFieldImpl = function(props) {
  var _a13;
  var className = props.className, emptyText = props.emptyText, source = props.source, _b = props.stripTags, stripTags = _b === void 0 ? false : _b, purifyOptions = props.purifyOptions, rest = __rest117(props, ["className", "emptyText", "source", "stripTags", "purifyOptions"]);
  var record = useRecordContext(props);
  var value = (_a13 = (0, import_get19.default)(record, source)) === null || _a13 === void 0 ? void 0 : _a13.toString();
  var translate = useTranslate();
  return React178.createElement(Typography_default, __assign126({ className, variant: "body2", component: "span" }, sanitizeFieldRestProps(rest)), value == null && emptyText ? translate(emptyText, { _: emptyText }) : stripTags ? removeTags(value) : React178.createElement("span", { dangerouslySetInnerHTML: {
    __html: purify.sanitize(value, purifyOptions)
  } }));
};
RichTextFieldImpl.propTypes = __assign126(__assign126(__assign126({}, Typography_default.propTypes), fieldPropTypes), { stripTags: import_prop_types107.default.bool, purifyOptions: import_prop_types107.default.any });
...
var SelectFieldImpl = function(props) {
  var className = props.className, emptyText = props.emptyText, source = props.source, choices2 = props.choices, optionValue = props.optionValue, optionText = props.optionText, translateChoice = props.translateChoice, rest = __rest118(props, ["className", "emptyText", "source", "choices", "optionValue", "optionText", "translateChoice"]);
  var record = useRecordContext(props);
  ...
  if (!choice) {
    return emptyText ? React179.createElement(Typography_default, __assign127({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText })) : null;
  }
  var choiceText = getChoiceText(choice);
  return React179.createElement(Typography_default, __assign127({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), choiceText);
};
SelectFieldImpl.propTypes = __assign127(__assign127(__assign127({}, Typography_default.propTypes), fieldPropTypes), { choices: import_prop_types108.default.arrayOf(import_prop_types108.default.object).isRequired, optionText: import_prop_types108.default.oneOfType([
  import_prop_types108.default.string,
  import_prop_types108.default.func,
  import_prop_types108.default.element
]), optionValue: import_prop_types108.default.string, translateChoice: import_prop_types108.default.bool });
...
var TextFieldImpl = function(props) {
  var _a13;
  var className = props.className, source = props.source, emptyText = props.emptyText, rest = __rest119(props, ["className", "source", "emptyText"]);
  var record = useRecordContext(props);
  var value = (_a13 = (0, import_get21.default)(record, source)) === null || _a13 === void 0 ? void 0 : _a13.toString();
  var translate = useTranslate();
  return React180.createElement(Typography_default, __assign128({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), value != null && typeof value !== "string" ? JSON.stringify(value) : value || (emptyText ? translate(emptyText, { _: emptyText }) : null));
};
TextFieldImpl.propTypes = __assign128(__assign128({}, Typography_default.propTypes), fieldPropTypes);
TextFieldImpl.displayName = "TextFieldImpl";
var TextField = genericMemo(TextFieldImpl);
...
var TranslatableFieldsTab = function(props) {
  var locale = props.locale, _a13 = props.groupKey, groupKey = _a13 === void 0 ? "" : _a13, rest = __rest120(props, ["locale", "groupKey"]);
  var translate = useTranslate();
  return import_react101.default.createElement(Tab_default, __assign129({ id: "translatable-header-".concat(groupKey).concat(locale), label: translate("ra.locales.".concat(groupKey).concat(locale), {
    _: (0, import_inflection6.capitalize)(locale)
  }) }, rest));
};
...
var TranslatableFieldsTabs = function(props) {
  ...
  return React182.createElement(
    ...
    React182.createElement(Tabs_default, __assign130({ value: selectedLocale, onChange: handleChange, indicatorColor: "primary", textColor: "primary" }, tabsProps), locales.map(function(locale) {
      return React182.createElement(TranslatableFieldsTab, { key: locale, value: locale, locale, groupKey });
    }))
  );
};
var PREFIX78 = "RaTranslatableFieldsTabs";
var StyledAppBar3 = styled_default(AppBar_default, {
  name: PREFIX78,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var TranslatableFieldsTabContent = function(props) {
  var children = props.children, _a13 = props.groupKey, groupKey = _a13 === void 0 ? "" : _a13, locale = props.locale, record = props.record, resource = props.resource, className = props.className, other = __rest121(props, ["children", "groupKey", "locale", "record", "resource", "className"]);
  var _b = useTranslatableContext(), selectedLocale = _b.selectedLocale, getLabel = _b.getLabel, getSource = _b.getSource;
  return React183.createElement(Root34, __assign131({ role: "tabpanel", hidden: selectedLocale !== locale, id: "translatable-content-".concat(groupKey).concat(locale), "aria-labelledby": "translatable-header-".concat(groupKey).concat(locale), className }, other), import_react102.Children.map(children, function(field) {
    return field && (0, import_react102.isValidElement)(field) ? React183.createElement("div", { key: field.props.source }, field.props.addLabel ? React183.createElement(Labeled, { resource, label: field.props.label, source: field.props.source }, (0, import_react102.cloneElement)(field, __assign131(__assign131({}, field.props), { label: getLabel(field.props.source), record, source: getSource(field.props.source, locale) }))) : typeof field === "string" ? field : (0, import_react102.cloneElement)(field, __assign131(__assign131({}, field.props), { label: getLabel(field.props.source), record, source: getSource(field.props.source, locale) }))) : null;
  }));
};
var PREFIX79 = "RaTranslatableFieldsTabContent";
var Root34 = styled_default("div", {
  name: PREFIX79,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var TranslatableFields = function(props) {
  var defaultLocale = props.defaultLocale, locales = props.locales, _a13 = props.groupKey, groupKey = _a13 === void 0 ? "" : _a13, _b = props.selector, selector = _b === void 0 ? React184.createElement(TranslatableFieldsTabs, { groupKey }) : _b, children = props.children, resource = props.resource, className = props.className;
  var record = useRecordContext(props);
  var context = useTranslatable({ defaultLocale, locales });
  return React184.createElement(
    ...
    React184.createElement(
      ...
      selector,
      locales.map(function(locale) {
        return React184.createElement(TranslatableFieldsTabContent, { key: locale, locale, record, resource, groupKey }, children);
      })
    )
  );
};
var PREFIX80 = "RaTranslatableFields";
var Root35 = styled_default("div", {
  name: PREFIX80,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var UrlFieldImpl = function(props) {
  var className = props.className, emptyText = props.emptyText, source = props.source, rest = __rest122(props, ["className", "emptyText", "source"]);
  var record = useRecordContext(props);
  var value = (0, import_get22.default)(record, source);
  var translate = useTranslate();
  if (value == null) {
    return React185.createElement(Typography_default, __assign132({ component: "span", variant: "body2", className }, sanitizeFieldRestProps(rest)), emptyText && translate(emptyText, { _: emptyText }));
  }
  return React185.createElement(Link_default, __assign132({ className, href: value, onClick: stopPropagation7, variant: "body2" }, sanitizeFieldRestProps(rest)), value);
};
...
var WrapperField = function(_a13) {
  var children = _a13.children;
  return React186.createElement(React186.Fragment, null, children);
};
...
var SimpleShowLayout = function(props) {
  var className = props.className, children = props.children, divider = props.divider, _a13 = props.spacing, spacing = _a13 === void 0 ? 1 : _a13, rest = __rest123(props, ["className", "children", "divider", "spacing"]);
  var record = useRecordContext(props);
  if (!record) {
    return null;
  }
  return React187.createElement(
    ...
    React187.createElement(
      Root36,
      __assign133({ className }, sanitizeRestProps27(rest)),
      React187.createElement(Stack_default, { spacing, divider, className: SimpleShowLayoutClasses.stack }, import_react103.Children.map(children, function(field) {
        return field && (0, import_react103.isValidElement)(field) ? React187.createElement(Labeled, { key: field.props.source, className: clsx_m_default("ra-field", field.props.source && "ra-field-".concat(field.props.source), SimpleShowLayoutClasses.row, field.props.className) }, field) : null;
      }))
    )
  );
};
SimpleShowLayout.propTypes = {
  ...
  record: import_prop_types109.default.object,
  spacing: import_prop_types109.default.any,
  sx: import_prop_types109.default.any
};
var PREFIX81 = "RaSimpleShowLayout";
var SimpleShowLayoutClasses = {
  stack: "".concat(PREFIX81, "-stack"),
  row: "".concat(PREFIX81, "-row")
};
var Root36 = styled_default("div", {
  name: PREFIX81,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var sanitizeRestProps27 = function(_a13) {
  var record = _a13.record, resource = _a13.resource, initialValues = _a13.initialValues, translate = _a13.translate, rest = __rest123(_a13, ["record", "resource", "initialValues", "translate"]);
  return rest;
};
...
var showFieldTypes = {
  show: {
    component: function(props) {
      return React188.createElement(SimpleShowLayout, __assign134({}, props));
    },
    representation: function(_, children) {
  ...
  array: {
    // eslint-disable-next-line react/display-name
    component: function(_a13) {
      var children = _a13.children, props = __rest124(_a13, ["children"]);
      return React188.createElement(
        ArrayField,
        __assign134({}, props),
        React188.createElement(Datagrid, null, children)
      );
    },
    representation: function(props, children) {
  ...
  referenceChild: {
    component: function(props) {
      return React188.createElement(TextField, __assign134({ source: "id" }, props));
    },
    representation: function() {
...
var ShowGuesser = function(_a13) {
  var id = _a13.id, queryOptions = _a13.queryOptions, resource = _a13.resource, rest = __rest125(_a13, ["id", "queryOptions", "resource"]);
  return React189.createElement(
    ShowBase,
    { id, resource, queryOptions },
    React189.createElement(ShowViewGuesser, __assign135({}, rest))
  );
};
var ShowViewGuesser = function(props) {
  var resource = useResourceContext(props);
  var record = useShowContext().record;
  var _a13 = (0, import_react104.useState)(null), child = _a13[0], setChild = _a13[1];
  ...
  (0, import_react104.useEffect)(function() {
    if (record && !child) {
      ...
      console.log("Guessed Show:\n\nimport { ".concat(components.join(", "), " } from 'react-admin';\n\nexport const ").concat(import_inflection7.default.capitalize(import_inflection7.default.singularize(resource)), "Show = () => (\n    <Show>\n").concat(inferredChild.getRepresentation(), "\n    </Show>\n);"));
    }
  }, [record, child, resource]);
  return React189.createElement(ShowView, __assign135({}, props), child);
};
...
var TabbedShowLayoutTabs = function(_a13) {
  var children = _a13.children, syncWithLocation = _a13.syncWithLocation, value = _a13.value, rest = __rest126(_a13, ["children", "syncWithLocation", "value"]);
  var params = useParams();
  var tabValue = params["*"];
  return React190.createElement(Tabs_default, __assign136({ indicatorColor: "primary", value: syncWithLocation ? tabValue : value }, rest), import_react105.Children.map(children, function(tab, index) {
    if (!tab || !(0, import_react105.isValidElement)(tab))
      return null;
    var tabPath = getShowLayoutTabFullPath(tab, index);
    return (0, import_react105.cloneElement)(tab, {
      context: "header",
      value: syncWithLocation ? tabPath : index,
      syncWithLocation
    });
...
var Tab = function(_a13) {
  var children = _a13.children, contentClassName = _a13.contentClassName, context = _a13.context, count = _a13.count, className = _a13.className, divider = _a13.divider, icon = _a13.icon, label = _a13.label, record = _a13.record, _b = _a13.spacing, spacing = _b === void 0 ? 1 : _b, _c = _a13.syncWithLocation, syncWithLocation = _c === void 0 ? true : _c, value = _a13.value, rest = __rest127(_a13, ["children", "contentClassName", "context", "count", "className", "divider", "icon", "label", "record", "spacing", "syncWithLocation", "value"]);
  var translate = useTranslate();
  var location = useLocation();
  var propsForLink = {
    component: Link,
    to: __assign137(__assign137({}, location), { pathname: value })
  };
  var renderHeader = function() {
    var tabLabel = typeof label === "string" ? translate(label, { _: label }) : label;
    if (count !== void 0) {
      tabLabel = React191.createElement(
        "span",
        null,
        tabLabel,
        " (",
    ...
    return React191.createElement(Tab_default, __assign137({ key: "tab-header-".concat(value), label: tabLabel, value, icon, className: clsx_m_default("show-tab", className) }, syncWithLocation ? propsForLink : {}, rest));
  };
  var renderContent = function() {
    return React191.createElement(Stack_default, { className: contentClassName, spacing, divider }, React191.Children.map(children, function(field) {
      return field && (0, import_react106.isValidElement)(field) ? React191.createElement(Labeled, { key: field.props.source, className: clsx_m_default("ra-field", field.props.source && "ra-field-".concat(field.props.source), field.props.className) }, field) : null;
    }));
  };
...
Tab.propTypes = {
  ...
  contentClassName: import_prop_types111.default.string,
  context: import_prop_types111.default.oneOf(["header", "content"]),
  count: import_prop_types111.default.node,
  icon: import_prop_types111.default.element,
  label: import_prop_types111.default.oneOfType([import_prop_types111.default.string, import_prop_types111.default.element]).isRequired,
  path: import_prop_types111.default.string,
  spacing: import_prop_types111.default.any,
  value: import_prop_types111.default.oneOfType([import_prop_types111.default.string, import_prop_types111.default.number])
};
...
var TabbedShowLayout = function(props) {
  var children = props.children, className = props.className, spacing = props.spacing, divider = props.divider, _a13 = props.syncWithLocation, syncWithLocation = _a13 === void 0 ? true : _a13, _b = props.tabs, tabs = _b === void 0 ? DefaultTabs2 : _b, value = props.value, rest = __rest128(props, ["children", "className", "spacing", "divider", "syncWithLocation", "tabs", "value"]);
  var record = useRecordContext(props);
  var nonNullChildren = import_react107.Children.toArray(children).filter(function(child) {
    return child !== null;
  });
  var _c = (0, import_react107.useState)(0), tabValue = _c[0], setTabValue = _c[1];
  ...
  var renderTabHeaders = function() {
    return (0, import_react107.cloneElement)(tabs, {
      onChange: handleTabChange,
      syncWithLocation,
      value: tabValue
    }, nonNullChildren);
  ...
  return React192.createElement(
    OptionalRecordContextProvider,
    { value: props.record },
    React192.createElement(Root37, __assign138({ className }, sanitizeRestProps28(rest)), syncWithLocation ? React192.createElement(
      Routes,
      null,
      React192.createElement(Route, { path: "/*", element: React192.createElement(
        React192.Fragment,
        null,
        renderTabHeaders(),
        React192.createElement(Divider_default, null),
        React192.createElement(
          "div",
          { className: TabbedShowLayoutClasses.content },
          React192.createElement(Outlet, null)
        )
      ) }, import_react107.Children.map(nonNullChildren, function(tab, index) {
        return (0, import_react107.isValidElement)(tab) ? React192.createElement(Route, { path: getShowLayoutTabFullPath(tab, index), element: (0, import_react107.cloneElement)(tab, {
          context: "content",
          spacing,
          divider
        }) }) : null;
      ...
      renderTabHeaders(),
      React192.createElement(Divider_default, null),
      React192.createElement("div", { className: TabbedShowLayoutClasses.content }, import_react107.Children.map(nonNullChildren, function(tab, index) {
        if (!(0, import_react107.isValidElement)(tab) || tabValue !== index) {
          return null;
        }
        return (0, import_react107.cloneElement)(tab, {
          context: "content",
          spacing,
          divider
        });
...
TabbedShowLayout.propTypes = {
  ...
  record: import_prop_types112.default.object,
  spacing: import_prop_types112.default.any,
  sx: import_prop_types112.default.any,
  syncWithLocation: import_prop_types112.default.bool,
  tabs: import_prop_types112.default.element,
  value: import_prop_types112.default.number
};
var DefaultTabs2 = React192.createElement(TabbedShowLayoutTabs, null);
var PREFIX82 = "RaTabbedShowLayout";
var TabbedShowLayoutClasses = {
  content: "".concat(PREFIX82, "-content")
};
var Root37 = styled_default("div", {
  name: PREFIX82,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var sanitizeRestProps28 = function(_a13) {
  var record = _a13.record, resource = _a13.resource, initialValues = _a13.initialValues, staticContext = _a13.staticContext, translate = _a13.translate, tabs = _a13.tabs, rest = __rest128(_a13, ["record", "resource", "initialValues", "staticContext", "translate", "tabs"]);
  return rest;
};
...
var Count = function(props) {
  var filter = props.filter, sort = props.sort, link = props.link, resourceFromProps = props.resource, _a13 = props.timeout, timeout = _a13 === void 0 ? 1e3 : _a13, rest = __rest129(props, ["filter", "sort", "link", "resource", "timeout"]);
  var resource = useResourceContext(props);
  var oneSecondHasPassed = useTimeout(timeout);
  var createPath = useCreatePath();
  ...
  var body = isLoading ? oneSecondHasPassed ? React193.createElement(CircularProgress_default, { size: 14 }) : "" : error ? React193.createElement(import_Error4.default, { color: "error", fontSize: "small", titleAccess: "error" }) : total;
  return link ? (
    // @ts-ignore TypeScript complains that the props for <a> aren't the same as for <span>
    React193.createElement(Link2, __assign139({ to: {
      pathname: createPath({ resource, type: "list" }),
      search: filter ? "filter=".concat(JSON.stringify(filter)) : void 0
    }, variant: "body2", onClick: function(e) {
      return e.stopPropagation();
    } }, rest), body)
  ) : React193.createElement(Typography_default, __assign139({ component: "span", variant: "body2" }, rest), body);
};
...
var Empty = function(props) {
  ...
  return React194.createElement(
    ...
    React194.createElement(
      ...
      React194.createElement(import_Inbox.default, { className: EmptyClasses.icon }),
      React194.createElement(Typography_default, { variant: "h4", paragraph: true }, translate("resources.".concat(resource, ".empty"), {
        _: emptyMessage
      })),
      hasCreate && React194.createElement(Typography_default, { variant: "body1" }, translate("resources.".concat(resource, ".invite"), {
        _: inviteMessage
      }))
    ),
    hasCreate && React194.createElement(
      "div",
      { className: EmptyClasses.toolbar },
      React194.createElement(CreateButton_default, { variant: "contained" })
    )
  );
};
var PREFIX83 = "RaEmpty";
var EmptyClasses = {
  message: "".concat(PREFIX83, "-message"),
  icon: "".concat(PREFIX83, "-icon"),
  toolbar: "".concat(PREFIX83, "-toolbar")
};
var Root38 = styled_default("span", {
  name: PREFIX83,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ListToolbar = (0, import_react108.memo)(function(props) {
  var filters = props.filters, actions = props.actions, className = props.className, rest = __rest130(props, ["filters", "actions", "className"]);
  return Array.isArray(filters) ? React195.createElement(
    FilterContext.Provider,
    { value: filters },
    React195.createElement(
      Root39,
      { className },
      React195.createElement(FilterForm, null),
      React195.createElement("span", null),
      actions && React195.cloneElement(actions, __assign140(__assign140({}, rest), actions.props))
    )
  ) : React195.createElement(
    Root39,
    { className },
    filters && React195.cloneElement(filters, __assign140(__assign140({}, rest), { context: "form" })),
    React195.createElement("span", null),
    actions && React195.cloneElement(actions, __assign140(__assign140(__assign140({}, rest), { filters }), actions.props))
  );
});
ListToolbar.propTypes = {
  filters: import_prop_types113.default.oneOfType([
    import_prop_types113.default.element,
    import_prop_types113.default.arrayOf(import_prop_types113.default.element)
  ]),
  // @ts-ignore
  actions: import_prop_types113.default.oneOfType([import_prop_types113.default.bool, import_prop_types113.default.element]),
  // @ts-ignore
  exporter: import_prop_types113.default.oneOfType([import_prop_types113.default.func, import_prop_types113.default.bool])
};
var PREFIX84 = "RaListToolbar";
var Root39 = styled_default(Toolbar_default, {
  name: PREFIX84,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var ListActions = function(props) {
  var className = props.className, filtersProp = props.filters, _ = props.hasCreate, rest = __rest131(props, ["className", "filters", "hasCreate"]);
  var _a13 = useListContext(props), sort = _a13.sort, displayedFilters = _a13.displayedFilters, filterValues = _a13.filterValues, exporter = _a13.exporter, showFilter = _a13.showFilter, total = _a13.total;
  var resource = useResourceContext(props);
  var hasCreate = useResourceDefinition(props).hasCreate;
  var filters = (0, import_react109.useContext)(FilterContext) || filtersProp;
  return (0, import_react109.useMemo)(
    function() {
      return React196.createElement(
        TopToolbar_default,
        __assign141({ className }, sanitizeListRestProps(rest)),
        filtersProp ? (0, import_react109.cloneElement)(filtersProp, {
          resource,
          showFilter,
          displayedFilters,
          filterValues,
          context: "button"
        }) : filters && React196.createElement(FilterButton, null),
        hasCreate && React196.createElement(CreateButton_default, null),
        exporter !== false && React196.createElement(ExportButton, { disabled: total === 0, resource, sort, filterValues })
      );
    },
...
ListActions.propTypes = {
  ...
  sort: import_prop_types114.default.any,
  displayedFilters: import_prop_types114.default.object,
  exporter: import_prop_types114.default.oneOfType([import_prop_types114.default.func, import_prop_types114.default.bool]),
  filters: import_prop_types114.default.element,
  filterValues: import_prop_types114.default.object,
  hasCreate: import_prop_types114.default.bool,
  resource: import_prop_types114.default.string,
  onUnselectItems: import_prop_types114.default.func.isRequired,
  selectedIds: import_prop_types114.default.arrayOf(import_prop_types114.default.any),
  showFilter: import_prop_types114.default.func,
  total: import_prop_types114.default.number
};
...
var defaultActions2 = React197.createElement(ListActions, null);
var defaultPagination2 = React197.createElement(Pagination, null);
var defaultEmpty = React197.createElement(Empty, null);
var DefaultComponent3 = Card_default;
var ListView = function(props) {
  var _a13 = props.actions, actions = _a13 === void 0 ? defaultActions2 : _a13, aside = props.aside, filters = props.filters, bulkActionButtons = props.bulkActionButtons, emptyWhileLoading = props.emptyWhileLoading, hasCreate = props.hasCreate, _b = props.pagination, pagination = _b === void 0 ? defaultPagination2 : _b, children = props.children, className = props.className, _c = props.component, Content = _c === void 0 ? DefaultComponent3 : _c, title = props.title, _d = props.empty, empty = _d === void 0 ? defaultEmpty : _d, rest = __rest132(props, ["actions", "aside", "filters", "bulkActionButtons", "emptyWhileLoading", "hasCreate", "pagination", "children", "className", "component", "title", "empty"]);
  ...
  var renderList = function() {
    return React197.createElement(
      ...
      (filters || actions) && React197.createElement(ListToolbar, { className: ListClasses.actions, filters, actions, hasCreate }),
      React197.createElement(Content, { className: ListClasses.content }, bulkActionButtons && children && React197.isValidElement(children) ? (
        // FIXME remove in 5.0
        (0, import_react110.cloneElement)(children, {
          bulkActionButtons
        })
      ) : children),
      error ? React197.createElement(Error2, { error, resetErrorBoundary: null }) : pagination !== false && pagination
    );
  };
  var renderEmpty = function() {
    return empty !== false && (0, import_react110.cloneElement)(empty, { className: ListClasses.noResults, hasCreate });
  };
  ...
  return React197.createElement(
    Root40,
    __assign142({ className: clsx_m_default("list-page", className) }, rest),
    React197.createElement(Title, { title, defaultTitle, preferenceKey: "".concat(resource, ".list.title") }),
    shouldRenderEmptyPage ? renderEmpty() : renderList(),
    aside
  );
};
ListView.propTypes = {
  actions: import_prop_types115.default.oneOfType([import_prop_types115.default.bool, import_prop_types115.default.element]),
  aside: import_prop_types115.default.element,
  children: import_prop_types115.default.node,
  className: import_prop_types115.default.string,
  component: ComponentPropType_default,
  emptyWhileLoading: import_prop_types115.default.bool,
  filters: import_prop_types115.default.oneOfType([
    import_prop_types115.default.element,
    import_prop_types115.default.arrayOf(import_prop_types115.default.element)
  ]),
  hasCreate: import_prop_types115.default.bool,
  pagination: import_prop_types115.default.oneOfType([import_prop_types115.default.element, import_prop_types115.default.bool]),
  title: TitlePropType
};
var PREFIX85 = "RaList";
var ListClasses = {
  main: "".concat(PREFIX85, "-main"),
  content: "".concat(PREFIX85, "-content"),
  actions: "".concat(PREFIX85, "-actions"),
  noResults: "".concat(PREFIX85, "-noResults")
};
var Root40 = styled_default("div", {
  name: PREFIX85,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var InfiniteList = function(_a13) {
  var debounce2 = _a13.debounce, disableAuthentication = _a13.disableAuthentication, disableSyncWithLocation = _a13.disableSyncWithLocation, exporter = _a13.exporter, filter = _a13.filter, filterDefaultValues = _a13.filterDefaultValues, _b = _a13.pagination, pagination = _b === void 0 ? defaultPagination3 : _b, perPage = _a13.perPage, queryOptions = _a13.queryOptions, resource = _a13.resource, sort = _a13.sort, storeKey = _a13.storeKey, rest = __rest133(_a13, ["debounce", "disableAuthentication", "disableSyncWithLocation", "exporter", "filter", "filterDefaultValues", "pagination", "perPage", "queryOptions", "resource", "sort", "storeKey"]);
  return React198.createElement(
    ...
    React198.createElement(ListView, __assign143({}, rest, { pagination }))
  );
};
var defaultPagination3 = React198.createElement(InfinitePagination, null);
InfiniteList.propTypes = {
  // the props you can change
  // @ts-ignore-line
  actions: import_prop_types116.default.oneOfType([import_prop_types116.default.bool, import_prop_types116.default.element]),
  aside: import_prop_types116.default.element,
  children: import_prop_types116.default.node.isRequired,
  className: import_prop_types116.default.string,
  emptyWhileLoading: import_prop_types116.default.bool,
  filter: import_prop_types116.default.object,
  filterDefaultValues: import_prop_types116.default.object,
  filters: import_prop_types116.default.oneOfType([
    import_prop_types116.default.element,
    import_prop_types116.default.arrayOf(import_prop_types116.default.element)
  ]),
  // @ts-ignore-line
  pagination: import_prop_types116.default.oneOfType([import_prop_types116.default.element, import_prop_types116.default.bool]),
  perPage: import_prop_types116.default.number.isRequired,
  //@ts-ignore-line
  sort: import_prop_types116.default.shape({
    field: import_prop_types116.default.string,
    order: import_prop_types116.default.string
  }),
  sx: import_prop_types116.default.any,
  title: TitlePropType,
  // the props managed by react-admin
  disableSyncWithLocation: import_prop_types116.default.bool,
  hasCreate: import_prop_types116.default.bool,
  hasEdit: import_prop_types116.default.bool,
  hasList: import_prop_types116.default.bool,
  hasShow: import_prop_types116.default.bool,
  resource: import_prop_types116.default.string
};
...
var List = function(_a13) {
  var debounce2 = _a13.debounce, disableAuthentication = _a13.disableAuthentication, disableSyncWithLocation = _a13.disableSyncWithLocation, exporter = _a13.exporter, filter = _a13.filter, filterDefaultValues = _a13.filterDefaultValues, perPage = _a13.perPage, queryOptions = _a13.queryOptions, resource = _a13.resource, sort = _a13.sort, storeKey = _a13.storeKey, rest = __rest134(_a13, ["debounce", "disableAuthentication", "disableSyncWithLocation", "exporter", "filter", "filterDefaultValues", "perPage", "queryOptions", "resource", "sort", "storeKey"]);
  return React199.createElement(
    ListBase,
    { debounce: debounce2, disableAuthentication, disableSyncWithLocation, exporter, filter, filterDefaultValues, perPage, queryOptions, resource, sort, storeKey },
    React199.createElement(ListView, __assign144({}, rest))
  );
};
List.propTypes = {
  // the props you can change
  // @ts-ignore-line
  actions: import_prop_types117.default.oneOfType([import_prop_types117.default.bool, import_prop_types117.default.element]),
  aside: import_prop_types117.default.element,
  children: import_prop_types117.default.node.isRequired,
  className: import_prop_types117.default.string,
  emptyWhileLoading: import_prop_types117.default.bool,
  filter: import_prop_types117.default.object,
  filterDefaultValues: import_prop_types117.default.object,
  filters: import_prop_types117.default.oneOfType([
    import_prop_types117.default.element,
    import_prop_types117.default.arrayOf(import_prop_types117.default.element)
  ]),
  // @ts-ignore-line
  pagination: import_prop_types117.default.oneOfType([import_prop_types117.default.element, import_prop_types117.default.bool]),
  perPage: import_prop_types117.default.number.isRequired,
  //@ts-ignore-line
  sort: import_prop_types117.default.shape({
    field: import_prop_types117.default.string,
    order: import_prop_types117.default.string
  }),
  sx: import_prop_types117.default.any,
  title: TitlePropType,
  // the props managed by react-admin
  disableSyncWithLocation: import_prop_types117.default.bool,
  hasCreate: import_prop_types117.default.bool,
  hasEdit: import_prop_types117.default.bool,
  hasList: import_prop_types117.default.bool,
  hasShow: import_prop_types117.default.bool,
  resource: import_prop_types117.default.string
};
List.defaultProps = {
  filter: {},
  perPage: 10
...
var listFieldTypes = {
  table: {
    component: function(props) {
      var hasEdit = props.hasEdit, hasShow = props.hasShow, rest = __rest135(props, ["hasEdit", "hasShow"]);
      return React200.createElement(Datagrid, __assign145({ rowClick: !hasEdit && hasShow ? "show" : "edit" }, rest));
    },
    representation: function(props, children) {
  ...
  array: {
    // eslint-disable-next-line react/display-name
    component: function(_a13) {
      var children = _a13.children, props = __rest135(_a13, ["children"]);
      return React200.createElement(
        ...
        React200.createElement(
          SingleFieldList,
          null,
          React200.createElement(ChipField, { source: children.length > 0 && children[0].props.source })
        )
      );
    },
    representation: function(props, children) {
  ...
  referenceChild: {
    component: function() {
      return React200.createElement(TextField, { source: "id" });
    },
    representation: function() {
      return '<TextField source="id" />';
    }
  ...
  referenceArrayChild: {
    component: function() {
      return React200.createElement(
        SingleFieldList,
        null,
        React200.createElement(ChipField, { source: "id" })
      );
    },
    representation: function() {
...
var ListGuesser = function(props) {
  var debounce2 = props.debounce, disableAuthentication = props.disableAuthentication, disableSyncWithLocation = props.disableSyncWithLocation, exporter = props.exporter, filter = props.filter, filterDefaultValues = props.filterDefaultValues, perPage = props.perPage, queryOptions = props.queryOptions, resource = props.resource, sort = props.sort, rest = __rest136(props, ["debounce", "disableAuthentication", "disableSyncWithLocation", "exporter", "filter", "filterDefaultValues", "perPage", "queryOptions", "resource", "sort"]);
  return React201.createElement(
    ListBase,
    { debounce: debounce2, disableAuthentication, disableSyncWithLocation, exporter, filter, filterDefaultValues, perPage, queryOptions: { keepPreviousData: false }, resource, sort },
    React201.createElement(ListViewGuesser, __assign146({}, rest))
  );
};
var ListViewGuesser = function(props) {
  ...
  var _b = (0, import_react111.useState)(null), child = _b[0], setChild = _b[1];
  ...
  (0, import_react111.useEffect)(function() {
    if (data && data.length > 0 && !child) {
      ...
      console.log("Guessed List:\n\nimport { ".concat(components.join(", "), " } from 'react-admin';\n\nexport const ").concat(import_inflection8.default.capitalize(import_inflection8.default.singularize(resource)), "List = () => (\n    <List>\n").concat(inferredChild.getRepresentation(), "\n    </List>\n);"));
    }
  }, [data, child, resource, hasEdit, hasShow]);
  return React201.createElement(ListView, __assign146({}, props), child);
};
...
var SimpleListLoading = function(props) {
  var className = props.className, hasLeftAvatarOrIcon = props.hasLeftAvatarOrIcon, hasRightAvatarOrIcon = props.hasRightAvatarOrIcon, hasSecondaryText = props.hasSecondaryText, hasTertiaryText = props.hasTertiaryText, _a13 = props.nbFakeLines, nbFakeLines = _a13 === void 0 ? 5 : _a13, rest = __rest137(props, ["className", "hasLeftAvatarOrIcon", "hasRightAvatarOrIcon", "hasSecondaryText", "hasTertiaryText", "nbFakeLines"]);
  var oneSecondHasPassed = useTimeout(1e3);
  return oneSecondHasPassed ? React202.createElement(StyledList2, __assign147({ className }, rest), times2(nbFakeLines, function(key) {
    return React202.createElement(
      ListItem_default,
      { key },
      hasLeftAvatarOrIcon && React202.createElement(
        ListItemAvatar_default,
        null,
        React202.createElement(Avatar_default, null, " ")
      ),
      React202.createElement(ListItemText_default, { primary: React202.createElement(
        "div",
        null,
        React202.createElement(Placeholder, { className: SimpleListLoadingClasses.primary }),
        hasTertiaryText && React202.createElement(
          "span",
          { className: SimpleListLoadingClasses.tertiary },
          React202.createElement(Placeholder, null)
        )
      ), secondary: hasSecondaryText ? React202.createElement(Placeholder, null) : void 0 }),
      hasRightAvatarOrIcon && React202.createElement(
        ListItemSecondaryAction_default,
        null,
        React202.createElement(Avatar_default, null, " ")
      )
...
SimpleListLoading.propTypes = {
  ...
  hasLeftAvatarOrIcon: import_prop_types118.default.bool,
  hasRightAvatarOrIcon: import_prop_types118.default.bool,
  hasSecondaryText: import_prop_types118.default.bool,
  hasTertiaryText: import_prop_types118.default.bool,
  nbFakeLines: import_prop_types118.default.number
};
var PREFIX86 = "RaSimpleListLoading";
var SimpleListLoadingClasses = {
  primary: "".concat(PREFIX86, "-primary"),
  tertiary: "".concat(PREFIX86, "-tertiary")
};
var StyledList2 = styled_default(List_default, {
  name: PREFIX86,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
...
var times2 = function(nbChildren, fn) {
  return Array.from({ length: nbChildren }, function(_, key) {
    return fn(key);
  });
};
...
var SimpleList = function(props) {
  var className = props.className, _a13 = props.empty, empty = _a13 === void 0 ? DefaultEmpty2 : _a13, hasBulkActions = props.hasBulkActions, leftAvatar = props.leftAvatar, leftIcon = props.leftIcon, _b = props.linkType, linkType = _b === void 0 ? "edit" : _b, primaryText = props.primaryText, rightAvatar = props.rightAvatar, rightIcon = props.rightIcon, secondaryText = props.secondaryText, tertiaryText = props.tertiaryText, rowStyle = props.rowStyle, rest = __rest138(props, ["className", "empty", "hasBulkActions", "leftAvatar", "leftIcon", "linkType", "primaryText", "rightAvatar", "rightIcon", "secondaryText", "tertiaryText", "rowStyle"]);
  var _c = useListContext(props), data = _c.data, isLoading = _c.isLoading, total = _c.total;
  var resource = useResourceContext(props);
  var translate = useTranslate();
  if (isLoading === true) {
    return React203.createElement(SimpleListLoading, { className, hasLeftAvatarOrIcon: !!leftIcon || !!leftAvatar, hasRightAvatarOrIcon: !!rightIcon || !!rightAvatar, hasSecondaryText: !!secondaryText, hasTertiaryText: !!tertiaryText });
  }
  if (data == null || data.length === 0 || total === 0) {
    if (empty) {
      return empty;
  ...
  var renderAvatar = function(record, avatarCallback) {
    ...
    if (typeof avatarValue === "string" && (avatarValue.startsWith("http") || avatarValue.startsWith("data:"))) {
      return React203.createElement(Avatar_default, { src: avatarValue });
    } else {
      return React203.createElement(Avatar_default, null, avatarValue);
    }
  };
  return total == null && (data === null || data === void 0 ? void 0 : data.length) > 0 || total > 0 ? React203.createElement(Root41, __assign148({ className }, sanitizeListRestProps(rest)), data.map(function(record, rowIndex) {
    return React203.createElement(
      ...
      React203.createElement(
        ...
        React203.createElement(
          LinkOrNot,
          { linkType, resource, id: record.id, record, style: rowStyle ? rowStyle(record, rowIndex) : void 0 },
          leftIcon && React203.createElement(ListItemIcon_default, null, leftIcon(record, record.id)),
          leftAvatar && React203.createElement(ListItemAvatar_default, null, renderAvatar(record, leftAvatar)),
          React203.createElement(ListItemText_default, { primary: React203.createElement(
            "div",
            null,
            typeof primaryText === "string" ? translate(primaryText, __assign148(__assign148({}, record), { _: primaryText })) : (0, import_react_is5.isElement)(primaryText) ? primaryText : primaryText(record, record.id),
            !!tertiaryText && ((0, import_react112.isValidElement)(tertiaryText) ? tertiaryText : React203.createElement("span", { className: SimpleListClasses.tertiary }, typeof tertiaryText === "string" ? translate(tertiaryText, __assign148(__assign148({}, record), { _: tertiaryText })) : (0, import_react_is5.isElement)(tertiaryText) ? tertiaryText : tertiaryText(record, record.id)))
          ), secondary: !!secondaryText && (typeof secondaryText === "string" ? translate(secondaryText, __assign148(__assign148({}, record), { _: secondaryText })) : (0, import_react_is5.isElement)(secondaryText) ? secondaryText : secondaryText(record, record.id)) }),
          (rightAvatar || rightIcon) && React203.createElement(
            ListItemSecondaryAction_default,
            null,
            rightAvatar && React203.createElement(Avatar_default, null, renderAvatar(record, rightAvatar)),
            rightIcon && React203.createElement(ListItemIcon_default, null, rightIcon(record, record.id))
          )
        )
      )
    );
...
SimpleList.propTypes = {
  ...
  leftAvatar: import_prop_types119.default.func,
  leftIcon: import_prop_types119.default.func,
  linkType: import_prop_types119.default.oneOfType([
    import_prop_types119.default.string,
    import_prop_types119.default.bool,
    import_prop_types119.default.func
  ]),
  primaryText: import_prop_types119.default.oneOfType([
    import_prop_types119.default.func,
    import_prop_types119.default.element,
    import_prop_types119.default.string
  ]),
  rightAvatar: import_prop_types119.default.func,
  rightIcon: import_prop_types119.default.func,
  secondaryText: import_prop_types119.default.oneOfType([
    import_prop_types119.default.func,
    import_prop_types119.default.element,
    import_prop_types119.default.string
  ]),
  tertiaryText: import_prop_types119.default.oneOfType([
    import_prop_types119.default.func,
    import_prop_types119.default.element,
    import_prop_types119.default.string
  ]),
  rowStyle: import_prop_types119.default.func
};
var LinkOrNot = function(props) {
  var classesOverride = props.classes, linkType = props.linkType, resource = props.resource, id = props.id, children = props.children, record = props.record, rest = __rest138(props, ["classes", "linkType", "resource", "id", "children", "record"]);
  var createPath = useCreatePath();
  var type = typeof linkType === "function" ? linkType(record, id) : linkType;
  return type === false ? React203.createElement(
    ListItemText_default,
    __assign148({
      // @ts-ignore
      component: "div"
    ...
    // @ts-ignore
    React203.createElement(ListItemButton_default, __assign148({ component: Link, to: createPath({ resource, id, type }) }, rest), children)
  );
};
var PREFIX87 = "RaSimpleList";
var SimpleListClasses = {
  tertiary: "".concat(PREFIX87, "-tertiary")
};
var Root41 = styled_default(List_default, {
  name: PREFIX87,
  overridesResolver: function(props, styles) {
    return styles.root;
  }
})((_a12 = {}, _a12["& .".concat(SimpleListClasses.tertiary)] = { float: "right", opacity: 0.541176 }, _a12));
var DefaultEmpty2 = React203.createElement(ListNoResults, null);
...
var SimpleListEditor = function(props) {
  ...
  return React204.createElement(
    "form",
    null,
    React204.createElement(TextField_default, __assign149({ label: translate("ra.configurable.SimpleList.primaryText", {
      _: "Primary Text"
    }) }, primaryTextField, { variant: "filled", size: "small", fullWidth: true, sx: { mb: 1 } })),
    React204.createElement(TextField_default, __assign149({ label: translate("ra.configurable.SimpleList.secondaryText", {
      _: "Secondary Text"
    }) }, secondaryTextField, { variant: "filled", size: "small", fullWidth: true, sx: { mb: 1 } })),
    React204.createElement(TextField_default, __assign149({ label: translate("ra.configurable.SimpleList.tertiaryText", {
      _: "Tertiary Text"
...
var SimpleListConfigurable = function(_a13) {
  var preferenceKey = _a13.preferenceKey, props = __rest139(_a13, ["preferenceKey"]);
  var resource = useResourceContext(props);
  return React205.createElement(
    Configurable,
    { editor: React205.createElement(SimpleListEditor, null), preferenceKey: preferenceKey || "".concat(resource, ".SimpleList"), sx: { display: "block" } },
    React205.createElement(SimpleListWithPreferences, __assign150({}, props))
  );
};
var SimpleListWithPreferences = function(props) {
  ...
  return React205.createElement(SimpleList, __assign150({}, props, { primaryText: primaryTextFromStore || props.primaryText, secondaryText: secondaryTextFromStore || props.secondaryText, tertiaryText: tertiaryTextFromStore || props.tertiaryText }));
};
...
var AdminContext = function(props) {
  var theme = props.theme, _a13 = props.lightTheme, lightTheme = _a13 === void 0 ? defaultLightTheme : _a13, darkTheme = props.darkTheme, defaultTheme2 = props.defaultTheme, children = props.children, rest = __rest141(props, ["theme", "lightTheme", "darkTheme", "defaultTheme", "children"]);
  return React207.createElement(
    ...
    React207.createElement(
      ...
      React207.createElement(ThemeProvider2, null, children)
    )
  );
};
...
var esm_default2 = function(getMessages, initialLocale, availableLocales, polyglotOptions) {
  ...
  var polyglot = new import_node_polyglot.default(__assign153({ locale, phrases: __assign153({ "": "" }, messages) }, polyglotOptionsFinal));
  ...
  return {
    ...
    changeLocale: function(newLocale) {
      return Promise.resolve(getMessages(newLocale)).then(function(messages2) {
        locale = newLocale;
        var newPolyglot = new import_node_polyglot.default(__assign153({ locale: newLocale, phrases: __assign153({ "": "" }, messages2) }, polyglotOptions));
...
var Admin = function(props) {
  var authProvider = props.authProvider, basename = props.basename, catchAll = props.catchAll, children = props.children, dashboard = props.dashboard, dataProvider = props.dataProvider, disableTelemetry = props.disableTelemetry, history = props.history, _a13 = props.i18nProvider, i18nProvider = _a13 === void 0 ? defaultI18nProvider : _a13, layout = props.layout, loading = props.loading, loginPage = props.loginPage, authCallbackPage = props.authCallbackPage, menu = props.menu, notification = props.notification, queryClient = props.queryClient, requireAuth = props.requireAuth, _b = props.store, store = _b === void 0 ? defaultStore : _b, ready = props.ready, theme = props.theme, lightTheme = props.lightTheme, darkTheme = props.darkTheme, defaultTheme2 = props.defaultTheme, _c = props.title, title = _c === void 0 ? "React Admin" : _c;
  ...
  return React208.createElement(
    AdminContext,
    { authProvider, basename, dataProvider, i18nProvider, store, history, queryClient, theme, lightTheme, darkTheme, defaultTheme: defaultTheme2 },
    React208.createElement(AdminUI, { layout, dashboard, disableTelemetry, menu, catchAll, title, loading, loginPage, authCallbackPage, notification, requireAuth, ready }, children)
  );
};
export {
  AUTH_CHECK,
