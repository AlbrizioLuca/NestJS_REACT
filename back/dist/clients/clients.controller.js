...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer UN seul client' }),
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Modifier UN seul client' }),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Supprimer UN seul client' }),
